...
public partial class user_shoporder1 : System.Web.UI.Page
{
    ...
    public void Bind_Page_Title()
    {
        ...
        TitleOrKeyword = "<title>积分兑换信息确认_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
    }
                ...
                foreach (var q in ShopCart)
                {
                    if (q != "")
                    {
                        ...
                        if (model != null)
                        {
                            ...
                            td_ShopCart.Append("<td width='69' align='center' bgcolor='#FFFFFF'><a target=\"_blank\" href='user_shoporder1.aspx?action=del&cid=" + model.i_Id + "&pid=" + model.i_Type + "' class='ac5t'>删除</a></td>");
                            td_ShopCart.Append("</tr>");
                        }
                    }
                }
