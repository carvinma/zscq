          ...
          <tr>
            <td height="60" align="left" valign="top" style="background-image: url(images/aboutus_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">首页</a>&nbsp;>>&nbsp;<a href="youhui.aspx">优惠活动</a>&nbsp;>>&nbsp;<a href="jifen.aspx?ptype=<%= Hi_PType.Value%>&ye=<%=ye %>&sel=<%=sel %>&keyword=<%=key %>">积分商城</a>&nbsp;>>&nbsp;<%=cname %>
                  </td>
                </tr>
              </table>
            </td>
                ...
                <tr>
                  ...
                  <td align="left" valign="top">
                    <table width="622" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td width="352" align="left" valign="top">
                                <table width="351" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="351" height="30" align="left">礼品名称：<%= cname %>
                                    </td>
                                  </tr>
                                  <%--<tr>
                                    <td height="30" align="left">礼品编号：<%= snnumber %></td>
                                  </tr>--%>
                                  <tr>
                                    <td height="30" align="left">兑换积分：<span class="font14ac5"><%= jifen%></span> </td>
                                  </tr>
                                  <tr>
                                          ...
                                          <td width="94%" align="left">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                ...
                                                <%if (ptype == 3)
                                                  { %>
                                                <td width="17%" height="20" style="line-height: 21px; font-size: 12px; color: #656565;">等级商品最多只能兑换一件 </td>
                                                <%}
                                                  else
                                                  { %>
                                                <td width="17%" height="20" style="line-height: 21px; font-size: 12px; color: #656565;">我要兑换 </td>
                                                ...
                                                <td width="20%" align="right" style="line-height: 21px; font-size: 12px; color: #656565;">积分总计： </td>
                                                ...
                                                <%}
                                                  ...
                                                  {%>
                                                <td width="17%" height="20" style="line-height: 21px; font-size: 12px; color: #656565;">商品已下架 </td>
                                                <%} %>
                                              </tr>
                                            </table>
                                          </td>
                      ...
                      <tr>
                        <td height="25" align="left" style="border-bottom: 1px solid #d45156; font-size: 12px; font-weight: bold;">详细介绍： </td>
                      </tr>
                      <tr>
