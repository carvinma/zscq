...
public partial class Box : System.Web.UI.Page
{
    ...
    protected string Bind_FeeInfo()
    {
        ...
        if (Request["pId"] != null && Request["pId"].ToString() != "")
        {
            ...
            sb.Append("<tr>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>Official fee</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>Surcharge</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>Excess fee of claims</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>Bank charges</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>Service fee</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>Total fee</strong></td>");
            sb.Append("<td width='10%' height='28' align='center' bgcolor='#FFFFFF'><strong>Currency</strong></td>");
            sb.Append("</tr>");
