          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">Front page</a>&nbsp;&gt;&gt;&nbsp;User Center&nbsp;&gt;&gt;&nbsp;My reward points </td>
                </tr>
              </table>
            </td>
          </tr>
                        ...
                        <td width="687" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                          <table width="161" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="144" align="center" class="font12bt">Points flow </td>
                              <td width="8"></td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td height="115" align="left" valign="top">
                          <table width="687" border="0" cellspacing="1" cellpadding="1" bgcolor="#d0d0d0">
                            <tr>
                              <td width="20%" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Date</td>
                              <td width="24%" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Abstract</td>
                              <td width="16%" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Change of reward points</td>
                              <td width="20%" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Balance of reward points</td>
                              <td width="20%" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Status of reward points</td>
                            </tr>
                              ...
                              <ItemTemplate>
                                <tr>
                                  ...
                                  <td align="center" bgcolor="#FFFFFF"><span style="color: Red;">
                                    <%# (Convert.ToInt32(Eval("i_status")) == 0 ? "Unfinished" : "Validated")%></span> </td>
                                </tr>
                              </ItemTemplate>
                            </asp:Repeater>
                          </table>
                          <table width="687" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td width="687" height="26" align="right"><a href="jifen.aspx"><img src="images/shop_go_1.jpg" title="进入Reward Points Shop" /> </a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
