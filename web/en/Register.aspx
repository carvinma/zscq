      ...
      <tr>
        <td height="150" align="left" valign="top" style="background-image: url(images/faq_bg2.gif);">
          <table width="700" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="36">&nbsp;</td>
              <td align="center" style="line-height: 21px; font-size: 14px; font-weight: bold;">HQHT User Registration Agreement</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
          ...
          <tr>
            <td width="260" height="308" align="left" valign="top" style="background-image: url(<%=pageflag%>);">
              <table width="464" height="308" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td width="60" height="255">&nbsp; </td>
                  <td width="404" align="left" valign="top">
                    <table width="398" height="243" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="141" height="28" class="style1">Username： </td>
                        ...
                        <td width="57" align="left" class="font12ac5" id="td_username"></td>
                      </tr>
                      <tr>
                        <td height="28" class="style1">User Type： </td>
                      ...
                      <tr>
                        <td height="28" class="style1">Nationality： </td>
                      ...
                      <tr>
                        <td height="28" class="style1">E-mail： </td>
                        <td colspan="2" align="left">
                      ...
                      <tr>
                        <td height="28" class="style1">User Password ： </td>
                        <td align="left">
                      ...
                      <tr>
                        <td height="28" class="style1">Re-enter Password： </td>
                        <td align="left">
                      ...
                      <tr>
                        <td class="style3"></td>
                        <td colspan="2" align="left" class="style4"><a href="javascript:openBg(1);showdiv('1');" class="ac5">《HQHT User Registration Agreement》</a> </td>
                      </tr>
                      <tr>
                        <td height="28" class="style2">&nbsp; </td>
                        <td colspan="2" align="left"><img src="images/reg.gif" width="147" height="24" border="0" onclick="user_register()" style="cursor: pointer" />
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table width="449" height="66" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td align="left" valign="top" style="line-height: 21px;">
                    <p>
                      <strong style="color: #fff;">HQHT user already? </strong>
                    </p>
                  </td>
                </tr>
                <tr>
                  <td width="29" height="26">&nbsp; </td>
                  <td width="420" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Login.aspx?flag=<%=Hf_PageFlag.Value %>" class="ac4">Go to login now&gt;&gt;</a> </td>
                </tr>
              </table>
            </td>
          </tr>
