...
<head runat="server">
  <title>My patent Order_Service Center_User Center_System of Patent Annuity Fee_Global Patent</title>
          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp;</td>
                  <td align="left">Front page >> System of Patent Annuity Fee >> User Center >> Service Center >> My patent Order </td>
                </tr>
              </table>
            </td>
          </tr>
                        ...
                        <td height="115" align="left" valign="top">
                              ...
                              <td width="687" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                                <table width="174" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="154" align="center" class="font12bt">My patent Order</td>
                                    <td width="10"></td>
                                  </tr>
                                </table>
                              </td>
                          ...
                          <table width="689" border="0" cellspacing="1" cellpadding="1" bgcolor="#d0d0d0">
                            <tr>
                              ...
                              <td width="56" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Patent</td>
                              <td width="66" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Total amount</td>
                              <td width="66" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Paid amount</td>
                              <td width="105" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Order time</td>
                              <td width="96" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Paid time</td>
                              <td width="101" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Order status</td>
                              <td width="66" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Operation</td>
                            </tr>
                              ...
                              <ItemTemplate>
                                <tr>
                                  ...
                                  <td width="101" align="center" bgcolor="#FFFFFF">
                                    <%#DALPO.GetStatus(Convert.ToInt32(Eval("i_Status")),"en")%></td>
                                  <td width="66" align="center" bgcolor="#FFFFFF" style="line-height: 20px;">
                                    ...
                                    <asp:LinkButton ID="Lbtn_EscOrder" runat="server" class="ac5t" CommandName='<%#Eval("i_Id")%>' CommandArgument='<%#Eval("nvc_OrderNumber")%>' OnCommand="EscOrder">Cancel</asp:LinkButton>
                                    <a href="User_PatentOrderInfo.aspx?oId=<%#Eval("i_Id")%>" class="ac5t">Check</a> </td>
                                </tr>
                              </ItemTemplate>
                            </asp:Repeater>
                          </table>
