...
<body id="links">
  ...
  <uc3:zscqadv ID="zscqadv1" TypeId="64" runat="server" />
          ...
          <tr>
            ...
            <td width="906" height="27" align="left" valign="top" style="background-color: #f4f4f4;">
              <table width="906" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="264" height="27" align="center" bgcolor="<%=  ftype == "1" ? "#bf2831" : "#404040"%>"><a href="links.aspx?ftype=1" class="ac6">Patent Offices of different countries</a> </td>
                  <td width="2"></td>
                  <td width="294" height="27" align="center" bgcolor="<%=  ftype == "2" ? "#bf2831" : "#404040"%>"><a href="links.aspx?ftype=2" class="ac6">Trademark Offices of different countries </a> </td>
                  <td width="2"></td>
                  <td width="264" height="27" align="center" bgcolor="<%=  ftype == "3" ? "#bf2831" : "#404040"%>"><a href="links.aspx?ftype=3" class="ac6">Others</a> </td>
                  <td width="80">&nbsp; </td>
                </tr>
              </table>
            </td>
              ...
              <asp:Repeater ID="Rpt_zhou" runat="server" OnItemDataBound="Rpt_zhou_ItemDataBound">
                <ItemTemplate>
                  <table width="153" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="34">&nbsp; </td>
                      <td width="101" height="18" align="left" valign="top" style="background-color: <%#Eval("i_Id").ToString()==qypid?"#d45156;":"#949293" %>">
                    ...
                    <tr <%#Eval("i_Id").ToString() == qypid ? "" : " style='display: none;'"%>>
                      <td colspan="3" align="left" valign="top">
                        <table width="153" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td width="33">&nbsp; </td>
                            <td width="102" height="18" align="left" valign="top">
                              <table width="90" border="0" cellspacing="0" cellpadding="0">
