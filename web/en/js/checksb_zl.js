...
function Checkadd() {
    ...
    //客户信息
    if ($("#c_Name").val() == "") {
        alert('Please enter the real name');
...
//                    alert("Can only input English and Numbers！");
//                    isok = false; $("#c_addressEn").focus(); return isok;
//                }
//            }
        }
...
//    if ($("#c_youbian").val() == "") {
//        isok = false;
//        alert('Please enter the contact zip code！');
//        $("#c_youbian").focus();
//        return isok;
//    }
//    else {
...
//        return isok;
        ...
        if (reg2.test($("#c_phone").val()) == false) {
            alert('Mobile phone number format is wrong!');
            $("#c_phone").focus();
            isok = false;
            return isok;
        }
            ...
            $.ajax({
                ...
                success: function (msg) {
                    if (msg == "1") {
                        alert("The mobile phone number has been registered！");
                        $("#c_phone").focus();
                        isok = false;
                        return isok;
                    }
    ...
    //if ($("#text_chuanzhen").val() != "") {
     ...
     //       alert("Fax format is not correct！");
   ...
   // if ($("#text_Address").val() == "") {
//        alert("Please enter the address in detail！");
