        ...
        if (txt_sbnum != "") {
            $.ajax({
                ...
                success: function (msg) {
                    if (msg == "ok") {
                        alert("Trademark Registration number already exists！");
                        $("#sb_num").val("");
                        $("#sb_num").focus();
    ...
    if (id == "0") {
        ...
        if (txt_sbnum != "") {
            $.ajax({
                ...
                success: function (msg) {
                    if (msg != "") {
                        //alert("该Trademark Registration number已存在！");
                        //$("#sb_num").val("");
                        //$("#sb_num").focus();
                        //document.getElementById("FileUpload3").display = 'none';
                        $("#FileUpload3").hide();
                        $("#hi_zhitifiles").val(msg);
                        $("#sb_namenum1").html("<a href='" + msg + "'  title='click to check'  target='_blank'>Certificate of Subject Qualification was uploaded already</a>");
                    }
                    //                    else {
...
function Checkadd() {
    var isok = true;
    if ($("#sb_num").val() == "") {
        alert("Please enter the Trademark Registration number！");
        isok = false;
        $("#sb_num").focus();
        $("#sb_num1").html("<img  src='images/tError.gif' />");
        return isok;
    ...
    if ($("#Sb_type").val() == "") {
        alert("Please enter the Trademark class！");
...
//        return isok;      
    //    }
    if ($("#Sb_passTime").val() == "") {
        alert("Please enter the filing date of Trademark！");
        isok = false;
         $("#Sb_passTime").focus();
        return isok;      
    }
...
if ($("#hi_guoji").val() == "0") {
	...
	if ($("#Sb_RegnameEn").val() == "") {
        alert("Please enter the Name of Trademark registrant in English!");
...
//   if ($("#Sb_Regname").val() == "") {
//        alert("Please enter Name of Trademark registrant！");
//        isok = false; $("#Sb_Regname").focus(); return isok;
//		}
//		    if ($("#Sb_Reg_Address").val() == "") {
//        alert("Please enter the details Address！");
