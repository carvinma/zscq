...
public partial class User_PatentCount : System.Web.UI.Page
{
    ...
    public void Bind_Page_Info()//绑定Basic information
    {
        ...
        if (model != null)
        {
            ...
            ltl_grade.Text = DALG.UserGrade_Select_Id(model.i_Grade).nvc_Name_en;
    ...
    protected void Bt_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //if (result.Count() > 0)
            //{
            //    div_a.InnerHtml = "<script>alert('E-mail已经被使用！');</script>";
            //    return;
            //}
            ...
            #endregion
            UserLog.AddUserLog(Hi_MemberId.Value, "专利系统", "更新资料信息");
            div_a.InnerHtml = "<script>alert('Modify successfully！');location.href='User_PatentUpdateData.aspx';</script>";
        }
        catch
        {
