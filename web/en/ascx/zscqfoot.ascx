    ...
    function sendMsg() {
        ...
        $.ajax({
            ...
            success: function (msg) {
                if (msg == "ok") {
                    hidedivbox('divshow3');
                    alert("The question was already sent to customer service center. Accordingly, we will make response to you within 24 hours, so please login in and check our response in due time!");
                                    ...
                                    <table width="1001" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="606" align="left">
                                                <table style="line-height: 15px;" width="670" border="0" cellspacing="0" cellpadding="0">
                                                    <tr valign="middle">
                                                        <td style="width: 109px; text-align: center; background-color: #bf2831; vertical-align: middle; line-height: 15px; height: 15px;">
                                                            <a href="javascript:openboxBg(1);showdivbox('divshow1');" class="ac3">Terms of Use</a>
                                                        </td>
                                                        <td width="2">
                                                        </td>
                                                        <td style="width: 109px; text-align: center; background-color: #bf2831; vertical-align: middle; line-height: 15px; height: 15px;">
                                                            <a href="javascript:openboxBg(1);showdivbox('divshow2');" class="ac3">Terms of Privacy</a>
                                                        </td>
                                                        <td width="2">
                                                        </td>
                                                        <td style="width: 109px; text-align: center; background-color: #bf2831; vertical-align: middle; line-height: 15px; height: 15px;">
                                                            <a href="sitemap.aspx" class="ac3">Site Map</a>
                                                        </td>
                                                        <td width="359">&nbsp;
                        ...
                        <td align="left" valign="top">
                            <table width="126" border="0" cellspacing="0" cellpadding="0">
                                <%--<tr>
                                 ...
                                 <tr>
                  <td height="33" align="center"><a href="msnim:chat?contact=hqht@live.com&Site=Online Q & A" onclick="return checkInstalled('msn');" target="_blank"><img src="images/hqht_kf8.jpg" width="109" height="27" border="0" /></a></td>
                </tr>--%>
                                <tr>
                                    <td height="33" align="center">
