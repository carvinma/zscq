...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
  <ContentTemplate>
        ...
        <ItemTemplate>
          <tr>
            ...
            <td>
              ...
              <asp:LinkButton ID="lbtn_SetMr" runat="server" CommandName="SETMR" CommandArgument='<%# Eval("i_Id")%>'>[Delete]</asp:LinkButton>
              &nbsp;&nbsp;
              <asp:LinkButton ID="lbtn_Delete" runat="server" CommandName="DELETE" CommandArgument='<%# Eval("i_Id")%>' OnClientClick="javascript:if(!window.confirm('确认删除？')){return false;}">[Delete]</asp:LinkButton>
            </td>
          </tr>
        </ItemTemplate>
      </asp:Repeater>
    ...
    <table id="div_address0" width="100%" border="0" cellspacing="0" cellpadding="0" style="display: none;">
      ...
      <tr>
        <td height="40" align="right" width="100"><span style="color: Red;">*</span>固定Tel： </td>
        <td align="left">
      ...
      <tr>
        <td height="40" align="right" width="100"><span style="color: Red;">*</span>Detailed address： </td>
      ...
      <tr>
        <td height="40" align="right" width="100">Default： </td>
        <td align="left">
