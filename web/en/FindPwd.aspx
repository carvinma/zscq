          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">Front page</a>&nbsp;&gt;&gt;&nbsp;Retrieve Password </td>
                </tr>
              </table>
            </td>
          </tr>
                              ...
                              <td width="639" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                                <table width="155" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="138" align="center" class="font12bt">Retrieve Password </td>
                                    <td width="7"></td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr>
                              <td height="115" align="center" valign="top">
                                <div id="setup1" style="display: ;">
                                  <table width="689" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td height="32" align="right"><strong>Retrieving method：</strong> </td>
                                      <td align="left">
                                        <input runat="server" id="ridE" type="radio" name="mode" value="2" checked="true" />
                                        By E-mail                                        </td>
                                    </tr>
                                    <tr>
                                      <td width="260" height="32" align="right"><strong>Username： </strong></td>
                                    ...
                                    <tr>
                                      ...
                                      <td width="429" align="left"><img src="images/userreg.jpg" name="fasong" width="120" height="22" border="0" id="fasong" /></td>
                                    </tr>
                                  </table>
                                ...
                                <div id="setup2" style="display: none;">
                                  <table width="689" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td width="260" height="32" align="right"><strong>Verification Code：</strong> </td>
                                      <td width="429" height="32" align="left">
                                        ...
                                        <span id="msg_v" class="msgshow"></span><a id="resend" href="javascript:void(0);">Resend</a> </td>
                                    </tr>
                                    <tr>
                                      <td height="32" align="right"><strong>Enter new password：</strong> </td>
                                      <td align="left">
                                        <input type="password" name="" id="TXT_NEWPWD" runat="server" tips="Password length is between 6 to 21!" class="font12000 tooltip" value="" placeholder="" />
                                        <span id="msg_pwd" class="msgshow"></span></td>
                                    </tr>
                                    <tr>
                                      <td height="32" align="right"><strong>Confirm new password：</strong> </td>
                                      <td align="left">
                                  ...
                                  <div id="divfasong" style="height: 50px; line-height: 21px; border: solid 1px #ffcc7f; background-color: #ffffe5;">
                                    Note message</div>
                                </div>
                              </td>
                            </tr>
...
<script type="text/javascript">
  ...
  function checkMode() {
    ...
    if (mode == "1" || mode == "2") {
      ...
      $("#msg_mode").text("Please selectRetrieve Password方式!");
      return false;
    }
  }
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (v == "1") { 
          ...
          alert(v2); //发生错误，Reset状态
        }
      }
    });
  }
  function setstate(v, v2) {
    if (v == 1) {//成功生成Verification Code
      $("#msg_v").text("");
      $("#msg_pwd").text("");
      $("#divfasong").html("");
      $('#divfasong').show();
  ...
  function daojishi(con, miaoshu) {
    ...
    if (miaoshu > 0) {
      $('#divfasong').show();
      con = con.replace(miaoshu + "Second", (miaoshu - 1) + "Second")
      $('#divfasong').html(con);
  ...
  function checksubmit() {
    ...
    if (code == "") {
        $("#msg_v").text("Please enter Verification Code！");
      return false;
    } else if (pwd == "") {
      $("#msg_pwd").text("Please enter password！");
      return false;
    } else if (pwd.length < 6 || pwd.length > 21) {
      $("#msg_pwd").text("Password length is between 6 to 21！");
      return false;
    } else if (pwd2 != pwd) {
      $("#msg_pwd2").text("Passwords do not match！");
      return false;
    }
    return true;
  } 
