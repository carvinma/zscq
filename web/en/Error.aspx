    ...
    <tr>
      <td align="center" valign="middle">
        <div style="font-size: 24px;">
          <strong style="font-size: 24px;">Kindly note：系统发生未知错误，请与管理员联系！</strong><br />
          <br />
          <span id="time" style="font-size: 24px;">5</span>秒后<a id="url" href="index.aspx" style="font-size: 24px;">Return to front page</a>
        </div>
      </td>
    </tr>
  </table>
