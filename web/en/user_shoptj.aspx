          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp;</td>
                  <td align="left"><a href="index.aspx">Front page</a>&nbsp;&gt;&gt;&nbsp;User Center&nbsp;&gt;&gt;&nbsp;Service Center&nbsp;&gt;&gt;&nbsp;My order statistics</td>
                </tr>
              </table>
            </td>
          </tr>
                        ...
                        <td width="654" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                          <table width="409" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="392" align="center" class="font12bt">Statistics of number and status of reward points order</td>
                              <td width="7"></td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td height="115" align="left" valign="top">
                          <table width="630" border="0" cellspacing="0" cellpadding="0" id="h_lsitt1">
                            <tr>
                              <td width="345" height="30" align="right" class="user_leftline">Order under delivery：</td>
                              <td width="285" class="user_rightline">&nbsp;&nbsp;<a href="user_shopdd.aspx?state=2" class="ac_hei"><%= GetOrderCount(2) %></a> </td>
                            </tr>
                            <tr>
                              <td width="345" height="30" align="right" class="user_leftline">Order under receipt：</td>
                              <td width="285" class="user_rightline">&nbsp;&nbsp;<a href="user_shopdd.aspx?state=3" class="ac_hei"><%= GetOrderCount(3)  %></a> </td>
                            </tr>
                            <tr>
                              <td width="345" height="30" align="right" class="user_leftline">Order already done：</td>
