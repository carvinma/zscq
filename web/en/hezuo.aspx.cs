...
{
    public string _Name = "Our Partner";
    public string _Title = "About Us";
    ...
    {
        t_PageInfo model = new dal_PageInfo().PageInfo_Select_Id(27);
    ...
    void Bind_Rpt_List()
    {
        ...
        var iquery = DALN.vwNews_Select_ShowNews(pageindex, pagesize, "hzhb", "en", ref count);
