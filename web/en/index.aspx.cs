...
public partial class index : System.Web.UI.Page
{
    ...
    public string _Title = "Front page";
    public string _Name = "";
    ...
    {
        t_PageInfo model = new dal_PageInfo().PageInfo_Select_Id(21);
