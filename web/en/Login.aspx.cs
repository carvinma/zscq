...
public partial class Login : System.Web.UI.Page
{
    ...
    public string unvalue = "Username/E-mail/Mobile phone";
    ...
    void Bind_Page_Adv()
    {
        ...
        //var iquery = DALA.Adv_Select_TypeId(100);//登陆page面广告 449*291
        ...
        if (Request["esc"] != null)
        {
            if (Request.Cookies["hqhtshop"] != null)
            {
                if (Request.Cookies["hqhtshop"]["hqht_zl_uid"] != null && Request.Cookies["hqhtshop"]["hqht_zl_uid"] != "" && Request.Cookies["hqhtshop"]["hqht_zl_uid"] != "0")
                {
                    ...
                    UserLog.AddUserLog(Request.Cookies["hqhtshop"]["hqht_zl_uid"].ToString(), "专利系统", "登陆专利系统");
                }
                if (Request.Cookies["hqhtshop"]["hqht_sb_uid"] != null && Request.Cookies["hqhtshop"]["hqht_sb_uid"] != "" && Request.Cookies["hqhtshop"]["hqht_sb_uid"] != "0")
                {
                    ...
                    Response.Cookies.Set(cookie);
                    UserLog.AddUserLog(Request.Cookies["hqhtshop"]["hqht_sb_uid"].ToString(), "商标系统", "登陆商标系统");
                ...
                if (Request.Cookies["hqhtshop"]["hqht_shop_uid"] != null && Request.Cookies["hqhtshop"]["hqht_shop_uid"] != "" && Request.Cookies["hqhtshop"]["hqht_shop_uid"] != "0")
                {
                    ...
                    Response.Cookies.Set(cookie);
                    UserLog.AddUserLog(Request.Cookies["hqhtshop"]["hqht_shop_uid"].ToString(), "商城系统", "登陆商城系统");
                }
    ...
    void SetPage()
    {
        ...
        if (flag == "sb")
        {
            ...
            TitleOrKeyword = "<title>" + "UserLogin_" + "System of Trademark Maintenance_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
        }
        else
        {
            _typeid = "104";
            ...
            TitleOrKeyword = "<title>" + "UserLogin__" + "System of Patent Annuity Fee_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
        }
