...
public partial class user_sbddck : System.Web.UI.Page
{
    ...
    public string fapiaotaitou = "No", youjitype = "No", youjidizhi = "No", youjidizhia = "No", youjidizhib = "No", payway = "";
    public string youhuiquan = "No", isuseyouhui = "No";
    ...
    public void Bind_Order_Info()
    {
        if (Request.QueryString["order"] != null || Request.QueryString["order"].ToString() != "")
        {
            ...
            if (order != null)
            {
                ...
                OrderState = ConvertStatus(order.i_Status,"en");
                if (order.i_Status == 4)
                {
                    ImageButton1.Enabled = false;
                    ImageButton1.ToolTip = "Paid";
                }
            }
            if (user != null)
            {
                ...
                if (mm.i_GuoJiId != null)
                {
                    ...
                    if (na != null)
                    {
                        ...
                        if (na.nvc_Name == "中国")
                        {
                            ...
                            Str_Money.Append(" <tr align=\"left\"><td width=\"200\" align=\"right\">Official fee：</td><td width=\"110\">" + order.dm_TrademarkMoney + "</td><td width=\"30\"></td><td width=\"100\"></td></tr>");
                            if (zhinajinnum != 0)
                            {
                                Str_Money.Append(" <tr align=\"left\"><td width=\"200\" align=\"right\">Surcharge：</td><td width=\"110\">" + order.dm_TMZhiNaJin + "</td><td width=\"30\"></td><td width=\"100\"></td></tr>");
                            }
                            Str_Money.Append(" <tr align=\"left\"><td width=\"200\" align=\"right\">Service fee：</td><td width=\"110\">" + order.dm_TMDaiLi + "</td><td width=\"30\"></td><td width=\"100\"></td></tr>");
                            ...
                            Str_AllMoney.Append("<tr align=\"left\"><td width=\"200\" align=\"right\"></td><td width=\"110\" align=\"right\">Total fee：</td><td width=\"color:red;\" width=\"30\">CNY</td><td style='color:red;' id='allmoney'  align=\"left\" width=\"100\" >" + order.dm_TotalMoney + "</td></tr>");
                        }
                        else
                        {
                            ...
                            Str_AllMoney.Append("<tr align=\"left\"><td width=\"200\" align=\"right\"></td><td width=\"110\" align=\"right\">Total fee：</td><td style='color:red;' width=\"30\"\">CNY</td><td style='color:red;' width=\"100\" id='allmoney'  align=\"left\">" + order.dm_TotalMoney + "</td></tr>");
