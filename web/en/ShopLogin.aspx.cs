...
public partial class ShopLogin : System.Web.UI.Page
{
    ...
    public void Bind_Page_Title()
    {
        ...
        TitleOrKeyword = "<title>" + "User Login_" + "System of Reward Points Shop_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
    }
    protected void Page_Load(object sender, EventArgs e)
    {
        div_a.InnerHtml = "";
        t_Adv adv = DALADV.Adv_Select_TypeId(117).FirstOrDefault();
        if (adv != null)
        {
    ...
    protected void Ibtn_Login_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (model != null)
        {
            ...
            {
                div_a.InnerHtml = "<script>alert('Your mobile phone number is not opened yet or your mobile phone user of reward points is unavaliable, since you have not binded it with any patent system or Trademark system. Please register new user for patent system or Trademark system and bind with your mobile phone user of reward points.');</script>";
                return;
            }
            ...
            {
                div_a.InnerHtml = "<script>alert('Your mobile phone number or password is incorrect!');</script>";
                return;
            }
        ...
        {
            div_a.InnerHtml = "<script>alert('Your mobile phone number is not opened yet！');</script>";
        }
    }
}