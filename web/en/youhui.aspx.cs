...
{
    public string _Name = "Promotions";
    ...
    void Bind_Page_Value()
    {
        ...
        TitleOrKeyword = "<title>" + _Name + "_Promotions_" + _Title + "_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
    }
