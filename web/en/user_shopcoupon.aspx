<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_shopcoupon.aspx.cs"
    Inherits="user_shopcoupon" %>
                                                ...
                                                <td width="654" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                                                    <table class="member_order_tabs" width="260" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="116" align="center" class="tab font12bt">
                                                                Unused coupons
                                                            </td>
                                                            <td width="8">
                                                            </td>
                                                            <td width="116" align="center" class="tab font12bs">
                                                                Used coupons
                                                            </td>
                                                            <td width="10">
                                                            </td>
                                                ...
                                                <td height="115" align="left" valign="top">
                                                    ...
                                                    <div class="member_order_cont" style="display: block;">
                                                        <asp:UpdatePanel runat="server">
                                                            <ContentTemplate>
                                                                <table class="member_infotable" width="689" border="0" cellspacing="1" cellpadding="1"
                                                                    bgcolor="#d0d0d0">
                                                                    <thead>
                                                                        <tr>
                                                                            <td width="16%" height="32" align="center" bgcolor="#FFFFFF">
                                                                                Code of coupons
                                                                            </td>
                                                                            ...
                                                                            <table class="aspnetpager" cellspacing="5">
                                                                                <tr>
                                                                                    <webdiyer:AspNetPager NumericButtonCount="7" ID="AspNetPager1" showpageindexbox="Always"
                                                                                        runat="server" ShowFirstLast="False" FirstPageText="Front page" LastPageText="Last page"
                                                                                        PrevPageText="Previous page" NextPageText="Next page" ShowInputBox="Always" PageSize="12"
                                                                                        ShowCustomInfoSection="Right" CustomInfoHTML="Total %PageCount% page " InputBoxClass="pagetext"
                                                                                        pageindexboxtype="TextBox" SubmitButtonText="确定" SubmitButtonClass="submitbutton"
                                                                                        OnPageChanged="AspNetPager1_PageChanged" TextAfterInputBox=" page" TextBeforeInputBox="Skip to ">
                                                                ...
                                                                <table width="687" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        <td align="right" class="font12b4e">
                                                                            <table class="aspnetpager" cellspacing="5">
                                                                                <tr>
                                                                                    <webdiyer:AspNetPager NumericButtonCount="7" ID="AspNetPager2" showpageindexbox="Always"
                                                                                        runat="server" ShowFirstLast="False" FirstPageText="Front page" LastPageText="Last page"
                                                                                        PrevPageText="Previous page" NextPageText="Next page" ShowInputBox="Always" PageSize="12"
                                                                                        ShowCustomInfoSection="Right" CustomInfoHTML="Total %PageCount% page " InputBoxClass="pagetext"
                                                                                        pageindexboxtype="TextBox" SubmitButtonText="确定" SubmitButtonClass="submitbutton"
                                                                                        OnPageChanged="AspNetPager2_PageChanged" TextAfterInputBox=" page" TextBeforeInputBox="Skip to ">
                                                                                    </webdiyer:AspNetPager>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
