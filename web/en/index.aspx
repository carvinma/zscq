                            ...
                            <tr>
                              ...
                              <td align="left" valign="top">
                                <table width="356" border="0" cellspacing="0" cellpadding="0" style="filter: alpha(opacity=80); opacity: 0.8; background: #bf2831;">
                                  <tr>
                                    <td width="7"></td>
                                    <td width="349" height="40" align="left" style="color: #f7dddd; font-size: 18px; line-height: 21px;">
                                      <%#Eval("nvc_Title")%></td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top">
                                <table width="356" height="96" border="0" cellspacing="0" cellpadding="0" style="filter: alpha(opacity=80); opacity: 0.8; background: #26323c;">
                                  ...
                                  <tr>
                                    <td width="10"></td>
                                    <td width="346" align="left" valign="top" style="color: #d6d6d6; font-size: 14px; line-height: 21px;">
                                      <%#Eval("nvc_EnTitle")%></td>
                                  </tr>
                                </table>
                              </td>
      ...
      <td height="105" align="left" valign="top">
        <table width="1001" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="336" valign="top"><a href="Login.aspx?flag=zl&pageurl2=<%=url %>"><img src="images/zhuanli_banner.gif" width="316" height="149" /></a> </td>
            <td width="330" valign="top"><a href="Login.aspx?flag=sb&pageurl2=<%=url %>"><img src="images/shangbiao_banner.gif" width="316" height="149" /></a> </td>
            <td width="317" valign="top"><a href="jifen.aspx"><img src="images/jifen_banner.gif" width="316" height="149" /></a> </td>
          </tr>
        </table>
      </td>
    </tr>
