...
public partial class ShopReg : System.Web.UI.Page
{
    ...
    public void Bind_Page_Title()
    {
        ...
        TitleOrKeyword = "<title>" + "User Login_" + "Shop_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
    }
    ...
    protected void Ibtn_Reg_Click(object sender, EventArgs e)
    {
        ...
        if (model == null)
        {
            ...
            div_a.InnerHtml = "<script>alert('注册成功！');window.location='ShopLogin.aspx';</script>";
        }
        else
        {
