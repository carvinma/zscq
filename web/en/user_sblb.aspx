...
<head runat="server">
  <title>All Trademark information_My Trademark_Service Center_System of Trademark Maintenance_Global Patent</title>
...
<body id="index">
          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp;</td>
                  <td align="left"><a href="index.aspx">Front page</a>&nbsp;>>&nbsp;System of Trademark&nbsp;>>&nbsp;Service Center&nbsp;>>&nbsp;My Trademark&nbsp;>>&nbsp;All Trademark</td>
                </tr>
              </table>
            </td>
          </tr>
                    ...
                    <table width="689" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="29" align="left" valign="top">
                          <table width="689" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="114" height="29" align="center" style="background-color: #1e2b6c;"><a href='user_sblb.aspx?stime=90_1&<%=Geturl("stime") %>' class="ac2">More than 90 days</a></td>
                              <td width="1"></td>
                              <td width="114" align="center" style="background-color: #50245f;"><a href='user_sblb.aspx?stime=61-90_2&<%=Geturl("stime") %>' class="ac2">61-90 days</a></td>
                              <td width="1"></td>
                              <td width="114" align="center" style="background-color: #852349;"><a href='user_sblb.aspx?stime=31-60_3&<%=Geturl("stime") %>' class="ac2">31-60 days</a></td>
                              <td width="1"></td>
                              <td width="114" align="center" style="background-color: #b2333d;"><a href='user_sblb.aspx?stime=16-30_4&<%=Geturl("stime") %>' class="ac2">16-30 days</a></td>
                              <td width="1"></td>
                              <td width="114" align="center" style="background-color: #d14b1a;"><a href='user_sblb.aspx?stime=0-15_5&<%=Geturl("stime") %>' class="ac2">0-15 days</a></td>
                              <td width="1"></td>
                              <td width="114" align="center" style="background-color: #ebbf1c;"><a href='user_sblb.aspx?stime=chao_6&<%=Geturl("stime") %>' class="ac2">Trademark overdue</a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
  ...
  <tr>
    <td width="12"></td>
    <td align="left"><span title="Trademark Registration number">Trademark number</span><a href="user_sblb.aspx?sbnum=desc_4" title="Descending" id="daoxu4">↑</a><a href="user_sblb.aspx?sbnum=asc_4" title="Ascending" id="zhengxu4" style="display: none;">↓</a></td>
  </tr>
</table>
</td>
  ...
  <tr>
    <td align="center"><span title="Trademark application and Power of attorney">Form</span></td>
    </tr>
</table></td>
                              <td width="86" height="42" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline"><table width="66" height="42" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="5"></td>
    <td width="61" align="left"><span title="Certificate of Subject Qualification and Trademark Registration Certificate">Certificate</span></td>
  </tr>
</table></td>
  ...
  <tr>
    <td align="center"><span title="Trademark class">Class</span><a href="user_sblb.aspx?sbtype=desc_1" title="Descending" id="daoxu1">↑</a><a href='user_sblb.aspx?sbtype=asc_1' title="Ascending" id="zhengxu1" style="display: none;">↓</a></td>
    </tr>
</table></td>
  ...
  <tr>
    <td align="center"><span title="Name of Trademark registrant">Name</span><a href="user_sblb.aspx?sbreg=desc_3" title="Descending" id="daoxu3">↑</a><a href="user_sblb.aspx?sbreg=asc_3" title="Ascending" id="zhengxu3" style="display: none;">↓</a></td>
    </tr>
</table></td>
                              <%if (usertype == 3)
                                { %>
                                 <td width="69" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline"><span>Reference number</span><a href="user_sblb.aspx?xnum=desc_7" title="Descending" id="daoxu7">↑</a><a href='user_sblb.aspx?xnum=asc_7' title="Ascending" id="zhengxu7" style="display: none;">↓</a></td>
                                 <%} %>
  ...
  <tr>
    <td width="5"></td>
    <td width="41" align="left"><span title="Remained days to the deadline">Remained days</span><a href="user_sblb.aspx?sbtime=desc_6" title="Descending" id="daoxu6">↑</a><a href="user_sblb.aspx?sbtime=asc_6" title="Ascending" id="zhengxu6" style="display: none;" >↓</a></td>
  </tr>
</table></td>
                              <td width="53" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline"><span title="Subtotal">Total</span></td>
                              <td width="37" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Detailed </td>
                              <td width="37" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">Select</td>
                            </tr>
                            <asp:Repeater ID="Rp_sb_list" runat="server">
                              <ItemTemplate>
                                <tr>
                                  ...
                                  <td height="42" align="center" bgcolor="#FFFFFF" class="user_zlbottomline"><%#BoolFileImg(Eval("nvc_ShenQingShu")) ? "<a href='../" + Eval("nvc_ShenQingShu") + "' title='Application'>Trademark Application</a>" : "<a href='user_sbck.aspx?t_r_id=" + Eval("i_Id") + "' >Not uploaded</a>"%><br /><%# int.Parse(Eval("i_JiaoFeiType").ToString()) == 2 ? (BoolFileImg(Eval("nvc_WeituoFile")) ? "<a href='../" + Eval("nvc_WeituoFile") + "' title='Power of Attorney'>Trademark attorney</a>" : "<a href='user_sbck.aspx?t_r_id=" + Eval("i_Id") + "'>Not uploaded</a>") : ""%>
                                  </td>
                                  <td height="42" align="center" bgcolor="#FFFFFF"><%#ZTFileImg(Eval("nvc_ZhuTiFile"), Eval("i_Id"))%><br /><%#BoolFileImg(Eval("nvc_SBFile")) ? "<a href='../" + Eval("nvc_SBFile") + "'><img src='../" + Eval("nvc_SBFile") + "' width='20'  title='Copy of Trademark Registration Certificate' border='0'/></a>" : "<a href='user_sbupdate.aspx?t_r_id=" + Eval("i_Id") + "' >Not uploaded</a>"%>
                                  </td>
                                  ...
                                  <td align="center" bgcolor="#FFFFFF"><a href="user_sbck.aspx?t_r_id=<%# Eval("i_Id") %>" class="ac5t">Check</a></td>
                                  <td align="center" bgcolor="#FFFFFF">
                      ...
                      <tr>
                        ...
                        <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="images/user_zl_del.jpg" OnClientClick="javascript:return confirm('Are you sure to perform this operation?')" 
  ...
  <div id="show">
            ...
            <tr>
              ...
              <td align="left" valign="top">
                <table width="397" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td colspan="2" align="center">Information note! </td>
                  </tr>
                  <tr>
    ...
    <Columns>
      <asp:BoundField DataField="nvc_UserNum" HeaderText="Customer Number" />
      <asp:TemplateField HeaderText="User type">
        <ItemTemplate>
          <%# GetSBtypeAndName(Eval("i_GuoJiId").ToString(), Eval("i_UserTypeId").ToString())%>
        </ItemTemplate>
      </asp:TemplateField>
       <asp:TemplateField HeaderText="Trademark Registration Certificate">
        <ItemTemplate>
          <%# Eval("nvc_SBFile") != null ? "Uploaded" : "Not uploaded"%>
        </ItemTemplate>
      </asp:TemplateField>
          <asp:TemplateField HeaderText="Certificate of Subject Qualification">
        <ItemTemplate>
          <%#SBZTFile(Eval("i_Id"))%>
        </ItemTemplate>
      </asp:TemplateField>
        <asp:TemplateField HeaderText="Trademark renewal application">
        <ItemTemplate>
          <%# Eval("nvc_ShenQingShu") != null ? "Uploaded" : "Not uploaded"%>
        </ItemTemplate>
      </asp:TemplateField>
          <asp:TemplateField HeaderText="Power of Attorney">
        <ItemTemplate>
          <%# Eval("nvc_WeituoFile") != null ? "Uploaded" : "Not uploaded"%>
        </ItemTemplate>
      </asp:TemplateField>
      <asp:BoundField DataField="nvc_SBRegNum" HeaderText="Trademark Registration number" />
      <asp:BoundField DataField="nvc_SBType" HeaderText="Trademark class" />
      <asp:BoundField DataField="nvc_SBRegName" HeaderText="Trademark Name" />
      <asp:BoundField DataField="nvc_SBRegEnName" HeaderText="Registrant Name" />     
      <asp:BoundField DataField="nvc_SBRegAddress" HeaderText="Detailed address" />
      <asp:BoundField DataField="nvc_SBRegEnAddress" HeaderText="Trademark registrant English addresses" />
      <asp:TemplateField HeaderText="Status">
        <ItemTemplate>
          <%#Eval("i_State").ToString() == "1" ? "Audited passed<font style='color:red;'>(Valid" + Eval("nvc_SbDaoqiTime") + "</font>)" : (Eval("i_State").ToString() == "2" ? "Not passed" : "Not checked")%>
        </ItemTemplate>
      </asp:TemplateField>
      <asp:BoundField DataField="nvc_SBPostcode" HeaderText="Zip Code" />
      <asp:BoundField DataField="dt_AddTime" HeaderText="Add Time" />
        <asp:BoundField DataField="nvc_SbRegTime" HeaderText="Registration date of Trademark" />      
             <asp:BoundField DataField="nvc_SbDaoqiTime" HeaderText="Expiry Date" />   
      <asp:BoundField DataField="i_ShengDays" HeaderText="Remained days" />
      <asp:TemplateField HeaderText="Trademark description type">
        <ItemTemplate>
         <%#Eval("i_MiaoShuType").ToString() == "1" ? "Word mark" : Eval("i_MiaoShuType").ToString() == "2" ? "Device mark" : "Composed mark with word and device"%>
        </ItemTemplate>
      </asp:TemplateField>

      <asp:BoundField DataField="nvc_SBDescribe" HeaderText="Trademark description" />
      <asp:TemplateField HeaderText="Payment channel">
        <ItemTemplate>
  ...
  <script type="text/javascript">
    ...
    function Maxjiaofei() {
      ...
      if (num != 0) {
        ...
        alert("Please select a payment of the trademark！");
        isok = false;
      }
      //alert(isok);
      return isok;
