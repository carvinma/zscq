...
public partial class nianfei : System.Web.UI.Page
{
    ...
    public string _Title = "Renewal Fee Inquiry";
    public string _Name = "";
    ...
    void Bind_Page_Value()
    {
        ...
        t_PageInfo model = DALPI.PageInfo_Select_Id(23);
    ...
    void Bind_County()
    {
        ...
        {
            selContry.Items.Add(new ListItem(i.nvc_EnName, i.i_Id.ToString()));
            if (countryId == i.i_Id.ToString())
            {
                currency = i.nvc_Currency;
                countryName = i.nvc_EnglishName;
                countrydesc = i.nt_enDescription;
            }
            sb.Append(string.Format("[{0},'{1}','{2}'],", i.i_Id, i.nvc_Name, i.nvc_Currency));
        }
    ...
    void Bind_Rpt_PatentTypeList()
    {
        ...
        if (count == 0)
        {
            div_title.InnerHtml = "</br>Failure of find the related contents！";
        }
