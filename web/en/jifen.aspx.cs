...
public partial class jifen : System.Web.UI.Page
{
    ...
    public string _Name = "Reward Points Shop";
    ...
    public string ptype = "1", name = "Reward points exchange";
    ...
    {
        t_PageInfo model = new dal_PageInfo().PageInfo_Select_Id(28);
    ...
    private void GetProductTypes()
    {
        ...
        foreach (var i in iquery)
        {
            ...
            var iquery2 = from i2 in dpdc.t_IntegralProductType where i2.i_ParentId == i.i_Id && i2.nvc_EnglishName != "" && i2.nvc_EnglishName != null select i2;
