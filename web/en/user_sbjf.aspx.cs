...
//            {
//                div_a.InnerHtml = "<script>alert('Error in mobile phone number or password！')</script>";
//                return;
//            }
//            //设cookie
...
//                    else
//                    {
//                        ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "msg", "<script>alert('Password is not consistent, bind failed！');</script>", false); return;
//                    }

//                }
//                else
//                {
//                    ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "msg", "<script>alert('The existing trademark users to use the mobile phone number！');</script>", false); return;
//                }
//                #endregion
//            }
//            else
