          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp;</td>
                  <td align="left"><a href="index.aspx">首页</a>&nbsp;&gt;&gt;&nbsp;会员中心&nbsp;&gt;&gt;&nbsp;服务中心&nbsp;&gt;&gt;&nbsp;我的积分订单统计</td>
                </tr>
              </table>
            </td>
          </tr>
                        ...
                        <td width="654" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                          <table width="169" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="148" align="center" class="font12bt">积分订单数量与状态统计</td>
                              <td width="11"></td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td height="115" align="left" valign="top">
                          <table width="630" border="0" cellspacing="0" cellpadding="0" id="h_lsitt1">
                            <tr>
                              <td width="345" height="30" align="right" class="user_leftline">待发货订单：</td>
                              <td width="285" class="user_rightline">&nbsp;&nbsp;<a href="user_shopdd.aspx?state=2" class="ac_hei"><%= GetOrderCount(2) %>个</a> </td>
                            </tr>
                            <tr>
                              <td width="345" height="30" align="right" class="user_leftline">待收货订单：</td>
                              <td width="285" class="user_rightline">&nbsp;&nbsp;<a href="user_shopdd.aspx?state=3" class="ac_hei"><%= GetOrderCount(3)  %>个</a> </td>
                            </tr>
                            <tr>
                              <td width="345" height="30" align="right" class="user_leftline">已完成订单：</td>
                              <td width="285" class="user_rightline">&nbsp;&nbsp;<a href="user_shopdd.aspx?state=4" class="ac_hei"><%= GetOrderCount(4)  %>个</a> </td>
                            </tr>
                          </table>
                        </td>
                      </tr>
