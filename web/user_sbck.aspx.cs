...
public partial class user_sbck : System.Web.UI.Page
{
    ...
    public string zhutifileok = "未上传", sbfileok = "未上传", shenqingfile = "未上传", weituofile = "未上传", Uname = "";
    public string Str_Moneysb = "", Str_Monesbmei = "", Str_Zhinajin = "", bizhong = "", zongji = "", zongjimei = "";//自行缴费
    ...
    public string daoqitime = "", shenhe = "未审核";
    ...
    private void Bind_Page_Info(int trademarkId)// 绑定商标详细数据
    {
        ...
        if (model != null)
        {
            ...
            if (mm != null)
            {
                ...
                {
                    zhutifileok = "<a href='" + mm.nvc_ZhuTiFile + "' title='点击查看' target='_blank'>主体资格证书已上传</a>";
                }
                ...
                if (mm.i_UserTypeId == 3)//代理
                {
                    ...
                    {
                        zhutifileok = "<a href='" + model.nvc_ZhuTiFile + "' title='点击查看' target='_blank'>主体资格证书已上传</a>";
                    }
                    else
                    {
                        zhutifileok = "<a href='user_sbupdate.aspx?t_r_id=" + trademarkId + "' target='_blank'>未上传</a>";
                    }
            ...
            SBPssTime = model.nvc_SbRegTime;
                ...
                JiaoFeiType = model.i_JiaoFeiType.ToString();// ? "自行缴费" : "代理缴费";
            //if (model.nvc_ZhuTiFile != null)
            //{
            //    zhutifileok = "<a href='" + model.nvc_ZhuTiFile + "' title='点击查看' target='_blank'>主体资格证书已上传</a>";
            //}
            ...
            {
                shangchuan = 1;//是否上传
                sbfileok = "<a href='" + model.nvc_SBFile + "' title='点击查看' target='_blank'>商标注册证书复印件已上传</a>";
            }
            if (model.nvc_ShenQingShu != null)
            {
                //shangchuan = 2;//是否上传
                shenqingfile = "<a href='" + model.nvc_ShenQingShu + "' title='点击查看' target='_blank'>申请书已上传</a>";
            ...
            if (model.i_JiaoFeiType == 2)
            {
                ...
                {
                    weituofile = "<a href='" + model.nvc_WeituoFile + "' title='点击查看'>委托书已上传</a>";
                    weituoshu = 1;
                    //Button1.Visible = false;
                }
                else
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        //    {
        //        MessageBox.Show(this.Page, "请上传委托书和申请书复印件!");
    ...
    public void UpfileLoad(FileUpload fileup, string pathname, string filename, ref string urlname)
    {
        ...
        if (fileNameExt == ".jpg" || fileNameExt == ".gif" ||fileNameExt == ".png"  || fileNameExt == ".pdf")
        {
            ...
            {
                div_a.InnerHtml = "<script>alert('文件大小不能超过 500KB');</script>";
                return;
            }
        ...
        {
            MessageBox.Show(this.Page, "文件格式仅限( .jpg .gif .pdf)!");
