                        ...
                        <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
                            <table width="739" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <a href="index.aspx">首页</a>&nbsp;&gt;&gt;&nbsp;会员中心&nbsp;&gt;&gt;&nbsp;服务中心&nbsp;&gt;&gt;&nbsp;我的兑换订单&nbsp;&gt;&gt;&nbsp;订单详情
                                    </td>
                                </tr>
                            </table>
                        </td>
                                                    ...
                                                    <table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto">
                                                        <tr class="orderxx">
                                                            <td height="30" width="80" align="right" valign="middle">
                                                                <span class="ordertext">您的订单号：</span>
                                                            </td>
                                                        ...
                                                        <tr class="orderxx">
                                                            <td height="30" width="80" align="right" valign="middle">
                                                                <span class="ordertext">提交时间：</span>
                                                            </td>
                                                            <td height="30" width="160" align="left" valign="middle">
                                                                <%= OrderDate %>
                                                            </td>
                                                                    ...
                                                                    <asp:Repeater runat="server" ID="repProduct">
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                ...
                                                                                <td width="69" align="center" bgcolor="#FFFFFF">
                                                                                    <a title="<%#Eval("nvc_ProductName")%>" href="jifen_show.aspx?cid=<%#Eval("i_IntegralProductId")%>" target="_blank" class="ac5t">查看</a>
                                                                                </td>
                                                                            </tr>
                                                                        </ItemTemplate>
                                                                    </asp:Repeater>
