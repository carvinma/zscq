          ...
          <tr>
            ...
            <td width="906" height="27" align="left" valign="top" style="background-color: #f4f4f4;">
              <table width="906" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="174" height="27" align="center" bgcolor="<%= TypeId== 1 ? "#bf2831" : "#404040"%>"><a href="down.aspx?sid=1" class="ac6">环球汇通下载</a> </td>
                  <td width="2"></td>
                  <td width="174" height="27" align="center" bgcolor="<%= TypeId== 2 ? "#bf2831" : "#404040"%>"><a href="down.aspx?sid=2" class="ac6">专利局下载</a> </td>
                  <td width="2"></td>
                  <td width="174" height="27" align="center" bgcolor="<%= TypeId== 3 ? "#bf2831" : "#404040"%>"><a href="down.aspx?sid=3" class="ac6">商标局下载</a> </td>
                  <td width="2"></td>
                  <td width="174" height="27" align="center" bgcolor="<%= TypeId== 4 ? "#bf2831" : "#404040"%>"><a href="down.aspx?sid=4" class="ac6">其他</a> </td>
                  <td width="204">&nbsp; </td>
                </tr>
              </table>
            </td>
