...
public partial class youhui : System.Web.UI.Page
{
    ...
    void Bind_Page_Value()
    {
        ...
        TitleOrKeyword = "<title>" + _Name + "_最新优惠_" + _Title + "_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
    }
