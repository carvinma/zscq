                ...
                <tr>
                  ...
                  <td width="396" align="left" valign="top">
                    <table width="372" height="121" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="72" height="32" class="font14">用户名称：</td>
                      ...
                      <tr>
                        ...
                        <td align="left"><a href="FindPwd.aspx?flag=<%=Hf_PageFlag.Value%>" class="ac7">找回密码</a></td>
                      </tr>
                      <tr>
                        <td height="32" class="font14">验&nbsp;&nbsp;证&nbsp;&nbsp;码：</td>
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                          <table width="199" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="97" height="30" align="left">
                                <input type="checkbox" name="checkbox" id="cb_remember" tabindex="4" />记住用户名 </td>
                              <td width="102" align="left">
                                <input type="checkbox" name="checkbox2" id="cb_auto" tabindex="5" />自动登录 </td>
                            </tr>
                          </table>
                        </td>
                      </tr>
              ...
              <table width="449" height="109" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td align="left" valign="top" style="line-height: 21px;">
                    <p>
                      <strong style="color: #fff;">还不是环球汇通用户？</strong></p>
                ...
                <tr>
                  ...
                  <td width="420" align="left"><a href="Register.aspx?flag=<%=Hf_PageFlag.Value%>" class="ac4">立即去注册&gt;&gt;</a></td>
                </tr>
              </table>
            </td>
          </tr>
