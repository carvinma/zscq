                            ...
                            <tr>
                              ...
                              <td align="left" valign="top">
                                <table width="356" border="0" cellspacing="0" cellpadding="0" style="filter: alpha(opacity=80); opacity: 0.8; background: #bf2831;">
                                  <tr>
                                    <td width="7"></td>
                                    <td width="349" height="40" align="left" style="color: #f7dddd; font-size: 20px; line-height: 24px;font-family: microsoft yahei,微软雅黑,宋体;">
                                      <%#Eval("nvc_Title")%></td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top">
                                <table width="356" height="96" border="0" cellspacing="0" cellpadding="0" style="filter: alpha(opacity=80); opacity: 0.8; background: #26323c;">
                                  ...
                                  <tr>
                                    <td width="10"></td>
                                    <td width="346" align="left" valign="top" style="color: #d6d6d6; font-size: 16px; line-height: 24px;font-family:microsoft yahei,微软雅黑,宋体;">
                                      <%#Eval("nvc_EnTitle")%></td>
                                  </tr>
                                </table>
                              </td>
