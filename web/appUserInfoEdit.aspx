<%@ Page Language="C#" AutoEventWireup="true" CodeFile="appUserInfoEdit.aspx.cs"
    Inherits="appUserInfoEdit" %>
                        ...
                        <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
                            <table width="739" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <a href="index.aspx">首页</a>&nbsp;&gt;&gt;&nbsp;会员中心&nbsp;&gt;&gt;&nbsp;账户中心&nbsp;&gt;&gt;&nbsp;常用申请人&nbsp;&gt;&gt;&nbsp;新增申请人
                                    </td>
                                </tr>
                            </table>
                        </td>
                                        ...
                                        <table width="671" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td height="115" align="left" valign="top">
                                                    <table width="671" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td width="129" height="32" align="right">
                                                                <strong><span style="color: #f00;">*</span>申请人名称：</strong>
                                                            </td>
                                                            <td width="542" align="left">
                                                                <input runat="server" id="txt_applyname" type="text" onblur="check_ApplyUser('name_div')"
                                                                    name="" value="" placeholder="" class="font12000" maxlength="50" />
                                                                <span class="status error" id="name_div_error"></span>
                                                            </td>
                                                        </tr>
                                                        <tr style="display: none" class="appusertype">
                                                            <td width="129" height="32" align="right">
                                                                <strong><span style="color: #f00;">*</span>身份证号码：</strong>
                                                            </td>
                                                            <td width="542" align="left">
                                                                <input runat="server" id="txt_applyCardNo" onblur="check_ApplyUser('cardno_div')"
                                                                    type="text" name="" value="" placeholder="" class="font12000" maxlength="18" />
                                                                <span class="status error" id="cardno_div_error"></span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="32" align="right">
                                                                <strong><span style="color: #f00;">*</span>联系人电话：</strong>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            <td height="32" align="right">
                                                                <strong><span style="color: #f00;">*</span>常用联系人：</strong>
                                                            </td>
                                                            <td align="left">
                                                                <input runat="server" id="txt_ContactPerson" type="text" onblur="check_ApplyUser('link_div')"
                                                                    name="" value="" placeholder="" class="font12000" maxlength="50" />
                                                        ...
                                                        <tr>
                                                            <td height="32" align="right">
                                                                <strong><span style="color: #f00;">*</span>行政区划：</strong>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            <td height="32" align="right">
                                                                <strong><span style="color: #f00;">*</span>详细地址：</strong>
                                                            </td>
                                                            <td align="left">
                                                                <span class="fl selected-address" id="areaNameTxt"></span>
                                                                <input class="font12000" style="width: 150px" onblur="check_ApplyUser('address_div')"
                                                                    runat="server" id="txt_address" maxlength="50" type="text" name="" value="" />
                                                                <span class="status error" id="address_div_error"></span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="32" align="right">
                                                                <strong><span style="color: #f00;">*</span>邮政编码：</strong>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <input runat="server" id="txt_mobile" onblur="check_ApplyUser('mobile_div')" maxlength="11"
                                                                    onkeypress="event.returnValue=IsDigit();" style="ime-mode: disabled;" class="font12000"
                                                        ...
                                                        <tr>
                                                            <td align="right" class="style1">
                                                                <strong><span style="color: #f00;">*</span>电子邮箱：</strong>
                                                            </td>
                                                            <td align="left" class="style1">
                                                                <input class="font12000" onblur="check_ApplyUser('email_div')" maxlength="50" runat="server"
                                                                    id="txt_email" type="text" name="" value="" placeholder="" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <input class="font12000" maxlength="20" runat="server" id="txt_qq" type="text" name=""
                                                                    value="" placeholder="" onkeypress="event.returnValue=IsDigit();" style="ime-mode: disabled;" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="32" align="right">
                                                                <strong><span style="color: #f00;">*</span>主体资格证明：</strong>
                                                            </td>
                                                            <td align="left">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <div id="upZhuTiZiGePdf">
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <tr style="display: none" class="appusertype">
                                                            <td height="32" align="right">
                                                                <strong><span style="color: #f00;">*</span>身份证证件证明：</strong>
                                                            </td>
                                                            <td align="left">
                                                                <table>
                                                                    <tr>
                                                                ...
                                                                <table width="415" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td width="108" align="left">
                                                                            &nbsp;
                                                                            <asp:ImageButton ID="Bt_AddAddress" CssClass="button52_28" runat="server" Text="添加"
                                                                                OnClick="Bt_AddAddress_Click" OnClientClick="return submitCheck_ApplyUser()"
