          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">首页</a>&nbsp;&gt;&gt;&nbsp;找回密码 </td>
                </tr>
              </table>
            </td>
          </tr>
                              ...
                              <td width="639" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                                <table width="114" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="98" align="center" class="font12bt">找回密码 </td>
                                    <td width="6"></td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr>
                              <td height="115" align="center" valign="top">
                                <div id="setup1" style="display: ;">
                                  <table width="689" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td height="32" align="right"><strong>找回方式：</strong> </td>
                                      <td align="left">
                                        <input runat="server" id="ridE" type="radio" name="mode" value="2" checked="true" />
                                        邮件
                                        <input runat="server" id="ridM" type="radio" name="mode" value="1" />
                                        短信 <span id="msg_mode" class="msgshow"></span></td>
                                    </tr>
                                    <tr>
                                      <td width="260" height="32" align="right"><strong>用户名： </strong></td>
                                    ...
                                    <tr>
                                      ...
                                      <td width="429" align="left"><img id="fasong" src="images/userreg.jpg" width="80" height="22" border="0" /></td>
                                    </tr>
                                  </table>
                                ...
                                <div id="setup2" style="display: none;">
                                  <table width="689" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td width="260" height="32" align="right"><strong>验证码：</strong> </td>
                                      <td width="429" height="32" align="left">
                                        ...
                                        <span id="msg_v" class="msgshow"></span><a id="resend" href="javascript:void(0);">重新发送</a> </td>
                                    </tr>
                                    <tr>
                                      <td height="32" align="right"><strong>输入新密码：</strong> </td>
                                      <td align="left">
                                        <input type="password" name="" id="TXT_NEWPWD" runat="server" tips="密码长度在6至21位之间!" class="font12000 tooltip" value="" placeholder="" />
                                        <span id="msg_pwd" class="msgshow"></span></td>
                                    </tr>
                                    <tr>
                                      <td height="32" align="right"><strong>确认密码：</strong> </td>
                                      <td align="left">
                                  ...
                                  <div id="divfasong" style="height: 22px; line-height: 22px; border: solid 1px #ffcc7f; background-color: #ffffe5;">
                                    提示信息</div>
                                </div>
                              </td>
                            </tr>
