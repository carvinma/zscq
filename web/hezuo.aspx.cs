...
public partial class HeZuo : System.Web.UI.Page
{
    ...
    {
        t_PageInfo model = new dal_PageInfo().PageInfo_Select_Id(13);
    ...
    void Bind_Rpt_List()
    {
        ...
        var iquery = DALN.vwNews_Select_ShowNews(pageindex, pagesize, "hzhb", "cn", ref count);
