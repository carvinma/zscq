                ...
                <tr>
                  ...
                  <td width="691" align="left" valign="top">
                              ...
                              <td height="115" align="left" valign="top">
                                <table width="689" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td align="left">
                                      <input type="text" name="s5" id="sb_num" class="font12000 tooltip" onkeyup="this.value=this.value.replace(/\D/g,'')" tips="请与商标注册证书内容一致 例如：35123535" maxlength="20" runat="server" onblur="CheckUserSbregnum('0');"/> <span style="color: Red;" id="sb_num1">*</span><span ></span></td>
                                  </tr>
                                  <tr>
                                    <td height="32" align="right"><strong>类别：</strong></td>
                                    <td align="left">
                                      <input type="text" name="s5" id="Sb_type" class="font12000 tooltip" tips="请与商标注册证书内容一致" maxlength="20" runat="server" onblur="checkOk('Sb_type');" />
                                      <span style="color: Red;" id="Sb_type1">*</span><span ></span></td>
                                  </tr><%if (usertype != 3)
                                         { %>
                                 <tr>
                                    <td height="32" align="right"><strong>是否使用资料中信息：</strong></td>
                                    <td align="left">
                                        <input id="cb_user" type="checkbox" onclick="Usercheck();" /><span style="color: Red;">&nbsp;如资料信息与商标注册证上信息不一致，请不要勾选</span>
                                     </td> </tr>
                                     <%}%>
                                  ...
                                  <tr>
                                    ...
                                    <td align="left">
                                      <input type="text" name="s6" runat="server" id="Sb_Regname" onblur="checkOk('Sb_Regname');Checksbzhenshu(0);" class="font12000 tooltip" tips="请与商标注册证书内容一致" maxlength="50" />
                                  ...
                                  <tr>
                                    ...
                                    <td align="left">
                                      <input type="text" name="s6" id="Sb_RegnameEn" onblur="checkOk('Sb_RegnameEn');" class="font12000 tooltip" tips="请与商标注册证书内容一致" maxlength="20" runat="server" onkeyup="value=value.replace(/[^a-zA-Z ]/g,'')"  /><span style="color: Red;" id="Sb_RegnameEn1">*</span><span ></span></td>
                                  </tr>
                                  <%} %>
                      
                                   <%if (guoji == 0 && usertype == 3)
                                    { %> <tr>
                                    <td height="46" align="right"><strong>注册人英文详细地址：</strong></td>
                                    <td align="left">
                                 ...
                                 <%} %>
                                  <tr>
                                    <td height="46" align="right"><strong>注册人详细地址：</strong></td>
                                    <td align="left">
                                    <textarea cols="20" rows="2" type="text" name="s6" id="Sb_Reg_Address" style="width: 300px;height:40px;"  onblur="checkOk('Sb_Reg_Address');"  class="font12000 tooltip" tips="请与商标注册证书内容一致" maxlength="250" runat="server" ></textarea><span style="color: Red;" id="Sb_Reg_Address1">*</span><span ></span></td>
                                  </tr>
                                  <tr>
                    ...
                    <td>    <%-- <input name="radio" type="radio" id="radio1" value="radio" checked="true" onchange="miaoshutype();" runat="server" /> 文字商标
                     <input name="radio" type="radio" id="radio2" value="radio"  onchange="miaoshutype();" runat="server" /> 图形商标
                      <input name="radio" type="radio" id="radio3" value="radio"  onchange="miaoshutype();" runat="server" /> 文字与图形商标  --%>  
                       <asp:RadioButton ID="RadioButton1" runat="server" onclick="miaoshutype();" GroupName="aa" Checked="true"/>文字商标 &nbsp;<asp:RadioButton ID="RadioButton2"
                           ...
                           <tr id="sbmiaoshu">
                                    ...
                                    <td align="left" style="text-li:left;">
                                        ...
                                        <input type="text" name="s6" id="Sb_miaosu" class="font12000" maxlength="50" runat="server" onblur="checkOk('Sb_miaosu');"  value="请填写所申请的商标文字" onClick="value='';focus()" style="width:300px;"/> <span style="color: Red;" id="Sb_miaosu1">*</span></td>
                                  </tr>
                                </table>
                            ...
                            <tr>
                              <td height="115" align="left" valign="top">
                                <table width="689" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <tr id="dailifei">                                   
                                    <td height="32" align="right" >官网商标费用：
                                    </td>  
                                   ...
                                   CNY&nbsp;<%=Str_Moneysb%>                                    
                                     ...
                                     <tr>
                                    <td height="32" align="right" >商标代理费用：
                                    </td>  
                                    <td> <span class="font12b4e user_zlbottomline">
                                   CNY&nbsp;<%=sbdailiweituo%>                                    
                                    </span></td>                                  
                                      ...
                                      <tr>
                                    <td align="right" height="32">总计：</td><td><span class="font12b4e user_zlbottomline">
                                  CNY&nbsp;<%=zongjiweituo%>                                    
                                    </span></td>                                    
                                    </tr>
                                    <tr>
                                ...
                                <table width="689" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="429" valign="middle">
                                      <input type="text" runat="server" id="t_anjuanhao" class="font12000" maxlength="100"  onblur="checkanjuanhao();"  onkeyup="value=value.replace(/[^\w]/ig,'')" />
                                    </td>
                                  </tr>
                                  <tr>
...
<tr id="zhitiOk">
                               ...
                               <td ><asp:FileUpload ID="FileUpload3" runat="server" Width="200px"/><div id="sb_namenum1"><span style="color:Red;">格式为.jpg.gif.png.PDF,不大于500K</span></div> </td>  
                                  </tr>
                                  <%} %>                                 
                                   <tr>
                                    <td style="height:50px;width:260px;" align="right">
                               ...
                               <td ><asp:FileUpload ID="FileUpload4" runat="server" Width="200px" /><span style="color:Red;">格式为.jpg.gif.png.PDF,不大于500K</span> </td>   
                                  </tr>
                                  </table>
                                  </td>
                                  </tr>
