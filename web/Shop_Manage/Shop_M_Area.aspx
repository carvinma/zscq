<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_M_Area.aspx.cs" Inherits="Shop_Manage_dimanage" %>
...
<head runat="server"><title></title>
  ...
  <script src="../js/checkcheckbox.js" type="text/javascript"></script>
  <style type="text/css">
...
<body>
  ...
  <h1>
    <%if (pageadd)
      { %><span class="action-span"><a href="Shop_A_Area.aspx">添加地区</a></span><%} %>
    <span class="action-span1"><a href="Shop_Index_Main.aspx">管理中心</a> </span><span id="search_id" class="action-span1">- 地区列表 </span>
  ...
  <div class="form-div">
    地区名称关键词：<input type="text" id="hoot" size="15" value="" runat="server" /><asp:Button ID="Button1" runat="server" Text="搜索" CssClass="button" OnClick="Button1_Click" /></div>
      ...
      <asp:Repeater ID="rep_brand" runat="server" OnItemCommand="rep_brand_ItemCommand">
        <ItemTemplate>
          <tr>
            ...
            <td height="26" align="center"><a href="Shop_A_Area.aspx?id=<%# Eval("id")%>&ye=<%=ye%>&Keyword=<%=Keyword %>">
  ...
  <%--<script type="text/javascript">xuanzecheckbox("listDiv");</script>--%>
  <div style="text-align: center">
    <table class="pager" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <webdiyer:AspNetPager ID="aspPage" ShowPageIndexBox="Never" runat="server" FirstPageText="首页" LastPageText="末页" PrevPageText="上一页" NextPageText="下一页" ShowInputBox="Always" OnPageChanged="aspPage_PageChanged" PageSize="20" SubmitButtonText="GO" TextAfterInputBox=" " SubmitButtonClass="button" NumericButtonCount="7" ShowDisabledButtons="False">
