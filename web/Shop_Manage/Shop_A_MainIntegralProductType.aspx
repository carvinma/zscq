<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_A_MainIntegralProductType.aspx.cs" Inherits="Shop_A_PatentType" ValidateRequest="false" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h1>
            <span class="action-span"><a href="Shop_M_MainIntegralProductType.aspx?<%=returnurl %>">商品大分类列表</a></span> <span class="action-span1"><a
        ...
        <div style="width: 100%; position: fixed; left: 0; bottom: 0px; height: 30px;background: #dfeef5;"><%if ((pageadd && hd.Value == "0") || (pageupdate && hd.Value != "0"))
                            ...
                            OnClientClick="return checkaddnews();" style="margin-left:125px;" /><%} %><% if (hd.Value != "0")
                              ...
                              onclick="javascript:window.location='Shop_M_MainIntegralProductType.aspx?<%=returnurl %>    ';" /><%} %>
        </div>    
