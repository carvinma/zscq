<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_Apl_Patent.aspx.cs" Inherits="Shop_Manage_Shop_Apl_Patent" %>
...
<body>
    ...
    <h1>
        <span class="action-span1"><a href="Shop_Index_Main.aspx">管理中心</a> </span><span id="search_id"
            class="action-span1">- 专利批量导入 </span>
    ...
    <div class="list-div" id="listDiv">
        <table cellspacing='1' cellpadding='3'>
            ...
            <tr>       
                ...
                <td align="left" style="line-height: 22px">个人&公司表格格式下载：<a href="../FileLoad/Patent Informaiton（个人or公司）.xls"><strong>点击下载</strong></a></td>
            </tr>
            <tr>       
                <td align="right" width="100">&nbsp;</td>
                <td align="left" style="line-height: 22px">事务所表格格式下载：<a href="../FileLoad/Patent Informaiton（事务所）.xls"><strong>点击下载</strong></a></td>
            </tr>
            <tr>      
                <td>&nbsp;</td>
                <td>
