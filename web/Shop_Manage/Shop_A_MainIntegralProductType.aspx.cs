    ...
    protected void btOK_Click(object sender, EventArgs e)// 添加专利类型
    {
        ...
        if (hd.Value != "0")
        {
            ...
            if (DALPT.IntegralProductType_Update(model) == 1)
            {
                ...
                string twourl = System.Web.HttpUtility.UrlEncode("Shop_M_MainIntegralProductType.aspx?" + returnurl, System.Text.Encoding.GetEncoding("gb2312"));
                Response.Redirect("shop_manageok.aspx?hrefname=商品分类&hreftype=2&href1=Shop_A_MainIntegralProductType.aspx&href2=" + twourl);
            }
            #endregion
        }
        else
        {
            ...
            if (DALPT.IntegralProductType_Add(model) > 0)
            {
                ...
                string twourl = System.Web.HttpUtility.UrlEncode("Shop_M_MainIntegralProductType.aspx", System.Text.Encoding.GetEncoding("gb2312"));
                Response.Redirect("shop_manageok.aspx?hrefname=商品分类&hreftype=1&href1=Shop_A_MainIntegralProductType.aspx&href2=" + twourl);
            }
            #endregion
        }
    }
