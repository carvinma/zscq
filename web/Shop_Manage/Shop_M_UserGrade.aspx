<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_M_UserGrade.aspx.cs" Inherits="Shop_Manage_Shop_M_UserGrade" %>
...
<body>
  ...
  <h1>
    <%if (pageadd)
      { %><span class="action-span"><a href="Shop_A_UserGrade.aspx">添加会员等级</a></span><%} %>
    <span class="action-span1"><a href="Shop_Index_Main.aspx">管理中心</a> </span><span id="search_id" class="action-span1">- 会员等级列表</span>
  ...
  <div id="list-div" class="list-div">
    <table cellspacing="1" cellpadding="3">
      ...
      <asp:Repeater ID="Repeater1" runat="server">
        <ItemTemplate>
          <tr>
            <td align="center"><img alt="" src="../<%# Eval("nvc_Logo") %>" width="60" /> </td>
            <td align="center">
              <%if (pageupdate)
                { %><a href="Shop_A_UserGrade.aspx?Gid=<%#Eval("i_Id") %>"><%# Eval("nvc_Name") %></a><%}
                else
                { %><%# Eval("nvc_Name") %><%} %>
            </td>
            <td align="center">
            ...
            <td align="center">
              <%if (pagedel)
                { %><%# Eval("i_Id").ToString() == "1" ? "" : "<input type=\"button\" title=\"删除\" class=\"inputicodelbutton\" onclick=\"xwshow('" + Eval("i_Id") + "')\"/>"%><%} %>
            </td>
          </tr>
        </ItemTemplate>
      </asp:Repeater>
      ...
      <tr>
        ...
        <td style="border-style: solid; border-width: 0px 1px 1px 1px; border-color: #578ece; background: #dfeef5; padding: 5px; font-size: 14px; text-align: center;">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td style="font-size: 14px;"><a style="cursor: pointer;" onclick="asdf()">确认</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="###" style="cursor: hand;" onclick="xwhidden()">取消</a> </td>
            </tr>
          </table>
        </td>
        <td>&nbsp; </td>
  ...
  <script type="text/javascript" language="javascript">
    ...
    function asdf() {
      ...
      window.location = 'Shop_M_UserGrade.aspx?PageType=del&Gid=' + delid;
    }
    function divhidden() {
