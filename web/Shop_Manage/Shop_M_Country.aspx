<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_M_Country.aspx.cs" Inherits="Shop_M_Country" %>
...
<body>
  ...
  <h1>
    <span class="action-span"><a href="Shop_A_Country.aspx">添加国家</a></span> <span class="action-span1"><a href="Shop_Index_Main.aspx">管理中心</a> </span><span id="search_id" class="action-span1">- 国家列表 </span>
  ...
  <div class="form-div">
    国家名称关键词：<input type="text" id="hoot" size="15" value="" maxlength="30" runat="server" />&nbsp;<asp:DropDownList ID="ddl_CType" runat="server" Visible=false>
      <asp:ListItem Value="1">中文</asp:ListItem>
      <asp:ListItem Value="2">英文</asp:ListItem>
      <asp:ListItem Value="3">日文</asp:ListItem>
      <asp:ListItem Value="4">韩文</asp:ListItem>
    </asp:DropDownList>
      ...
      <asp:Repeater ID="rep_brand" runat="server" EnableViewState="false">
        <ItemTemplate>
          <tr>
            ...
            <td height="26" align="center"><a href="Shop_A_Country.aspx?id=<%# Eval("i_Id")%>&ye=<%=ye%>&Keyword=<%=Keyword %>&CType=<%=CType%>">
              <%=ifhave==true?"修改":"查看"%></a> </td>
          </tr>
        </ItemTemplate>
      </asp:Repeater>
      <tr align="left">
