<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_M_ExChange.aspx.cs" Inherits="Shop_Manage_shengmanage" %>
...
<body>
    ...
    <div class="form-div">国家名称关键词：<input type="text" id="hoot" size="15" value="" runat="server" MaxLength="30"/>&nbsp;<asp:DropDownList
        ID="ddl_CType" runat="server">
    ...
    <div class="list-div" id="listDiv">
        <table cellspacing='1' cellpadding='3'>
            ...
            <asp:Repeater ID="rep_brand" runat="server" 
                onitemcommand="rep_brand_ItemCommand" 
                onitemdatabound="rep_brand_ItemDataBound" >
                <ItemTemplate>
                    <tr>
                        ...
                        <td height="26" align="center">
                         ...
                         <td height="26" align="center">
                              <asp:TextBox ID="tb_cn" runat="server" Width="60px" Text='<%# Eval("dm_Exchange") %>' MaxLength="9" onkeypress="event.returnValue=IsDigit();"></asp:TextBox> </td>
                          <td height="26" align="center">
                              <asp:TextBox ID="tb_exchange" runat="server" Width="60px" Text='<%# Eval("dm_Exchange1") %>' MaxLength="9" onkeypress="event.returnValue=IsDigit();"></asp:TextBox> </td>
                                <td height="26" align="center">
                              <asp:TextBox ID="tb_Meiyuan" runat="server" Width="60px" Text='<%# Eval("dm_Exchange2") %>' MaxLength="9" onkeypress="event.returnValue=IsDigit();"></asp:TextBox> </td>
                        <td height="26" align="center">
                            <asp:Button ID="bt_update" class="inputicoeditbutton" runat="server"  Text="" CommandName="update"  CommandArgument='<%# Eval("i_Id") %>' />
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
            <tr align="left">
                <td height="25" colspan="6"><input name="checkall" id="checkall" type="checkbox" onclick="SelAll()" />
                    <input type="button" id="Button2" runat="server" value="删除" onclick="xwshow()"
                          class="button" />
                </td><td colspan="2">
                    <asp:Button ID="Button3" runat="server" class="button" Text="更新全部" onclick="Button3_Click" />
                </td>
    ...
    <table class="pager" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td><asp:Label ID="Lb_sum" runat="server"></asp:Label>&nbsp;<b style="color: Red;">20</b><asp:Label ID="Label1" runat="server" Text="条/页"></asp:Label>&nbsp;<asp:Label ID="Lb_ye" runat="server"></asp:Label>&nbsp;</td><webdiyer:AspNetPager
                     NumericButtonCount="7" ID="aspPage" ShowPageIndexBox="Never" runat="server" ShowFirstLast="true"
...
<td width="34" background="images/ts_bg.jpg" ><img alt="取消" src="images/dingdan2.gif" width="34" height="27" style="cursor: hand;" onclick="divoperation(2,'1')" /></td>
            ...
            <tr>
                ...
                <td style="border-style: solid; border-width: 0px 1px 1px 1px; border-color: #578ece;
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td align="center" style=" font-size: 14px;"><a><asp:LinkButton ID="LinkButton1" runat="server" OnClick="Button2_Click1">确认</asp:LinkButton></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="###" style="cursor: hand;" onclick="divoperation(2,'1')">取消</a></td></tr></table>
                </td>
                <td>
                </td>
            </tr>
