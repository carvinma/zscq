<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_M_Province.aspx.cs" Inherits="Shop_Manage_shengmanage" %>
...
<body>
    ...
    <h1>
        <span class="action-span"><a href="Shop_A_Province.aspx">添加省份</a></span> <span class="action-span1">
    ...
    <div class="form-div">省份名称关键词：<input type="text" id="hoot" size="15" value="" runat="server" />&nbsp;<asp:Button ID="Button1" runat="server" Text="搜索" OnClick="Button1_Click" CssClass="button" />
    </div>
    <div class="list-div" id="listDiv">
        <table cellspacing='1' cellpadding='3'>
            ...
            <asp:Repeater ID="rep_brand" runat="server" EnableViewState="false">
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <%#DALN.Nationality_Select_Id(Convert.ToInt32(Eval("guojiaID"))).nvc_Name%>
                        </td>
                        <td align="center">
                            <%# Eval("provinceID")%>
                        </td>
                        ...
                        <td height="26" align="center">
                            <a href="Shop_A_Province.aspx?id=<%# Eval("i_ID")%>&ye=<%=ye%>&Keyword=<%=Keyword %>">
                                <%=ifhave==true?"修改":"查看"%></a>
                        </td>
                    </tr>
                </ItemTemplate>
            ...
            <tr align="left">
                <td height="25" colspan="4"><input name="checkall" id="checkall" type="checkbox" onclick="SelAll()" />
