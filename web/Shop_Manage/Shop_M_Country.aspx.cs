...
public partial class Shop_M_Country : System.Web.UI.Page
{
    public int ye = 1;
    public string Keyword = "";
    public bool ifhave = Manager.GetManagerQX(41,2);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Manager.GetManagerQX(41,3) == false)
        {
    ...
    protected void Button2_Click1(object sender, EventArgs e)
    {
        if (Request.Form["inputPageid"] != null)
        {
            ...
            for (int i = 0; i < IDList.Length; i++)
            {
                ...
                DALN.Nationality_Del(int.Parse(IDList[i]));
            }
