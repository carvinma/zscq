<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_M_Help.aspx.cs" Inherits="Shop_Manage_shop_type" %>
...
<body>
    ...
    <div>
        <h1>
            <%if (htpageadd)
              { %><span class="action-span"><a href="shop_A_HelpType.aspx">添加帮助类别</a></span><%} %> <span class="action-span1">
        ...
        <%=table_Category%>
                ...
                <asp:Repeater ID="rpList" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                                <%# SetHelpClassName(Eval("i_Id"))%>
                            </td>
                            <td height="26" align="center">
                                <%#Eval("nvc_Title")%>
                            </td>
                            <td height="26" align="center">
                                <a href="Shop_A_Help.aspx?book_id=<%#Eval("i_Id") %>&ye=<%=ye %>&Keyword=<%=Keyword %>&TypeHelp=<%=TypeHelp %>">
                                    <%if (pageupdate)
          ...
          {%>修改<%}
                ...
                <tr align="left">
                    <td height="25" colspan="4"><input name="checkall" id="checkall" type="checkbox" onclick="SelAll()" />&nbsp;<%if (pagedel)

          {%><input type="button" id="btnDel" runat="server" value="删除" onclick="xwshow()"
                          class="button" /><%} %>
                    </td>
                </tr>
            </table>--%>
        ...
        <table class="pager" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td><asp:Label ID="Lb_sum" runat="server"></asp:Label>&nbsp;<b style="color: Red;">20</b><asp:Label ID="Label1" runat="server" Text="条/页"></asp:Label>
                    &nbsp;<asp:Label ID="Lb_ye" runat="server"></asp:Label>&nbsp;</td><webdiyer:AspNetPager NumericButtonCount="7" ID="aspPage" ShowPageIndexBox="Never" runat="server" ShowFirstLast="true"
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="border: 1px solid #578ece; height: 30px; background: #dfeef5; color: Red;
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr><td width="40%" align="right"><img alt="" width="30" src="images/caozuo_2.jpg" /></td><td width="60%" align="left" style="font-size:14px;">
                            &nbsp;删除成功</td></tr>
                    </table>
                </td>
                <td width="45%">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td style="border-style: solid; border-width: 0px 1px 1px 1px; border-color: #578ece;
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td style=" font-size: 14px;"><a><asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnDel_Click">确认</asp:LinkButton></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;<a href="###" style="cursor: hand;" onclick="divoperation(2,'1')">取消</a></td></tr></table>
                </td>
                <td>
                </td>
            </tr>
                ...
                <td style="border: 1px solid #578ece; height: 30px; background: #dfeef5; color: Red;
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td width="25%" align="right"><img alt="" width="30" src="images/caozuo_3.jpg" /></td><td width="75%" align="left" style="font-size: 14px;">
                            &nbsp;请选中您要删除的记录</td>
