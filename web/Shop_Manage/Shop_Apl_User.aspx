<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_Apl_User.aspx.cs" Inherits="Shop_Manage_Shop_Apl_Patent" %>
...
<body>
    ...
    <h1>
        <span class="action-span1"><a href="Shop_Index_Main.aspx">管理中心</a> </span><span id="search_id"
            class="action-span1">- 客户批量导入 </span>
    ...
    <div class="list-div" id="listDiv">
        <table cellspacing='1' cellpadding='3'>
            ...
            <tr>       
                ...
                <td align="left" style="line-height: 22px">表格格式下载：<%if (usertype == 1)
                                { %>
                              <a href="../FileLoad/shop_apl_patentuser.xls"><strong>点击下载</strong></a><%}
                                else { %>
                                 <a href="../FileLoad/shop_apl_sbuser.xls"><strong>点击下载</strong></a>
                               <% } %>
