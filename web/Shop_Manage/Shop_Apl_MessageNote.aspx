<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_Apl_MessageNote.aspx.cs" Inherits="Shop_Manage_shop_smspl" %>
...
<body onbeforecopy="return false" oncopy="document.selection.empty()" onselect="document.selection.empty()">
  ...
  <div>
    <h1>
      <span class="action-span"></span><span class="action-span1"><a href="Shop_Index_Main.aspx">管理中心</a> </span><span id="search_id" class="action-span1">- 短信群发</span>
    ...
    <div class="list-div" id="listDiv">
      <table cellspacing='1' cellpadding='3'>
        ...
        <tr>
          <td valign="top" align="right" width="100">语言版本：</td>
          <td>
        ...
        <tr>
          <td valign="top" align="right" width="100">手机号码：</td>
          <td>
            <textarea name="phones" cols="100" style="width: 80%;" rows="5" id="phones" runat="server" onblur="checknull('phones','fphones')"></textarea>&nbsp;<br />
            <font color="#FF0000">*(多个手机号码之间用“;”号分开)</font>&nbsp;<input type="button" name="Submit" title="复制手机号码" onclick='copyToClipBoard()' class="inputicocopybutton">&nbsp;<font id="fphones" class="alertfont" style="display: none;"><img alt="警告" src="images/caozuo_3.jpg" width="15" />请填写手机号码</font></td>
        </tr>
        <tr>
          <td valign="top" align="right">短信内容：</td>
          <td>
            <textarea name="content" cols="100" style="width: 80%;" rows="5" id="content" runat="server" onblur="checknull('content','fcontent')"></textarea>&nbsp;<font color="#FF0000">*</font>&nbsp;<font id="fcontent" class="alertfont" style="display: none;"><img alt="警告" src="images/caozuo_3.jpg" width="15" />请填写短信内容</font></td>
        </tr>
        <tr>
          <td></td>
          <td>
            <% if (pageadd)
               { %><asp:Button ID="btnFS" runat="server" Text="发送" class="button" OnClick="btnFS_Click" /><%} %></td>
        </tr>
      </table>
    </div>
