<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_A_Admin.aspx.cs" Inherits="Shop_Manage_Shop_A_Admin" %>
...
<body>
  <form id="form1" runat="server" name="form1" method="post" onsubmit="return checkinput();">
  <h1>
    <span class="action-span"><a href="Shop_M_Admin.aspx">管理员列表</a></span> <span class="action-span1"><a href="Shop_Index_Main.aspx">管理中心</a> </span><span id="search_id" class="action-span1">- 添加管理员 </span>
  ...
  <div id="list-div" class="list-div">
    <table cellpadding="3" cellspacing="1">
      ...
      <tr>
        ...
        <td>
          <input name="admin_name1" id="admin_name1" type="text" class="inputs200text" maxlength="25" />&nbsp;<font color="#FF0000">*</font> </td>
        <td>&nbsp; </td>
      </tr>
      <tr>
        <td width="100" align="right">管理密码： </td>
        <td>
          <input name="admin_pass1" id="admin_pass1" type="password" class="inputs200text" maxlength="26" />&nbsp;<font color="#FF0000">*</font> </td>
        <td>&nbsp; </td>
      </tr>
      <tr>
        <td width="100" align="right">真实姓名： </td>
        <td>
          <input name="admin_realname1" id="admin_realname1" type="text" class="inputs200text" maxlength="10" />
        </td>
        <td>&nbsp; </td>
      </tr>
      <tr>
        ...
        <td>
          <asp:DropDownList ID="DDL_Group" runat="server" AppendDataBoundItems="True" onchange="changegroup()">
          </asp:DropDownList>
        </td>
        <td>&nbsp; </td>
      </tr>
...
<script type="text/javascript" language="javascript">
  function changegroup() {
    if (document.getElementById('DDL_Group').value == '0') {
      ...
      document.getElementById('tr_power').style.display = 'none';
    }
  }
  changegroup();
  function checkinput() {
    var flag = true;
    if (document.getElementById('admin_name1').value == "") {
      alert("管理账号不能为空!");
      document.getElementById('admin_name1').focus();
      flag = false;
      return flag;
    }
