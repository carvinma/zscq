<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Goods_SubCategoryList.aspx.cs" Inherits="Shop_Manage_NewManage_Goods_SubCategoryList" %>
...
<body>
    ...
    <h1>
        <span class="action-span"><a href="Goods_SubCategory.aspx">添加小类别</a></span> <span class="action-span1">
    ...
    <div class="form-div">
        商品小类别关键词：<input type="text" id="hoot" size="15" value="" runat="server" />
        &nbsp;
        <asp:Button ID="btnQuery" runat="server" Text="搜索" CssClass="button" 
                ...
                <ItemTemplate>
                    <tr>
                        <td height="26" align="center">
                         ...
                         <td align="center">
                            <%# Eval("MainCategoryCode")%>
                        </td>
                        <td align="center">
                            <%# Eval("DetailCategoryCode")%>
                        </td>
                        <td height="26" align="center">
                            <%# Eval("DetailCategoryRemark")%>
                        </td>
                        <td height="26" align="center">
                            <a href="Goods_SubCategory.aspx?id=<%# Eval("id")%>&PageNo=<%=PageNo%>&Keyword=<%=Keyword %>">
                                <%=ifhave==true?"修改":"查看"%></a>
                        </td>
                    </tr>
                </ItemTemplate>
