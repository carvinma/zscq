            ...
            <table cellspacing='1' cellpadding='3'>
                ...
                <td colspan="2">
                  <table  width="689" border="0" cellspacing="0" cellpadding="0">
                                                               ...
                                                               <td >
                                                               <table>
                                                               <tr><td height="32" width="276" align="right"><span>商标注册申请书：</span></td>
                                                               <td></td></tr>
                                                               <tr><td height="32" width="276" align="right"><span>商标申请委托书：</span></td>
                                                               <td>&nbsp;</td></tr>
                                                               <tr><td height="32" width="276" align="right"><span>商标续展申请书：</span></td>
                                                               <td>&nbsp;</td></tr>
                                                               <tr><td height="32" width="276" align="right"><span>商标续展委托书：</span></td>
                                                               <td>&nbsp;</td></tr>
                    ...
                    是否接受邮件期限提醒</td></tr>
                                                               ...
                                                               <td> 
                                                                   <asp:TextBox ID="TextBox1" runat="server"  style="width: 293px;
                                                               ...
                                                               <tr>
                                                                  <td colspan="3">  
                                                                      <div class="list-div" id="Div1">
                                                                        <table cellspacing='1' cellpadding='3' id="tblData" width="100%">
                                                                            <tr>
                                                                                <th width="2%"></th>
                                                                                <th width="10%">账单号</th>
                                                                                <th width="10%">添加时间</th>
                                                            ...
                                                            --%>
                                                             ...
                                                             <input type="button" id="btnAdd" runat="server" class="button" style="display:none;" value="增加一条明细" />
                                                                 ...
                                                                 ID="Button1" runat="server" Text="提交数据" OnClientClick="return dalclick();" /></td>
                                                                            </tr>
                                                                        </table>
                                                                        <table cellspacing='1' cellpadding='3'>
                                                                            <tr align="left">
        ...
        <%if ((pageadd && hd_id.Value == "0") || (pageupdate && hd_id.Value != "0"))
         { %>
           <asp:Button ID="btOK" runat="server" Text="提交" class="button" OnClick="btOK_Click"
                            OnClientClick="return checkaddnews();" style="margin-left:350px;" />
                            <%} %>
                            <% if (hd_id.Value != "0")
