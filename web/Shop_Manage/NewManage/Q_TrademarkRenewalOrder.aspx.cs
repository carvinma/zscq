...
public partial class Q_TrademarkRenewalOrder : System.Web.UI.Page
{
    ...
    private void Bind_Rpt_Order(int pageCurrent)//绑定订单
    {
        ...
        IQueryable query = DALTO.TrademarkOrder_New_SelectPage(pageCurrent, PageSize,1, Keyword, SType, State, int.Parse(ddl_SbType.SelectedValue), TimeType, txtStartDate.Value, txtEndDate.Value, ordernum, username, cname, cbianhao, orderstate, totalmoney, addtime, paytime, ref count);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        GridView1.DataSource = DALTO.TrademarkOrder_New_SelectPage(1, 100000000,1, Keyword, SType, State, int.Parse(ddl_SbType.SelectedValue), TimeType, txtStartDate.Value, txtEndDate.Value, ordernum, username, cname, cbianhao, orderstate, totalmoney, addtime, paytime, ref count);
        GridView1.DataBind();
        toExecl(GridView1);
