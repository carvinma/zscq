<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Q_TrademarkRenewalOrder.aspx.cs" Inherits="Q_TrademarkRenewalOrder" %>
             ...
             <td align="center">
               <asp:Repeater runat="server" ID="repTrademark">
                    ...
                    <div style="text-align: center; width: 100%;height:30px;line-height:30px;">
                        ...
                        href="M_TrademarkInfo.aspx?id=<%# Eval("i_Id") %>" class="ac5t">
                                                        <%# Eval("CaseNo")%></a>
                    </div>
                    </ItemTemplate>
                  </asp:Repeater>
