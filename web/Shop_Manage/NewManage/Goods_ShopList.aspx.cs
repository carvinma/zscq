...
public partial class Shop_Manage_NewManage_Goods_ShopList : System.Web.UI.Page
{
    public int PageNo = 1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Bind_Page_value();
            BindShop(PageNo, this.hoot.Value.Trim());
        }
    }
    ...
    private void BindShop(int pageCurrent, string name)
    {
        Keyword = name;
        int PageSize = 20;
        int count = 0;
        this.rep_brand.DataSource = goods.Goods_SelectPage(pageCurrent, PageSize, name, ref count);
    ...
    {
        BindShop(((Wuqi.Webdiyer.AspNetPager)sender).CurrentPageIndex, this.hoot.Value);//翻页
    ...
    protected void btnDel_Click(object sender, EventArgs e)
    {
        if (Request.Form["inputPageid"] != null)
        {
            ...
            Manager.AddLog(0, "商品管理", "删除商品");
        }
        BindShop(aspPage.CurrentPageIndex, this.hoot.Value.Trim());
        HiddenDel.Value = "del";
    }
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        BindShop(1, this.hoot.Value.Trim());
    }
}