<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Goods_MainCategoryList.aspx.cs" Inherits="Shop_Manage_NewManage_Goods_MainCategoryList" %>
...
<body>
    ...
    <h1>
        <span class="action-span"><a href="Goods_MainCategory.aspx">添加类别</a></span> <span class="action-span1">
    ...
    <div class="form-div">商品类别关键词：<input type="text" id="hoot" size="15" value="" runat="server" />&nbsp;<asp:Button 
            ID="btnSearch" runat="server" Text="搜索" CssClass="button" 
    ...
    <div class="list-div" id="listDiv">
        <table cellspacing='1' cellpadding='3'>
            ...
            <asp:Repeater ID="rep_brand" runat="server" EnableViewState="false">
                <ItemTemplate>
                    <tr>
                        ...
                        <td height="26" align="center">
                            <a href="Goods_MainCategory.aspx?id=<%# Eval("i_ID")%>&PageNo=<%=PageNo%>&Keyword=<%=Keyword %>">
                                <%=ifhave==true?"修改":"查看"%></a>
                        </td>
                    </tr>
                </ItemTemplate>
            ...
            <tr align="left">
                <td height="25" colspan="3"><input name="checkall" id="checkall" type="checkbox" onclick="SelAll()" />
    ...
    <table class="pager" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td><asp:Label ID="Lb_sum" runat="server"></asp:Label>&nbsp;<b style="color: Red;">20</b><asp:Label ID="Label1" runat="server" Text="条/页"></asp:Label>&nbsp;<asp:Label ID="Lb_ye" runat="server"></asp:Label>&nbsp;</td>
...
<td width="34" background="../images/ts_bg.jpg" ><img alt="取消" src="../images/dingdan2.gif" width="34" height="27" style="cursor: hand;" onclick="divoperation(2,'1')" /></td>
            ...
            <tr>
                ...
                <td style="border-style: solid; border-width: 0px 1px 1px 1px; border-color: #578ece;
                    ...
                    <a><asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnDel_Click">确认</asp:LinkButton>
                    </a>&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="###" style="cursor: hand;" onclick="divoperation(2,'1')">取消</a></td></tr>
                    </table>
                </td>
                <td>
                </td>
