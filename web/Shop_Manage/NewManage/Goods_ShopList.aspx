...
<body>
    ...
    <h1>
        <span class="action-span"><a href="Goods_Shop.aspx">添加商品</a></span> <span class="action-span1">
    ...
    <div class="form-div">
        商品关键词：<input type="text" id="hoot" size="15" value="" runat="server" />
        &nbsp;
            ...
            <asp:Repeater ID="rep_brand" runat="server" EnableViewState="false">
                <ItemTemplate>
                    <tr>
                        ...
                        <td height="26" align="center">
                            <a href="Goods_Shop.aspx?id=<%# Eval("id")%>&PageNo=<%=PageNo%>&Keyword=<%=Keyword %>">
                                <%=ifhave==true?"修改":"查看"%></a>
                        </td>
                    </tr>
                </ItemTemplate>
