<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Goods_Shop.aspx.cs" Inherits="Shop_Manage_NewManage_Goods_Shop" %>
...
<body>
    ...
    <h1>
        <span class="action-span"><a href="Goods_ShopList.aspx<%="?PageNo=" + Hidden1.Value + "&Keyword=" + Hidden2.Value %>">商品列表</a></span> <span class="action-span1">
