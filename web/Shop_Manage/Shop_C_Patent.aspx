<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_C_Patent.aspx.cs" Inherits="Shop_Manage_Shop_C_Patent" %>
    ...
    <div>
        <h1>
            <span class="action-span"></span><span class="action-span1"><a href="Shop_Index_Main.aspx">
                管理中心</a> </span><span id="search_id" class="action-span1">- 专利个人统计 </span>
                                ...
                                <table cellspacing='1'>
                                    <asp:Repeater ID="rept_list1" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td align="center">
                                                    <%#GetGuoJiaNameById(Eval("i_AuthorizeNationalityId"))%>
                                                    (<%#GetPatentCountById(Eval("i_MemberId"), Eval("i_AuthorizeNationalityId"))%>个)
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
