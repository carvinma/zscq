<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_M_FriendLink.aspx.cs"
    Inherits="Shop_Manage_Link_islink" %>
...
<body>
    ...
    <h1>
        <%if (pageadd)
          {%><span class="action-span"><a href="Shop_A_FriendLink.aspx">添加链接</a></span><%} %>
        <span class="action-span1"><a href="Shop_Index_Main.aspx">管理中心</a> </span><span id="search_id"
            class="action-span1">- 链接管理 </span>
    ...
    <div class="form-div">
        <table>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddl_CQuYu" runat="server">
                    </asp:DropDownList>
                </td>
                <td>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <img src="../<%# Eval("nvc_Pic")%>" width="60" height="60" />
                        </td>
                        <td align="center">
                            <%if (pageupdate)
                              {%><a href="Shop_A_FriendLink.aspx?Id=<%# Eval("i_Id") %>&ye=<%=ye %>&title=<%=title.Value %>&CQuYu=<%=ddl_CQuYu.SelectedValue %>&CType=<%=ddl_CType.SelectedValue %>"><%# Eval("nvc_LinkName")%></a><%}
                              else
                              {%><%# Eval("nvc_LinkName")%><%} %>
                        </td>
                        <td align="center">
                            <a target="_blank" href="<%# Eval("nvc_Link")%>">点击链接</a>
                        </td>
                        <%--<td align="center">
              <input type="button" class="inputicocopybutton" onclick="javascript:window.location='Shop_A_FriendLink.aspx?fId=<%# Eval("i_Id") %>'"
                title="复制" />
              <a href="Shop_A_FriendLink.aspx?fId=<%# Eval("i_Id") %>">复制</a>
            </td>--%>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
    ...
    <div id="divbox" style="position: fixed; _position: absolute; left: 0; top: 250px;
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="font-size: 14px;">
                                <a>
                                    <asp:LinkButton ID="lbtn_Del" runat="server" OnClick="lbtn_Del_Click">确认</asp:LinkButton></a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                        href="###" style="cursor: hand;" onclick="xwhidden()">取消</a>
                            </td>
                        </tr>
                    </table>
                </td>
