<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_M_Trademark.aspx.cs"
    Inherits="Shop_Manage_shop_delhw" %>
...
<body>
        ...
        <table width="800" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td align="left">
                    <input type="text" id="hw_name" size="15" title="关键词" runat="server" />&nbsp;<asp:DropDownList
                        ...
                        <%--     <asp:ListItem Text="多字段" Value="3"></asp:ListItem>--%>
            ...
            <tr>
                ...
                <td height="28" align="left">
                    <asp:DropDownList ID="ddl_jiaofei" runat="server" AppendDataBoundItems="True">
                        <asp:ListItem Text="请选择缴费类型" Value="0"></asp:ListItem>
                        <asp:ListItem Text="委托缴费" Value="2"></asp:ListItem>
                        <asp:ListItem Text="自行缴费" Value="1"></asp:ListItem>
                    </asp:DropDownList>
                    &nbsp;
                    <asp:DropDownList ID="DDL_guoji" runat="server" AppendDataBoundItems="True">
                        <asp:ListItem Text="请选择国籍" Value="0"></asp:ListItem>
                    </asp:DropDownList>
                    ...
                    &nbsp;<asp:DropDownList ID="DDl_regtype" runat="server" AppendDataBoundItems="True">
                        <asp:ListItem Text="请选择语言" Value="0"></asp:ListItem>
                        <asp:ListItem Text="中文" Value="1"></asp:ListItem>
                        <asp:ListItem Text="外文" Value="2"></asp:ListItem>
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td align="left">
                    会员总数：
                    <%=usercount %>
                    |自行缴费的商标总数:<%=zixingjiaofei%>
                    |已接受委托的商标总数:<%=weituocount %>
                    |已完成缴费委托的商标总数：<%=weituoJiaofeiOKcount%>
                </td>
            </tr>
        </table>
    </div>
            ...
            <tr align="left">
                <td bgcolor="#FFFFFF" height="23">
                    <input name="checkall" id="checkall2" type="checkbox" onclick="SelAll(this)" />&nbsp;<%if (pagedel)
                                                                                                           ...
                                                                                                           {%>
                    <asp:Button ID="Button5" runat="server" class="button" Text="导出商标" OnClick="Button2_Click" />
                ...
                <td bgcolor="#FFFFFF" height="23">
                    <input name="checkall" id="checkall" type="checkbox" onclick="SelAll(this)" />&nbsp;<%if (pagedel)
                                                                                                          {%><input type="button" id="Button1" runat="server" value="删除" onclick="xwshow()"
                                                                                                              class="button" /><%} if (pagechu)
                                                                                                          {%><input type="button" class="button" value="导入" onclick="javascript:window.location='Shop_Apl_Trademark.aspx';">
                    <asp:Button ID="Button2" runat="server" class="button" Text="导出商标" OnClick="Button2_Click" /><%} %>
                </td>
            </tr>
        </table>
    </div>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderStyle="None"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="nvc_SBRegNum" HeaderText="商标编号" />
            <asp:BoundField DataField="nvc_SBType" HeaderText="商标类型" />
            <asp:BoundField DataField="nvc_SBRegName" HeaderText="商标注册人姓名" />
            <asp:BoundField DataField="nvc_SBRegEnName" HeaderText="注册人英文名称" />
            <asp:TemplateField HeaderText="地址">
                <ItemTemplate>
                    <%# StringHelper.AddressGId_Pid_Cid_Aid(int.Parse(Eval("sb_RegGuoji").ToString()),int.Parse(Eval("i_ProvinceId").ToString()),int.Parse(Eval("i_CityId").ToString()),int.Parse(Eval("i_AreaId").ToString()))%>
                </ItemTemplate>
            </asp:TemplateField>
      ...
      <asp:BoundField DataField="nvc_SBDescribe" HeaderText="商标描述" />
            ...
            <asp:TemplateField HeaderText="商标类别">
                <ItemTemplate>
                    <%#Eval("i_JiaoFeiType").ToString() == "1" ?"自行缴费" :"委托缴费"%>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="nvc_CFaxnumber" HeaderText="案卷号" />
      <asp:BoundField DataField="nvc_OtherName" HeaderText="联系人" />
      <asp:BoundField DataField="nvc_CTel" HeaderText="电话" />
      <asp:BoundField DataField="nvc_CAddress" HeaderText="地址" />
        </Columns>
    </asp:GridView>
