<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_M_UserLog.aspx.cs" Inherits="Shop_Manage_Shop_M_UserLog" %>
...
<body>
  ...
  <h1>
    <span class="action-span1"><a href="Shop_Index_Main.aspx">管理中心</a> </span><span id="search_id" class="action-span1">-- 用户日志 </span>
  ...
  <div class="form-div">
    用户名：<input type="text" runat="server" id="txt_UserName" maxlength="50" class="input" />
        ...
        <ItemTemplate>
          <tr bgcolor="#FFFFFF">
            <td height="25" align="center">
              <input name="inputPageid" onclick="Selbox(this)" type="checkbox" value="<%# Eval("LogID")%>">
            </td>
            <td align="center">
              <%# Eval("nvc_Name")%>
            </td>
            ...
            <td align="center">
              <%# Eval("nvc_LogContent") != null ? Eval("nvc_LogContent").ToString().Replace("[", "[<font color=\"red\">").Replace("]", "</font>]") : Eval("nvc_LogContent")%>
            </td>
            <td align="center">
              <%# Eval("ip")%></td>
            <td align="center">
  ...
  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
    <Columns>
      <asp:BoundField DataField="nvc_Name" HeaderText="操作管理员" />
      <asp:BoundField DataField="time" HeaderText="操作时间" />
      <asp:BoundField DataField="ip" HeaderText="IP" />
      <asp:BoundField DataField="pindao" HeaderText="频道" />
      <asp:BoundField DataField="nvc_LogContent" HeaderText="操作记录" />
    </Columns>
  </asp:GridView>
