...
public partial class Shop_Manage_shop_upsystem : System.Web.UI.Page
{
    ...
    public void Bind_Page_Info()
    {
        ...
        txt_NewApply.Text = model.i_NewSbApply.ToString();
        txt_NewRenewal.Text = model.i_NewSbRenewal.ToString();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        model.i_NewSbApply = Convert.ToInt32(txt_NewApply.Text);
        model.i_NewSbRenewal = Convert.ToInt32(txt_NewRenewal.Text);
