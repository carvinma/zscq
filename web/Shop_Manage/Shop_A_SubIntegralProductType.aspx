<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_A_SubIntegralProductType.aspx.cs" Inherits="Shop_A_PatentType" ValidateRequest="false" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h1>
            <span class="action-span"><a href="Shop_M_SubIntegralProductType.aspx?<%=returnurl %>">商品小分类列表</a></span> <span class="action-span1"><a
            ...
            <tr>
                ...
                <tr>
                    ...
                    <input type="text" runat="server" id="txt_zhongwen" class="inputs200text" MaxLength="40"/>
                        ...
                        <img alt="警告" src="images/caozuo_3.jpg" width="15" />请填写商品小分类名称</font>
                     </td>
                </tr>
                <tr>
