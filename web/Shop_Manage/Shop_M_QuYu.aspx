<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_M_QuYu.aspx.cs" Inherits="Shop_Manage_Shop_M_QuYu" %>
...
<body>
    ...
    <h1>
        <span class="action-span"><a href="Shop_A_QuYu.aspx">
            添加区域</a></span> <span class="action-span1"><a href="Shop_Index_Main.aspx">管理中心</a>
        </span><span id="search_id" class="action-span1">- 区域列表 </span>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="center" style="font-size: 14px;">
                                <a>
                                    <asp:LinkButton ID="lbtn_Ok" runat="server" OnClick="lbtn_Ok_Click">确认</asp:LinkButton></a>&nbsp;&nbsp;&nbsp;&nbsp;<a
