...
public partial class user_shopcoupon : System.Web.UI.Page
{
    ...
    public void Bind_Page_Title()
    {
        ...
        TitleOrKeyword = "<title>我的优惠券_商标系统_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
    }
    ...
    public void Bind_Rpt_CouponUnUse()//未使用
    {
        ...
        {
            div_Coupon1.Append("<tr><td colspan=\"7\" height=\"25\" width=\"13%\" align=\"center\" bgcolor=\"#FFFFFF\">您没有未使用的优惠券</td></tr>");
        }
    }
    public void Bind_Rpt_CouponUsed()//已使用
    {
        ...
        {
            div_Coupon2.Append("<tr><td colspan=\"7\" height=\"25\" width=\"13%\" align=\"center\" bgcolor=\"#FFFFFF\">您没有已使用的优惠券</td></tr>");
        }
    }
