...
<body id="links">
  ...
  <uc3:zscqadv ID="zscqadv1" TypeId="50" runat="server" />
          ...
          <tr>
            ...
            <td width="906" height="27" align="left" valign="top" style="background-color: #f4f4f4;">
              <table width="906" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="174" height="27" align="center" bgcolor="<%=  ftype == "1" ? "#bf2831" : "#404040"%>"><a href="links.aspx?ftype=1" class="ac6">各国专利局</a> </td>
                  <td width="2"></td>
                  <td width="174" height="27" align="center" bgcolor="<%=  ftype == "2" ? "#bf2831" : "#404040"%>"><a href="links.aspx?ftype=2" class="ac6">各国商标局</a> </td>
                  <td width="2"></td>
                  <td width="174" height="27" align="center" bgcolor="<%=  ftype == "3" ? "#bf2831" : "#404040"%>"><a href="links.aspx?ftype=3" class="ac6">其他</a> </td>
                  <td width="380">&nbsp; </td>
                </tr>
              </table>
            </td>
