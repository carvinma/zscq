...
public partial class Login : System.Web.UI.Page
{
    ...
    public string unvalue = "用户名/邮箱/手机";
        ...
        if (Request["esc"] != null)
        {
            if (Request.Cookies["hqhtshop"] != null)
            {
                ...
                if (Request.Cookies["hqhtshop"]["hqht_sb_uid"] != null && Request.Cookies["hqhtshop"]["hqht_sb_uid"] != "" && Request.Cookies["hqhtshop"]["hqht_sb_uid"] != "0")
                {
                    ...
                    Response.Cookies.Set(cookie);
                    UserLog.AddUserLog(Request.Cookies["hqhtshop"]["hqht_sb_uid"].ToString(), "商标系统", "登出商标系统");
                ...
                {
                    HttpCookie cookie = Request.Cookies["hqhtshop"];
                    if (Request.Cookies["hqhtshop"]["hqht_shop_mid"] != null && Request.Cookies["hqhtshop"]["hqht_shop_mid"] != "" && Request.Cookies["hqhtshop"]["hqht_shop_mid"] != "0")
                    {
                        cookie.Values["hqht_shop_mid"] = null;
                    } 
