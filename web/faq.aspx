...
<body id="faq">
                ...
                <tr>
                  ...
                  <td align="left" valign="top">
                    <table width="480" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="41" height="32" align="left"><strong>主题：</strong> </td>
                      ...
                      <tr>
                        <td height="32" align="left"><strong>邮箱：</strong> </td>
                        <td valign="middle">
                      ...
                      <tr>
                        <td height="88" align="left"><strong>内容：</strong> </td>
                        <td valign="middle">
                      ...
                      <tr>
                        <td height="30" colspan="2" align="center"><strong style="color: #d34245;">如您需得到更全面的帮助请直接联系我们</strong> </td>
                      </tr>
                      <tr>
  ...
  <uc3:zscqadv ID="zscqadv1" TypeId="49" runat="server" />
    ...
    <tr>
      <td height="78" align="left" valign="top">
        <table width="1001" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="618" align="left" valign="top"><img src="images/faq.gif" width="212" height="78" /> </td>
            <td width="94" align="left"><a href="javascript:void(0)"><img src="images/faq1.gif" width="86" height="27" border="0" id="img_faq" onclick="openBg(1);showdiv('1');" /></a></td>
            <td width="63" align="left">本页搜索： </td>
                  ...
                  <td width="184" height="19" align="left" valign="top" style="background-image: url(images/search.gif);">
                    <table width="183" border="0" align="right" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="24" align="left"><img alt="搜索" src="images/search1.gif" width="23" height="17" onclick="s();" style="cursor: pointer;" /></td>
                      </tr>
                    </table>
                  </td>
                </tr>
          ...
          <tr>
            ...
            <td width="851" align="left" valign="top">
              ...
              <%}
                ...
                { %>
              <asp:Label ID="lb_msg" runat="server" Text="没有找到相关内容!"></asp:Label>
              <%} %>
            </td>
            <td width="50">&nbsp; </td>
          </tr>
    ...
    <tr>
      <td align="center" valign="top">
        <table class="aspnetpager" cellspacing="3" cellpadding="0">
          <tr>
            <webdiyer:AspNetPager NumericButtonCount="5" ID="AspNetPager1" OnPageChanged="AspNetPager1_PageChanged" AlwaysShow="true" ShowPageIndex="true" runat="server" ShowFirstLast="true" FirstPageText="首页" LastPageText="末页" PrevPageText="上一页" NextPageText="下一页" ShowInputBox="Never" PageSize="6" SubmitButtonText="GO" TextAfterInputBox="页" CustomInfoHTML="共 %PageCount% 页 " CustomInfoTextAlign="Right" ShowCustomInfoSection="Right" SubmitButtonClass="button" ShowDisabledButtons="true">
