        ...
        try
        {
            if (Request.QueryString["pId"] != null)
            {
                ...
                if (model != null)
                {
                    ...
                    Ltl_PatentType.Text = model.nvc_koreanName;
                    Ltl_PatentHolder.Text = model.nvc_PatentHolder;
                    if (model.i_YaoQiuXiang <= 0)//청구항
                    {
                    ...
                    try
                    {
                        Ltl_PatentHolderNationalityId.Text = DALN.Nationality_Select_Id(model.i_PatentHolderNationalityId).nvc_HanName;
                    }
                    catch { }
                    ...
                    {
                        Ltl_PriorityNationalityId.Text = DALN.Nationality_Select_Id(model.i_PriorityNationalityId).nvc_HanName;
                    }
                    ...
                    Ltl_AuthorizeNationalityId.Text = DALN.Nationality_Select_Id(model.i_AuthorizeNationalityId).nvc_HanName;
                    ...
                    Ltl_AnnualFeeStatus.Text = DALP.GetStatus(Convert.ToInt32(model.i_AnnualFeeStatus),"kr");
