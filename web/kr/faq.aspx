...
<body id="faq">
  ...
  <uc3:zscqadv ID="zscqadv1" TypeId="91" runat="server" />
    ...
    <tr>
      <td height="78" align="left" valign="top">
        <table width="1001" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="564" align="left" valign="top"><img src="images/faq.gif" width="212" height="78" /> </td>
            ...
            <td width="118" align="left">본페지에서 수색： </td>
          ...
          <tr>
            ...
            <td width="851" align="left" valign="top">
              ...
              <%}
                ...
                { %>
              <asp:Label ID="lb_msg" runat="server" Text="관련 내용 찾을 수 없습니다!"></asp:Label>
              <%} %>
            </td>
            <td width="50">&nbsp; </td>
          </tr>
