...
public partial class user_sbdz : System.Web.UI.Page
{
    ...
    public void Bind_Page_Title()
    {
        ...
        TitleOrKeyword = "<title>우편주소_계정센터_상표시시템_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
    }
    ...
    public void Update_TopAddress()//기본값으로 설정
    {
        if (Request.QueryString["PageType"].ToString() == "mr")
        {
            ...
            UserLog.AddUserLog(Hi_MemberId.Value.GetInt(), "收货地址", "修改默认地址");
        }
    }
