          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">홈</a>&nbsp;&gt;&gt;&nbsp;회원센터&nbsp;&gt;&gt;&nbsp;계정센터&nbsp;&gt;&gt;&nbsp;자료 수정 </td>
                </tr>
              </table>
            </td>
          </tr>
                              ...
                              <td width="687" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                                <table width="132" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="115" align="center" class="font12bt">자료 수정 </td>
                                    <td width="7"></td>
                                  </tr>
                                </table>
                              </td>
                        ...
                        <td height="115" align="left" valign="top">
                          ...
                          <table width="671" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <%if (usertype == 2)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>회사 명칭：</strong> </td>
                              <td align="left">
                                <input type="text" name="s8" id="c_company" class="font12000" maxlength="100" runat="server" /><%if (guoji == 0 && usertype == 2)
                                                                                                      { %><%} %><% else 
                                                                                                      {%><span style="color: Red;">*</span>
                                                                    <asp:CustomValidator ID="CustomValidator6" runat="server" ClientValidationFunction="validate11"
                                                                    ControlToValidate="c_company" ValidateEmptyText="true" Display="Dynamic" ValidationGroup="a" SetFocusOnError="true"></asp:CustomValidator><span id="s_c_company" style="display: none"><img src='images/tOk.gif' /></span><%} %></td>
                            </tr>
                            <%} %>
                            <%if (guoji == 0 && usertype == 2)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>회사영어 명칭：</strong> </td>
                              <td align="left">
                                <input type="text" name="s8" id="c_companyEn" onkeyup="value=value.replace(/[^a-zA-Z]/g,'')" class="font12000" maxlength="50" runat="server" /><span style="color: Red;">*</span>
                            ...
                            <%if (usertype == 3)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>대리사무소 이름：</strong> </td>
                              <td align="left">
                                ...
                                <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="validate1"
                                                                    ControlToValidate="c_dailiName" ValidateEmptyText="true" Display="Dynamic" ValidationGroup="a" SetFocusOnError="true"></asp:CustomValidator><span id="s_dailiName" style="display: none"><img src='images/tOk.gif' /></span></td>
                            </tr>
                            <%} %>
                            <tr>
                              <td height="32" align="right"><strong>국적：</strong> </td>
                              <td align="left">
                            ...
                            <tr>
                              <td width="238" height="32" align="right"><strong>담당자 이름：</strong> </td>
                              <td width="433" align="left">
                                <input type="text" name="s10" id="c_Name" class="font12000"
                                                                ...
                                                                <asp:CustomValidator ID="CustomValidator2" runat="server" ClientValidationFunction="validate2"
                                                                    ControlToValidate="c_Name" ValidateEmptyText="true" Display="Dynamic" ValidationGroup="a" SetFocusOnError="true"></asp:CustomValidator><span id="s_c_Name" style="display: none"><img src='images/tOk.gif' /></span><%} %></td>
                            </tr>
                            <%if (guoji == 0 && usertype != 3)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>담당자 영어이름：</strong> </td>
                              <td align="left">
                                <input type="text" name="s8" id="c_NameEn" class="font12000"
                                                                    onkeyup="value=value.replace(/[^a-zA-Z]/g,'')" maxlength="20" runat="server" /><span style="color: Red;">*</span>
                            ...
                            <%if (guoji == 1 && usertype == 1)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>준문등로번호：</strong> </td>
                              <td align="left">
                                <input type="text" name="s8" id="c_Idcard" class="font12000 tooltip"
                                                                    maxlength="18" runat="server" tips="아래 업로드한 중민등록증,여권 등 신분을 증명할수있는 증명서류의 번호와 일치해야합니다" /><span style="color: Red;">*</span>
                                                                <asp:CustomValidator ID="CustomValidator7" runat="server" ClientValidationFunction="validate111"
                                                                    ControlToValidate="c_Idcard" ValidateEmptyText="true" Display="Dynamic" ValidationGroup="a" SetFocusOnError="true"></asp:CustomValidator><span id="s_c_Idcard" style="display: none"><img src='images/tOk.gif' /></span></td>
                            </tr>
                            <%} %>
                            <%if (guoji == 0 && usertype == 1)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>증명서 번호：</strong> </td>
                              <td align="left">
                                <input type="text" name="s8" id="c_youxiao" class="font12000 tooltip"
                                                                    maxlength="50" runat="server" tips="아래 업로드한 중민등록증,여권 등 신분을 증명할수있는 증명서류의 번호와 일치해야합니다" /><span style="color: Red;">*</span>
                                                                    <asp:CustomValidator ID="CustomValidator10" runat="server" ClientValidationFunction="validate112"
                                                                    ControlToValidate="c_youxiao" ValidateEmptyText="true" Display="Dynamic" ValidationGroup="a" SetFocusOnError="true"></asp:CustomValidator><span id="s_c_youxiao" style="display: none"><img src='images/tOk.gif' /></span></td>
                            </tr>
                            <%} %>
                            <tr>
                              ...
                              <td align="left">
                                <input type="text" name="text_Call" id="text_Call"
                                                                ...
                                                                <asp:CustomValidator ID="CustomValidator3" runat="server" ClientValidationFunction="validate3"
                                                                    ControlToValidate="text_Call" ValidateEmptyText="true" Display="Dynamic" ValidationGroup="a" SetFocusOnError="true"></asp:CustomValidator><span id="s_text_Call" style="display: none"><img src='images/tOk.gif' /></span></td>
                            </tr>
                            <tr>
                              <td height="32" align="right"><strong>팩스：</strong> </td>
                              <td align="left">
                                <input type="text" id="text_chuanzhen" runat="server" maxlength="15" class="font12000" /></td>
                            </tr>
                            <tr>
                              <td height="32" align="right"><strong>연락처 주소：</strong> </td>
                              <td align="left">
                            ...
                            <%if (guoji == 0 && usertype != 3)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>영어 연락처 주소：</strong> </td>
                              <td align="left">
                                <textarea rows="2" name="s6" id="c_addressEn" onkeyup="value=value.replace(/[^a-zA-Z0-9]/g,'')" style="width: 300px; height: 40px;" class="font12000" onblur="checkOk('c_addressEn');" maxlength="150" runat="server"> </textarea>
                                </td>
                            </tr>
                            <%} %>
                            <tr>
                              <td height="32" align="right"><strong>연락처 우편 번호：</strong> </td>
                              <td align="left">
                                <input type="text" name="s8" id="c_youbian" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" class="font12000" maxlength="6" runat="server" /></td>
                            </tr>
                            <%if (guoji == 1)
                              { %>
                            <tr>
                              ...
                              <td align="left">
                                <input type="text" name="text_QQ" id="text_QQ" onkeyup="value=value.replace(/\D/g,'')" runat="server" class="font12000" maxlength="15" /></td>
                            </tr>
                            <%}
                              else
                              {%>
                            <tr>
                              ...
                              <td align="left">
                                <input type="text" id="text_msn" name="text_msn" runat="server" class="font12000" maxlength="30" /> </td>
                            </tr>
                            <%} %>
                            <tr>
                              <td height="32" align="right"><strong>휴대폰：</strong> </td>
                              <td align="left">
                                <input type="text" name="s8" id="c_phone" class="font12000" maxlength="50" runat="server" /></td>
                            </tr>
                            <tr style="display:none;">
                              <td height="32" align="right"><strong>SMS 알림이 만료 열기：</strong> </td>
                              <td align="left">
                                ...
                                <table width="282" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="201" align="left" class="style1">
                                      <input type="text" name="text_Email" id="text_Email" runat="server" maxlength="80" class="font12000" onblur="ClientValidateEmail();" /><span style="color: Red;" id="text_Email1">*</span></td>
                            ...
                            <tr>
                              <td style="height: 50px;" align="right" valign="top" style="line-height:20px;"><strong> <%if(usertype==1){ %>주민등록증, 여권등 신분을 증명할수있는 증명서류<%}
							    else if(usertype!=1){ %>신분을 증명할수있는 증명서류<%} %>：</strong> </td>
                              <td valign="top" style="line-height:20px;"> <%=zhutiwenjian %><br>
                                <asp:FileUpload ID="FileUpload3" runat="server"  Width="150px"/><br><span style="color: Red;">파일 격식은 jpg .gif .png .pdf. 파일크기는 500K 넘어서는 않됩니다</span> </td>
                            </tr>
                            <tr>
                                ...
                                <table width="415" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="95" align="left">
                                      <asp:ImageButton ID="Bt_Submit" ImageUrl="images/user_zl_b5.gif" runat="server" Text="확정" Width="85" Height="29" OnClick="Bt_Submit_Click"  ValidationGroup="a" />
...
<script type="text/javascript">
  $("#mail_add_show").click(function () {
    var html1 = '<div class="msg-div">' +
                ...
                '<input type="text" name="txt_addmail" id="txt_addmail" maxlength="60" class="font12000 tooltip" tips="입력 관련 메일 클릭 후 제출 증가" />' +
