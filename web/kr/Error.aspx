    ...
    <tr>
      <td align="center" valign="middle">
        <div style="font-size: 24px;">
          <strong style="font-size: 24px;">제시 :시스템 착오가 생겨 관리원 련락하세요！</strong><br />
          <br />
          <span id="time" style="font-size: 24px;">5</span>초후<a id="url" href="index.aspx" style="font-size: 24px;">홈으로</a>
        </div>
      </td>
    </tr>
  </table>
