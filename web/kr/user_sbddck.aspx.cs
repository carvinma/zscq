...
public partial class user_sbddck : System.Web.UI.Page
{
    ...
    public string fapiaotaitou = "없다", youjitype = "없다", youjidizhi = "없다", youjidizhia = "없다", youjidizhib = "없다", payway = "";
    public string youhuiquan = "없다", isuseyouhui = "없다";
    ...
    public void Bind_Order_Info()
    {
        if (Request.QueryString["order"] != null || Request.QueryString["order"].ToString() != "")
        {
            ...
            usertype = Convert.ToInt32(user.i_UserTypeId);
            if (order != null)
            {
                ...
                if (order.nvc_PayType == "线下汇款")
                {
                    ...
                    //        str += "<br/><br/>&nbsp;&nbsp;开户行:" + tb.nvc_BankDetails + "<br/>&nbsp;&nbsp;&nbsp;&nbsp;用户:" + tb.nvc_AccountName + "<br/>&nbsp;&nbsp;&nbsp;&nbsp;계좌 번호:" + tb.nvc_BankNumber;
                    //    }
                    //}
                ...
                OrderState = ConvertStatus(order.i_Status,"kr");
                if (order.i_Status == 4)
                {
                    ImageButton1.Enabled = false;
                    ImageButton1.ToolTip = "이미 지불";
                }
            }
            if (user != null)
            {
                ...
                if (mm.i_GuoJiId != null)
                {
                    ...
                    if (na != null)
                    {
                        ...
                        if (na.nvc_Name == "中国")
                        {
                            ...
                            Str_Money.Append(" <tr align=\"left\"><td width=\"200\" align=\"right\">상표갱신등록관납료：</td><td width=\"110\">" + order.dm_TrademarkMoney + "</td><td width=\"30\"></td><td width=\"100\"></td></tr>");
                            if (zhinajinnum != 0)
                            {
                                Str_Money.Append(" <tr align=\"left\"><td width=\"200\" align=\"right\">추가 지체료：</td><td width=\"110\">" + order.dm_TMZhiNaJin + "</td><td width=\"30\"></td><td width=\"100\"></td></tr>");
                            }
                            Str_Money.Append(" <tr align=\"left\"><td width=\"200\" align=\"right\">대리 비용：</td><td width=\"110\">" + order.dm_TMDaiLi + "</td><td width=\"30\"></td><td width=\"100\"></td></tr>");
                            ...
                            Str_AllMoney.Append("<tr align=\"left\"><td width=\"200\" align=\"right\"></td><td width=\"110\" align=\"right\">합계：</td><td width=\"color:red;\" width=\"30\">CNY</td><td style='color:red;' id='allmoney'  align=\"left\" width=\"100\" >" + order.dm_TotalMoney + "</td></tr>");
                        }
                        else
                        {
                            ...
                            Str_AllMoney.Append("<tr align=\"left\"><td width=\"200\" align=\"right\"></td><td width=\"110\" align=\"right\">합계：</td><td style='color:red;' width=\"30\"\">CNY</td><td style='color:red;' width=\"100\" id='allmoney'  align=\"left\">" + order.dm_TotalMoney + "</td></tr>");
