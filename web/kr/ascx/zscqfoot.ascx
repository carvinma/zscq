    ...
    function sendMsg() {
        ...
        $.ajax({
            ...
            success: function (msg) {
                if (msg == "ok") {
                    hidedivbox('divshow3');
                    alert("문제는 이미 고개센터로  발송하였습니다 24시간이내에 답변드리겠습니다  즉지검색하기를  바랍니다!");
...
<div id="divshow3" class="divshow">
    <table width="571" height="345" border="0" cellspacing="0" cellpadding="0" style="background-image: url(images/faq_bg.gif);">
        <tr>
                            ...
                            <table width="480" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td height="30" colspan="2" align="center">
                                        <strong style="color: #d34245;">전면적인 도움이 필료하면 력라해주세요</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="30" colspan="2" align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td width="626" align="left">
                                                <table style="line-height: 15px;" width="600" border="0" cellspacing="0" cellpadding="0">
                                                    <tr valign="middle">
                                                        <td width="79" style="width: 79px; text-align: center; background-color: #bf2831; vertical-align: middle; line-height: 15px; height: 15px;">
                                                            <a href="javascript:openboxBg(1);showdivbox('divshow1');" class="ac3">사용조항</a>
                                                        </td>
                                                        <td width="2">
                                                        </td>
                                                        <td width="99" style="text-align: center; background-color: #bf2831; vertical-align: middle; line-height: 15px; height: 15px;">
                                                            <a href="javascript:openboxBg(1);showdivbox('divshow2');" class="ac3">개인정보조항</a>
                                                        </td>
                                                        <td width="2">
                                                        </td>
                                                        <td width="99" style="text-align: center; background-color: #bf2831; vertical-align: middle; line-height: 15px; height: 15px;">
                                                            <a href="sitemap.aspx" class="ac3">사이트 지도</a>
                                                        </td>
                                                        <td width="339">&nbsp;
...
<div id="div_kefuleft" style="position: absolute; right: 0px; top: 130px; width: 80px; z-index: 10000;">
                ...
                <table id="kefu1" style="border-left: 1px solid #d4484b; border-top: 1px solid #d4484b; border-bottom: 1px solid #d4484b; border-right: 1px solid #d4484b; background-color: #fff;" width="126" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td height="42" align="center" style="line-height: 21px;">
                            <strong>근무일</strong>（북경시간 ）<br />
                            9:00-17:00
                        </td>
                    </tr>
                    <tr>
                        <td height="28" align="center">
                            <a href="javascript:openboxBg(1);showdivbox('divshow4');" class="ac10">금년도 휴가시간</a>
                        </td>
                    </tr>
                    <tr>
                  ...
                  <td height="33" align="center"><a href="msnim:chat?contact=hqht@live.com&Site=在线咨询" onclick="return checkInstalled('msn');" target="_blank"><img src="images/hqht_kf8.jpg" width="109" height="27" border="0" /></a></td>
                                ...
                                <tr>
                                    <td height="33" align="center">
                                        <a href="skype:hqht@live.com?call" target="_blank" onclick="return skypeCheck();">
