...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
  <ContentTemplate>
        ...
        <ItemTemplate>
          <tr>
            ...
            <td>
              ...
              <asp:LinkButton ID="lbtn_SetMr" runat="server" CommandName="SETMR" CommandArgument='<%# Eval("i_Id")%>'>[삭제]</asp:LinkButton>
              &nbsp;&nbsp;
              <asp:LinkButton ID="lbtn_Delete" runat="server" CommandName="DELETE" CommandArgument='<%# Eval("i_Id")%>' OnClientClick="javascript:if(!window.confirm('삭제 확인？')){return false;}">[삭제]</asp:LinkButton>
            </td>
          </tr>
        </ItemTemplate>
      </asp:Repeater>
    ...
    <table id="div_address0" width="100%" border="0" cellspacing="0" cellpadding="0" style="display: none;">
      ...
      <tr>
        <td height="40" align="right" width="100"><span style="color: Red;">*</span>상세한 주소
： </td>
      ...
      <tr>
        <td height="40" align="right" width="100"><span style="color: Red;">*</span>우편번호： </td>
        <td align="left">
          <input type="text" runat="server" name="s6" id="text_youzhengbianma" class="font12000" maxlength="6" />
        </td>
      </tr>
      <tr>
        <td height="40" align="right" width="100">무직적으로  설치： </td>
        <td align="left">
