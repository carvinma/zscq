          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">홈</a>&nbsp;&gt;&gt;&nbsp;회원센터&nbsp;&gt;&gt;&nbsp;계정센터&nbsp;&gt;&gt;&nbsp;우편주소 </td>
                </tr>
              </table>
            </td>
          </tr>
                      ...
                      <tr>
                        <td height="26" align="left" valign="top">
                          ...
                          <table width="689" border="0" cellspacing="1" cellpadding="1" bgcolor="#d0d0d0">
                            <tr>
                              <td width="86" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">받는 이 </td>
                              <td width="94" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">전화 </td>
                              <td width="140" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">국가 </td>
                            ...
                            <asp:Repeater ID="Repeater1" runat="server">
                              <ItemTemplate>
                                <tr>
                                  ...
                                  <td width="78" align="center" bgcolor="#FFFFFF"><a href="user_sbdzadd.aspx?PageType=update&uid=<%# Eval("i_Id")%>" class="ac5t">[수정]</a> <a href="?PageType=del&did=<%# Eval("i_Id")%>" onclick="javascript:if(!window.confirm('삭제 확인？')){return false;}" class="ac5t">[삭제]</a> </td>
                                </tr>
                              </ItemTemplate>
                            </asp:Repeater>
                          </table>
