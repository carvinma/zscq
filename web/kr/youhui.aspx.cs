...
public partial class youhui : System.Web.UI.Page
{
    ...
    void Bind_Page_Value()
    {
        ...
        TitleOrKeyword = "<title>" + _Name + "_최신할인 활동_" + _Title + "_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
    }
