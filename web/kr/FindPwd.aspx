          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">홈</a>&nbsp;&gt;&gt;&nbsp;비밀번호 찾기 </td>
                </tr>
              </table>
            </td>
          </tr>
                              ...
                              <td width="639" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                                <table width="114" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="98" align="center" class="font12bt">비밀번호 찾기 </td>
                                    <td width="6"></td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr>
                              <td height="115" align="center" valign="top">
                                <div id="setup1" style="display: ;">
                                  <table width="689" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td height="32" align="right"><strong>비밀번호 찾는 방식：</strong> </td>
                                      <td align="left">
                                        <input runat="server" id="ridE" type="radio" name="mode" value="2" checked="true" />
                                        이메일                                        </td>
                                    </tr>
                                    <tr>
                                      <td width="260" height="32" align="right"><strong>아이디： </strong></td>
                                ...
                                <div id="setup2" style="display: none;">
                                  <table width="689" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td width="260" height="32" align="right"><strong>인정번호：</strong> </td>
                                      <td width="429" height="32" align="left">
                                        ...
                                        <span id="msg_v" class="msgshow"></span><a id="resend" href="javascript:void(0);">다시 보내기</a> </td>
                                    </tr>
                                    <tr>
                                      <td height="32" align="right"><strong>새로운 비밀번호：</strong> </td>
                                      <td align="left">
                                        <input type="password" name="" id="TXT_NEWPWD" runat="server" tips="비밀번호 길이 여섯 ~ 21 분 사이에!" class="font12000 tooltip" value="" placeholder="" />
                                        <span id="msg_pwd" class="msgshow"></span></td>
                                    </tr>
                                    <tr>
                                      <td height="32" align="right"><strong>비밀번호 확인：</strong> </td>
                                      <td align="left">
...
<script type="text/javascript">
  ...
  function daojishi(con, miaoshu) {
    if (miaoshu > 0) {
      $('#divfasong').show();
      con = con.replace(miaoshu + "초", (miaoshu - 1) + "초")
      $('#divfasong').html(con);
  ...
  function checksubmit() {
    ...
    if (code == "") {
      $("#msg_v").text("인증 번호 입력해주세요！");
      return false;
    } else if (pwd == "") {
      $("#msg_pwd").text("비밀번호 입력해주세요！");
      return false;
    } else if (pwd.length < 6 || pwd.length > 21) {
      $("#msg_pwd").text("비밀번호 길이 여섯 ~ 21 분 사이에！");
      return false;
    } else if (pwd2 != pwd) {
      $("#msg_pwd2").text("암호가 일치하지 않는다！");
      return false;
    }
    return true;
  } 
