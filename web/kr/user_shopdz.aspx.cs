...
public partial class user_shopdz : System.Web.UI.Page
{
    ...
    public void Bind_Page_Title()
    {
        ...
        TitleOrKeyword = "<title>나의 주소록_계정센터_상가 시스템_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
    }
    ...
    public void Update_TopAddress()//기본값으로 설정
    {
        if (Request.QueryString["PageType"].ToString() == "mr")
        {
            ...
            UserLog.AddUserLog(Hi_MemberId.Value, "收货地址", "设置默认地址");
        }
    }
