          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">홈</a>&nbsp;&gt;&gt;&nbsp;회원센터&nbsp;&gt;&gt;&nbsp;계정센터&nbsp;&gt;&gt;&nbsp;我的地址薄 </td>
                </tr>
              </table>
            </td>
          </tr>
            ...
            <td height="639" valign="top">
              <table width="716" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="691" align="right"><a href="user_shopdzadd.aspx"><img src="images/dzadd.jpg" width="85" height="29" border="0" /></a> </td>
                </tr>
                <tr>
                  <td height="123">&nbsp; </td>
                  <td align="left" valign="top">
                      ...
                      <tr>
                        <td height="26" align="left" valign="top">
                              ...
                              <td width="687" height="28" align="left" valign="bottom" style="border-bottom: 1px solid #d34245;">
                                <table width="132" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="115" align="center" class="font12bt">주소 리스트
 </td>
                                    <td width="7"></td>
                                  </tr>
                                </table>
                          ...
                          <table width="689" border="0" cellspacing="1" cellpadding="1" bgcolor="#d0d0d0">
                            <tr>
                              <td width="86" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">收货人 </td>
                              <td width="94" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">전화 </td>
                              <td width="140" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">
                                  국가 </td>
                              <td width="210" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">상세한 주소
 </td>
                              <td width="62" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">무직적으로  설치 </td>
                              <td width="78" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">작업 </td>
                            </tr>
                              ...
                              <ItemTemplate>
                                <tr>
                                  ...
                                  <td width="62" align="center" bgcolor="#FFFFFF">
                                    <%# Hi_Mr.Value != Eval("i_Id").ToString() ? "<a href=\"?PageType=mr&mid=" + Eval("i_Id") + "\">[아니요]</a>" : "<span style=\"color:#e3441c;\">예</span>"%>&nbsp;&nbsp; </td>
                                  <td width="78" align="center" bgcolor="#FFFFFF"><a href="user_shopdzadd.aspx?PageType=update&uid=<%# Eval("i_Id")%>" class="ac5t">[수정]</a> <a href="?PageType=del&did=<%# Eval("i_Id")%>" onclick="javascript:if(!window.confirm('정말 삭제할')){return false;}" class="ac5t">[삭제]</a> </td>
                                </tr>
                              </ItemTemplate>
                            </asp:Repeater>
                          </table>
