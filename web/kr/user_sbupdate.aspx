...
<table width="1001" border="0" align="center" cellpadding="0" cellspacing="0" style="margin:0 auto;background-color: #fff;">
    ...
    <td align="left" valign="top"><table width="741" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);"><table width="739" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="19">&nbsp;</td>
            <td align="left"><a href="index.aspx">홈</a>&nbsp;&gt;&gt;&nbsp;회원센터&nbsp;&gt;&gt;&nbsp;서비스 센터&nbsp;&gt;&gt;&nbsp;나의 상표&nbsp;&gt;&gt;&nbsp;상표 정보 업데이트</td>
          </tr>
        </table></td>
      </tr>
      <tr>
                  ...
                  <tr>
                    <td height="115" align="left" valign="top"><table width="689" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="left">  <input type="text" name="s5" id="sb_num" class="font12000 tooltip" maxlength="20" tips="수자와 영어문자만 입력해주세요" onkeyup="value=value.replace(/[^\w]/ig,'')" runat="server" onblur="CheckUserSbregnum('1');"/><span id="sb_num1" style="color: Red;">*</span></td>
                        </tr>
                      <tr>
                        <td height="32" align="right"><strong>상표 류형：</strong></td>
                       <td align="left">
                                      <input type="text" name="s5" id="Sb_type" class="font12000 tooltip" maxlength="20" runat="server" tips="상표 등록 증명서의 내용과 일치주세요" onblur="checkOk('Sb_type');" /><span style="color: Red;" id="Sb_type1">*</span></td>
                        </tr>
                      <tr>
                        <td height="32" align="right"><strong>출원인<%if (usertype == 3)
                                                                      { %>(중국어)<%} %>：</strong></td>
                        <td align="left">
                                      <input type="text" name="s6" id="Sb_Regname" onblur="checkOk('Sb_Regname');Checksbzhenshu(1);" class="font12000 tooltip" tips="상표 등록 증명서의 내용과 일치주세요" maxlength="50" runat="server" /><span style="color: Red;" id="Sb_Regname1"></span></td>
                        </tr>
                       ...
                       <td align="left">
                        ...
                        <td height="32" align="right"><strong>등록자 코드：</strong></td>
                         <td align="left">
                                      <input type="text" name="s6" id="Sb_Reg_youbian" onblur="checkOk('Sb_Reg_youbian');"  class="font12000 tooltip" maxlength="10" tips="수자만 입력해주세요" runat="server" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/><span style="color: Red;" id="Sb_Reg_youbian1"></span><span ></span></td>
                                  </tr>
 ...
 <tr>
                ...
                <%} %>
                    ...
                    <td>   
                      <asp:RadioButton ID="RadioButton1" runat="server" onclick="miaoshutype();" GroupName="aa"/>문자 상표 &nbsp;<asp:RadioButton ID="RadioButton2"
                  ...
                  <%--    <input name="radio" type="radio" id="radio1" value="1" checked="true" onclick="miaoshutype();" runat="server" /> 文字商标
                     <input name="radio" type="radio" id="radio2" value="2"  onclick="miaoshutype();" runat="server" /> 도형상표
                      <input name="radio" type="radio" id="radio3" value="3"  onclick="miaoshutype();" runat="server" /> 문자와 도형상표    --%>                  
                    </td>
                </tr>
                    <tr id="sbmiaoshu">
                              ...
                              <td height="115" align="left" valign="top">
                                <table width="689" border="0" cellspacing="0" cellpadding="0">                            
                                  <% if (int.Parse(JiaoFeiType)== 2)
                                    ...
                                    <td width="429"> <span class="font12b4e user_zlbottomline">
                                  CNY&nbsp;<%=Str_Moneysb%>                                    
                                    </span></td>                                  
                                    </tr>
                                     <tr>
                                  ...
                                  CNY&nbsp;<%=sbdailiweituo%>                                    
                                    ...
                                    <%if (iszhinajin == 1)
                                      { %>
                                      <tr>
                                    <td width="260" height="32" align="right" >연체 요금을 상표：
                                    </td>  
                                    <td> <span class="font12b4e user_zlbottomline">
                                 CNY&nbsp;<%=Str_Zhinajin%>                                    
                                    </span></td>                                  
                                    ...
                                    <%} %> 
                                      ...
                                      <tr>
                                    <td width="260" align="right" height="32">합계：</td><td><span class="font12b4e user_zlbottomline" style="color:Red;">
                                   CNY&nbsp;<%=zongjiweituo%>                                    
                                    </span></td>                                    
                                    </tr>   
                                    <tr >
                            ...
                            <tr>
                              <td height="115" align="left" valign="top">
                                <table width="689" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    %>
                                    <tr>
                                    <td style="height:90px;width:290px;line-height:20px;" align="right" valign="top">
                               <strong> 사업자등록증 등 신분을 증명할수있는 증명서류：</strong>
                              </td>
                               <td style="line-height:20px;" valign="top"><%if (zhitiOk == 1)
                                    { %><span style="color:Red;"><%=zhutiwenjian%></span><br><%}%><asp:FileUpload ID="FileUpload3" runat="server"  Width="200px"/><br><span style="color:Red;">형식. Jpg.gif.png.PDF, 더 못하는 것보다 500K</span></td>  
                                  </tr>
                               ...
                               <td style="line-height:20px;" valign="top"><%if (sbfileok == 1)
                                    { %><span style="color:Red;"><%=Sbfile%></span><br><%}%><asp:FileUpload ID="FileUpload4" runat="server"  Width="200px"/><br><span style="color:Red;">형식. Jpg.gif.png.PDF, 더 못하는 것보다 500K</span></td>   
                                  </tr>
                                 ...
                                 <tr>
                                    ...
                                    { %><span style="color:Red;"><%=shenqingfile%></span><br><%}%><asp:FileUpload ID="FileUpload1" runat="server"  Width="200px"/><br><span style="color:Red;">형식. Jpg.gif.png.PDF, 더 못하는 것보다 500K</span>
                                                                                    </td>
                                                                                </tr>
                                    ...
                                    { %><span style="color:Red;"><%=weituofile%></span><br><%}%><asp:FileUpload ID="FileUpload2" runat="server" Width="200px" /><br><span style="color:Red;">형식. Jpg.gif.png.PDF, 더 못하는 것보다 500K</span>
                                                                                    </td>
                                                                                </tr>
                                                                                <%}%>
                                </table>
                                      ...
                                      <table width="389" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          ...
                                          <td width="116" align="left">
                                            ...
                                            <img src="images/user_js_b2.gif" width="86" height="27" />--%><asp:Button ID="Button1" runat="server" Text="" Style="border: 0; cursor: pointer; background: url(images/user_zl_b5.gif); width: 85px; height: 29px;" OnClick="Button1_Click" OnClientClick="return Checkadd();" /></td>
