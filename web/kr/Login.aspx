                ...
                <tr>
                  ...
                  <td width="396" align="left" valign="top">
                    <table width="372" height="121" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="72" height="32" class="font14">아이디：</td>
                      ...
                      <tr>
                        ...
                        <td align="left"><a href="FindPwd.aspx?flag=<%=Hf_PageFlag.Value%>" class="ac7">비밀번호 찾기</a></td>
                      </tr>
                      <tr>
                        <td height="32" class="font14">인정번호：</td>
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                          <table width="199" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="97" height="30" align="left">
                                <input type="checkbox" name="checkbox" id="cb_remember" tabindex="4" />아이디 저장 </td>
                              <td width="102" align="left">
                                <input type="checkbox" name="checkbox2" id="cb_auto" tabindex="5" />자동 로그 </td>
                            </tr>
                          </table>
                        </td>
                      </tr>
              ...
              <table width="449" height="109" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td align="left" valign="top" style="line-height: 21px;">
                    <p>
                      <strong style="color: #fff;">아직도HQHT의 회원이아닙니까？</strong></p>
                    <p style="font-size: 12px; color: #fff;">
                      바로회원가입하여 우리의 전문적인<br />
                      서비스를 채험하세요！</p>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="420" align="left"><a href="Register.aspx?flag=<%=Hf_PageFlag.Value%>" class="ac4">회원가입&gt;&gt;</a></td>
                </tr>
              </table>
            </td>
          </tr>
