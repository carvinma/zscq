...
<body id="services">
  ...
  <uc3:zscqadv ID="zscqadv1" TypeId="88" runat="server" />
          ...
          <tr>
            ...
            <td width="906" height="27" align="left" valign="top" style="background-color: #f4f4f4;">
              <table width="906" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="174" height="27" align="center" bgcolor="<%= TypeId== 1 ? "#bf2831" : "#404040"%>"><a href="down.aspx?sid=1" class="ac6">Global Patent 다운로드</a> </td>
                  <td width="2"></td>
                  <td width="174" height="27" align="center" bgcolor="<%= TypeId== 2 ? "#bf2831" : "#404040"%>"><a href="down.aspx?sid=2" class="ac6">특허파일 다운로드</a> </td>
                  <td width="2"></td>
                  <td width="174" height="27" align="center" bgcolor="<%= TypeId== 3 ? "#bf2831" : "#404040"%>"><a href="down.aspx?sid=3" class="ac6">상표파일 다운로드</a> </td>
                  <td width="2"></td>
                  <td width="174" height="27" align="center" bgcolor="<%= TypeId== 4 ? "#bf2831" : "#404040"%>"><a href="down.aspx?sid=4" class="ac6">기타</a> </td>
                  <td width="204">&nbsp; </td>
                </tr>
              </table>
            </td>
