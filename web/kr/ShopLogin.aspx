                ...
                <tr>
                  ...
                  <td width="450" align="left" valign="top">
                    <table width="450" height="121" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td width="93" height="32" class="font14" align="right">핸드폰：</td>
                        ...
                        <td width="140" align="left">
                          <asp:RequiredFieldValidator runat="server" ControlToValidate="txt_username" ErrorMessage="비워 둘 수 없습니다" Display="Dynamic"></asp:RequiredFieldValidator>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td align="left">
                          <asp:RequiredFieldValidator runat="server" ControlToValidate="txt_userpassword" ErrorMessage="비밀번호 입력해주세요" Display="Dynamic"></asp:RequiredFieldValidator>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td align="left">
                          <table width="189" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="92" align="left"><img src="v.aspx" id="img_regcheckcode" onclick="reloadcode('img_regcheckcode')" style="cursor: pointer; vertical-align: middle;" alt="클릭하여" title="클릭하여" /> </td>
                            </tr>
                          </table>
                        </td>
                        <td align="left">
                          <asp:RequiredFieldValidator runat="server" ControlToValidate="txt_code" ErrorMessage="인증 번호 입력해주세요"></asp:RequiredFieldValidator></td>
                      </tr>
                      <tr>
                        <td height="32">&nbsp;</td>
                        <td align="left">
