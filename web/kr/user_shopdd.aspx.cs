...
public partial class user_shopdd : System.Web.UI.Page
{
    ...
    public string PageType = "바꿈주무 리스트";
    ...
    public void Bind_Page_Title()
    {
        ...
        TitleOrKeyword = "<title>나의 바꿈 주문_상가 시스템_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
    }
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        if (LinkButton1.Text == "주문 번호↓")
        {
            LinkButton1.Text = "주문 번호↑";
            desc = false;
        }
        else
        {
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ordertype = "2";
        AspNetPager1.CurrentPageIndex = 1;
        if (LinkButton2.Text == "접분총계↓")
        {
            LinkButton2.Text = "접분총계↑";
            desc = false;
        }
        else
        {
    ...
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        ordertype = "3";
        AspNetPager1.CurrentPageIndex = 1;
        if (LinkButton3.Text == "주문 상태↓")
        {
            LinkButton3.Text = "주문 상태↑";
            desc = false;
        }
        else
        {
