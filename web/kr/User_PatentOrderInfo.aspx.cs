        ...
        try
        {
            if (Request["oId"] != null && Request["oId"].ToString() != "")
            {
                ...
                if (model != null)
                {
                    ...
                    Ltl_OrderStatus.Text = DALPO.GetStatus(model.i_Status,"kr");
                    #region 绑定专利列表
                    ...
                    Lal_TotalMoney.Text = model.dm_TotalMoney.ToString();//특허등록한 국가외화종류합계
                    ...
                    Ltl_PayType.Text = "송금";//model.nvc_PayType;
                ...
                yinhang.Append("</tr>");
                        ...
                        #endregion
                            Ltl_PayType.Text = "송금" + "<br/><br/>" + yinhang.ToString();
                        ImgBtn_Pay.Visible=false;
                    }
