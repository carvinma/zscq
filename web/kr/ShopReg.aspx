                ...
                <tr>
                  <td width="667" height="52" align="left" valign="top">
                    <table width="200" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="left">&nbsp;<a href="index.aspx">홈으로&gt;&gt;</a></td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  ...
                  <td width="396" align="left" valign="top">
                    <table width="372" height="121" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td width="72" height="32" class="font14" align="right">핸드폰：</td>
                        ...
                        <td width="100" align="left">
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_username" ErrorMessage="비워 둘 수 없습니다" Display="Dynamic"></asp:RequiredFieldValidator>
                          <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationExpression="^1((3[0-9])|(4[5-7])|(5([0-3]|[5-9]))|(8(0|[2-3]|[5-9])))[0-9]{8}$" ControlToValidate="txt_username" ErrorMessage="비워 둘 수 없습니다格式不正确" Display="Dynamic"></asp:RegularExpressionValidator>
                        </td>
                      </tr>
                      <tr>
                        <td height="32" class="font14" align="right">비밀번호：</td>
                        <td align="left">
                        ...
                        <td align="left">
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_userpassword" ErrorMessage="비밀번호 입력해주세요" Display="Dynamic"></asp:RequiredFieldValidator>
                        </td>
                      </tr>
                         <tr>
                        <td height="32" class="font14" align="right">비밀번호 확인：</td>
                        <td align="left">
                        ...
                        <td align="left">
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_userpassword2" ErrorMessage="비밀번호가 일치하지 않습니다" Display="Dynamic"></asp:RequiredFieldValidator>
                        </td>
                      </tr>
                      <tr>
                        <td height="32" class="font14" align="right">인정번호：</td>
                        <td align="left">
                          <table width="199" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="102" align="left"><img src="v.aspx" id="img_regcheckcode" onclick="reloadcode('img_regcheckcode')" style="cursor: pointer; vertical-align: middle;" alt="클릭하여" title="클릭하여" /> </td>
                            </tr>
                          </table>
                        </td>
                        <td align="left">
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_code" ErrorMessage="인증 번호 입력해주세요"></asp:RequiredFieldValidator></td>
                      </tr>
                      <tr>
                        <td height="32">&nbsp;</td>
                        <td align="left">
                          <asp:Button ID="Ibtn_Reg" ForeColor="White" BackColor="#bf2831" runat="server" Text="회원가입" Width="147"   Height="22" BorderWidth="0" OnClick="Ibtn_Reg_Click" />
                        </td>
                        <td align="left"></td>
                      </tr>
                    </table>
