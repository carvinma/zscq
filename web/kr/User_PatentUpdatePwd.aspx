...
<head runat="server">
<title>비밀번호 수정_계정센터_회원센터_특허시스템_Global Patent</title>
            ...
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td align="left">홈 >> 특허시스템 >> 회원센터 >> 계정센터 >> 비밀번호 수정</td>
                </tr>
              </table>
            </td>
          </tr>
                            ...
                            <tr>
                              ...
                              <td width="433" align="left">
                                <input runat="server" type="password" name="iptOldpwd" id="iptOldpwd" class="font12000"
                                  ...
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ValidationGroup="a" ControlToValidate="iptOldpwd" Display="Dynamic" SetFocusOnError="true" Text="비워 둘 수 없습니다！"></asp:RequiredFieldValidator>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td align="left">
                                <input runat="server" type="password" name="iptNewpwd1" id="iptNewpwd1" class="font12000"
                                  maxlength="50" />&nbsp;<span class="error">*</span>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ValidationGroup="a" ControlToValidate="iptNewpwd1" Display="Dynamic" SetFocusOnError="true" Text="비워 둘 수 없습니다！"></asp:RequiredFieldValidator>
                              </td>
                            </tr>
                            <tr>
                              <td height="32" align="right">
                                <strong>비일 번호 확인：</strong>
                              </td>
                              <td align="left">
