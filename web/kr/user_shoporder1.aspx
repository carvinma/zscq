                        ...
                        <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
                            <table width="739" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <a href="index.aspx">홈</a>&nbsp;&gt;&gt;&nbsp;회원센터&nbsp;&gt;&gt;&nbsp;서비스 센터&nbsp;&gt;&gt;&nbsp;나의 바꿈 주문&nbsp;&gt;&gt;&nbsp;주문 확인
                                    </td>
                                </tr>
                            </table>
                        </td>
                                                ...
                                                <td height="115" align="left" valign="top">
                                                    <table width="689" border="0" cellspacing="1" cellpadding="1" bgcolor="#d0d0d0">
                                                        <tr>
                                                            ...
                                                            <%--<td width="137" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">상품번호</td>--%>
                                                        ...
                                                        <table width="687" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td width="600" align="right">
                                                                    <span id="title" style="cursor: pointer;" onclick="showaddr();">추가 주소</span>
                                                                </td>
                                                                <td height="10">&nbsp;
                                                ...
                                                <asp:Repeater ID="Rpt_Address" runat="server">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <%#Eval("nvc_EnName")%>&nbsp;<%# Eval("nvc_StreetAddress")%>&nbsp;&nbsp;（<%# Eval("nvc_Consignee")%>&nbsp;&nbsp;받다）&nbsp;&nbsp;<%# Eval("nvc_TelPhone")%>&nbsp;&nbsp;<%# Hi_Mr.Value != Eval("i_Id").ToString() ? "<a href=\"?aid=" + Hi_AddressId.Value + "&PageType=mr&mid=" + Eval("i_Id") + "\">[기본값으로 설정]</a>" : "<span style=\"color:#e3441c;\">기본 위치</span>"%>&nbsp;&nbsp;<a href="?aid=<%= Hi_AddressId.Value %>&PageType=del&did=<%# Eval("i_Id")%>" onclick="javascript:if(!window.confirm('삭제 확인？')){return false;}">[삭제]</a>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            ...
                                            <table id="div_address0" width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none ;">
                                                <tr>
                                                    <td width="18%" height="40" align="right">
                                                        <span style="color: #f00;">*</span>받은 사람：
                                                    </td>
                                                ...
                                                <tr>
                                                    <td width="18%" height="40" align="right">
                                                        <span style="color: #f00;">*</span>주소 전화：
                                                    </td>
                                                    <td width="53%" align="left">
                                                ...
                                                <tr>
                                                    <td width="18%" height="40" align="right">
                                                        <span style="color: #f00;">*</span>상세한 주소
：
                                                    </td>
                                        ...
                                        <table width="689" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td height="59" align="right" valign="top" style="line-height: 22px;">
                                                    ...
                                                    접분총계：<span id="span_allintegral" class="font14ac5"><%= Hi_allintegral.Value %></span>
                                                </td>
                                            </tr>
                                        </table>
                                        <table width="687" border="0" cellspacing="0" cellpadding="0">
