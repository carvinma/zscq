                  ...
                  <td width="221" height="22" bgcolor="#d34245">
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="25" height="22">&nbsp; </td>
                        <td width="13">&nbsp; </td>
                        <td width="183" align="left"><a href="jifen.aspx" class="ac2">적분상점</a> </td>
                      </tr>
                    </table>
                  </td>
                  <td width="29">&nbsp; </td>
          ...
          <tr>
            <td height="60" align="left" valign="top" style="background-image: url(images/aboutus_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">홈</a>&nbsp;>>&nbsp;<a href="youhui.aspx">할인 활동</a>&nbsp;>>&nbsp;<a href="jifen.aspx">적분상점</a>&nbsp;>>&nbsp;<%=cname %>
                  </td>
                </tr>
              </table>
            </td>
