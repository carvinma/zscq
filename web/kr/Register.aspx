      ...
      <tr>
        <td height="150" align="left" valign="top" style="background-image: url(images/faq_bg2.gif);">
          <table width="700" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="36">&nbsp;</td>
              <td align="center" style="line-height: 21px; font-size: 14px; font-weight: bold;">Global Patent 사용자 등록 계약</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
  ...
  <table width="915" border="0" align="center" cellpadding="0" cellspacing="0" style="margin: 0 auto; background-color: #fff;">
    <tr>
      <td width="466" height="308" align="left" valign="top">
        <table width="463" height="252" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="463" height="308" align="left" valign="top" style="background-image: url(<%=pageflag%>);">
              <table width="464" height="285" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="412" align="left" valign="top">
                    <table width="410" height="207" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="112" height="32" class="font14">아이디： </td>
                        ...
                        <td width="109" align="left" class="font12ac5" id="td_username"></td>
                      </tr>
                      <tr>
                        <td height="32" class="font14">회원류형： </td>
                      ...
                      <tr>
                        <td height="32" class="font14">국적： </td>
                        <td colspan="2" align="left">
                          <asp:DropDownList ID="Drp_GuoJi" runat="server" Style="border: 1px solid #ebebeb; font-size: 12px; font-weight: bold; width: 189px; height: 24px; background-color: #dedede;">
                            <asp:ListItem Value="0">국적</asp:ListItem>
                          </asp:DropDownList>
                        </td>
                      </tr>
                      <tr>
                        <td height="32" class="font14">이메일： </td>
                        <td colspan="2" align="left">
                      ...
                      <tr>
                        <td height="32" class="font14">비밀번호： </td>
                        <td align="left">
                      ...
                      <tr>
                        <td height="32" class="font14">비밀번호 확인： </td>
                        <td align="left">
                      ...
                      <tr>
                        ...
                        <td colspan="2" align="left">
                          <table width="298" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="100" height="30" align="left"><img src="images/reg.gif" width="100" height="24" border="0" onclick="user_register()" style="cursor: pointer" /> </td>
                              <td width="198" align="left"><a href="javascript:openBg(1);showdiv('1');" class="ac5">《Global Patent사용자 등록 계약》</a> </td>
                            </tr>
                          </table>
                        </td>
                      </tr>
              ...
              <table width="449" height="66" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td align="left" valign="top" style="line-height: 21px;">
                    <p>
                      <strong style="color: #fff;">이미 사용자 Global Patent？</strong>
                    </p>
                  </td>
                </tr>
                <tr>
                  <td width="29" height="26">&nbsp; </td>
                  <td width="420" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Login.aspx?flag=<%=Hf_PageFlag.Value %>" class="ac4">로그인&gt;&gt;</a> </td>
                </tr>
              </table>
            </td>
          </tr>
