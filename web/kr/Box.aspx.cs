...
public partial class Box : System.Web.UI.Page
{
    ...
    protected string Bind_FeeInfo()
    {
        ...
        if (Request["pId"] != null && Request["pId"].ToString() != "")
        {
            ...
            sb.Append("<tr>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>관비</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>추가 지체료</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>가산료</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>송금수수료</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>대리비</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>합계</strong></td>");
            sb.Append("<td width='10%' height='28' align='center' bgcolor='#FFFFFF'><strong>외화종류</strong></td>");
            sb.Append("</tr>");
