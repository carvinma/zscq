...
<head runat="server">
  <title>상표 정보 입력_나의 상표_서비스 센터_상표시시템_Global Patent</title>
                              ...
                              <td width="687" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                                <table width="132" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="115" align="center" class="font12bt">대량 업로드</td>
                                    <td width="7"></td>
                                  </tr>
                                </table>
                              </td>
                      ...
                      <tr>
                        <td height="115" align="left" valign="top">
                          <table width="671" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="238" height="32" align="right"><strong>다운로드：</strong></td>
                              <td width="433" align="left">
                                <asp:FileUpload ID="ful_price" runat="server" />&nbsp;</td>
                            </tr>
                            <tr>
                              <td height="32" align="right"><strong>비고：</strong></td>
                              <td align="left">스프레드시트：
                              <%if (usertype == 3)
                                { %>
                              <a href="FileLoad/Trademark Informaiton(2).xls" class="ac9">다운로드</a><%}
                                else { %>
                                 <a href="FileLoad/Trademark Informaiton(1).xls" class="ac9">다운로드</a>
                               <% } %></td>
                            </tr>
                            <tr>
