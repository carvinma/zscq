                        ...
                        <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
                            <table width="739" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <a href="index.aspx">홈</a>&nbsp;&gt;&gt;&nbsp;회원센터&nbsp;&gt;&gt;&nbsp;서비스 센터&nbsp;&gt;&gt;&nbsp;나의 바꿈 주문&nbsp;&gt;&gt;&nbsp;주문 정보
                                    </td>
                                </tr>
                            </table>
                        </td>
                                            ...
                                            <tr>
                                                <td height="115" align="left" valign="top">
                                                    ...
                                                    <table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto">
                                                        <tr class="orderxx">
                                                            <td height="30" width="80" align="right" valign="middle">
                                                                <span class="ordertext">발주서 번호：</span>
                                                            </td>
                                                            <td height="30" width="160" align="left" valign="middle">
                                                                <span class="ordertext">
                                                                    <%=  OrderNumber %></span>
                                                            </td>
                                                            <td height="30" width="80" align="right" valign="middle">
                                                                <span class="ordertext">아이디：</span>
                                                            </td>
                                                        ...
                                                        <tr class="orderxx">
                                                            <td height="30" width="80" align="right" valign="middle">
                                                                <span class="ordertext">제출시간：</span>
                                                            </td>
                                                            <td height="30" width="160" align="left" valign="middle">
                                                                <%= OrderDate %>
                                                            </td>
                                                                    ...
                                                                    <asp:Repeater runat="server" ID="repProduct">
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                ...
                                                                                <td width="69" align="center" bgcolor="#FFFFFF">
                                                                                    <a title="<%#Eval("nvc_ProductName")%>" href="jifen_show.aspx?cid=<%#Eval("i_IntegralProductId")%>" target="_blank" class="ac5t">보기</a>
                                                                                </td>
                                                                            </tr>
                                                                        </ItemTemplate>
                                                                    </asp:Repeater>
