...
<body id="youhui">
  ...
  <uc3:zscqadv ID="zscqadv1" TypeId="93" runat="server" />
                  ...
                  <td height="22" bgcolor="#949293">
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="13">&nbsp; </td>
                        <td width="183" align="left"><a href="youhui.aspx" class="ac2">최신할인 활동</a> </td>
                      </tr>
                    </table>
                  </td>
                  <td>&nbsp; </td>
                  ...
                  <td width="221" height="22" bgcolor="#d34245">
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="25" height="22">&nbsp; </td>
                        <td width="13">&nbsp; </td>
                        <td width="183" align="left"><a href="###" class="ac2">적분상점</a> </td>
                      </tr>
                    </table>
                  </td>
                  <td width="29">&nbsp; </td>
                    ...
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="183" align="left">
                          <%if (isLogin)
                            { %>
                          <a href="user_shopintegral.aspx" class="ac2">개인 선터</a>
                          <%} %>
                          <%else
                            { %>
                          <a href="ShopLogin.aspx" class="ac2">태환시스템</a>
                          <%} %>
                        </td>
                      </tr>
                    </table>
          ...
          <tr>
            <td height="60" align="left" valign="top" style="background-image: url(images/aboutus_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td width="143" align="left" valign="middle">
                          <select id="Jifen" name="Jifen" runat="server" onchange="s();" style="padding-top: 3px; padding-bottom: 2px; font-size: 12px; width: 129px; height: 24px; line-height: 24px; overflow: hidden; vertical-align: text-bottom; border: #d7d7d7 1px solid;">
                            ...
                            <option style="z-index: 10000000000; font-size: 100;" value="0,50">&nbsp;&nbsp;0-50태환</option>
                            <option value="51,100">&nbsp;&nbsp;51-100태환</option>
                            <option value="101,300">&nbsp;&nbsp;101-300태환</option>
                            <option value="301,500">&nbsp;&nbsp;301-500태환</option>
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">홈</a>&nbsp;>>&nbsp;<a href="youhui.aspx">할인 활동</a>&nbsp;>>&nbsp;<a href="jifen.aspx?ptype=<%= Hi_PType.Value%>&ye=<%=ye %>&sel=<%=sel %>&keyword=<%=key %>">적분상점</a>&nbsp;>>&nbsp;<%=cname %>
                  </td>
                </tr>
              </table>
            </td>
                ...
                <tr>
                  ...
                  <td align="left" valign="top">
                    <table width="622" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td width="352" align="left" valign="top">
                                <table width="351" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="351" height="30" align="left">상품명칭 ：<%= cname %>
                                    </td>
                                  </tr>
                                  <%--<tr>
                                    <td height="30" align="left">상품번호：<%= snnumber %></td>
                                  </tr>--%>
                                  <tr>
                                    <td height="30" align="left">적분 바꿈：<span class="font14ac5"><%= jifen%></span> </td>
                                  </tr>
                                  <tr>
                                      ...
                                      <table width="100%" height="75" border="0" cellpadding="0" cellspacing="0">
                                          ...
                                          <td width="94%" align="left">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                ...
                                                <%if (ptype == 3)
                                                  { %>
                                                <td width="12%" height="20" style="line-height: 21px; font-size: 12px; color: #656565;">등급상품은 하나밖에 태환하지 못함 </td>
                                                <%}
                                                  else
                                                  { %>
                                                <td width="12%" height="20" style="line-height: 21px; font-size: 12px; color: #656565;">바로바꿈  </td>
                                                <td width="4%" align="left"><img src="images/icon_jian.gif" style="cursor: pointer;" width="14" height="13" onclick="jfpnumber(2)" /> </td>
                                                ...
                                                <td width="4%" align="left"><img src="images/icon_jia.gif" style="cursor: pointer;" width="14" height="13" onclick="jfpnumber(1)" /> </td>
                                                <td width="19%" align="right" style="line-height: 21px; font-size: 12px; color: #656565;">적분총계： </td>
                                                <td width="22%" align="left" style="line-height: 21px; font-size: 12px; color: #656565;"><span id="jfzj" class="font14ac5">
                                                  <%=jifen%>
                                                </span></td>
                                                <%}
                                                  }
                                                  ...
                                                  {%>
                                                <td width="16%" height="20" style="line-height: 21px; font-size: 12px; color: #656565;">상품</td>
                                                <%} %>
                                              </tr>
                                            </table>
                                          </td>
                                        ...
                                        <tr>
                                          ...
                                          <td align="left">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td width="35%" align="left"><a href="javascript:void(0);" onclick="duihuan();"><img src="images/duihuan.jpg" width="70" height="22" border="0" /> </a></td>
                                                <td width="65%">&nbsp; </td>
                                              </tr>
                                            </table>
                                          </td>
                      ...
                      <tr>
                        <td height="25" align="left" style="border-bottom: 1px solid #d45156; font-size: 12px; font-weight: bold;">상세소개： </td>
                      </tr>
                      <tr>
