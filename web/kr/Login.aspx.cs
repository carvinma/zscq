...
public partial class Login : System.Web.UI.Page
{
    ...
    public string unvalue = "아이디/메일/핸드폰";
        ...
        if (Request["esc"] != null)
        {
            if (Request.Cookies["hqhtshop"] != null)
            {
                ...
                if (Request.Cookies["hqhtshop"]["hqht_shop_uid"] != null && Request.Cookies["hqhtshop"]["hqht_shop_uid"] != "" && Request.Cookies["hqhtshop"]["hqht_shop_uid"] != "0")
                {
                    ...
                    Response.Cookies.Set(cookie);
                    UserLog.AddUserLog(Request.Cookies["hqhtshop"]["hqht_shop_uid"].ToString(), "商城系统", "登出商城系统");
                }
    ...
    void SetPage()
    {
        ...
        if (flag == "sb")
        {
            ...
            TitleOrKeyword = "<title>" + "사용자 로그인_" + "상표시시템_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
        }
        else
        {
            _typeid = "112";
            ...
            TitleOrKeyword = "<title>" + "사용자 로그인_" + "특허시스템_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
        }
