...
public partial class user_sbupdate : System.Web.UI.Page
{
    ...
    public string JiaoFeiType = "0", Sb_num = "", shenhe = "未审核", jiaofei = "未缴费";
    ...
    public string Str_Moneysb = "0", Str_Monesbmei = "", Str_Zhinajin = "", bizhong = "", zongji = "", zongjimei = "";//自行缴费
    public string Str_Moneysbweituo = "", Str_Monesbmeiweituo = "", sbdailiweituo = "", sbmeidailiweituo = "", zongjiweituo = "", zongjimeiweituo = "";//委托缴费
        ...
        else
        {
            ...
            if (Request.QueryString["t_r_id"] != null && Request.QueryString["t_r_id"].ToString() != "")
            {
                ...
                if (model != null)
                {
                    ...
                    if (mm != null)
                    {
                        ...
                        if (mm.i_UserTypeId != null)
                        {
                            if (mm.i_UserTypeId == 1)
                            {
                                ...
                                {
                                    zhutiwenjian = "<a href='" + mm.nvc_ZhuTiFile + "' title='点击查看'  target='_blank'>主体资格证书已上传</a>&nbsp;&nbsp;<span  style=\"color:Red;\">如证明文件有变更，请重新上传</span>";
                                    zhitiOk = 1;
                                }
                                else
                                {
                            ...
                            if (mm.i_UserTypeId == 3)
                            {
                                ...
                                {
                                    zhutiwenjian = "<a href='" + model.nvc_ZhuTiFile + "' title='点击查看'  target='_blank'>主体资格证书已上传</a>&nbsp;&nbsp;<span  style=\"color:Red;\">如证明文件有变更，请重新上传</span>";
                                    zhitiOk = 1;
                                }
                                #region 第三方信息
                                t_anjuanhao.Value = model.nvc_CFaxnumber;//案卷号
                    ...
                    {
                        Sbfile = "<a href='" + model.nvc_SBFile + "' title='点击查看'  target='_blank'>商标注册证书复印件已上传</a>&nbsp;&nbsp;<span  style=\"color:Red;\">如证明文件有变更，请重新上传</span>";
                        sbfileok = 1;
                    }
                    else
                    {
                    ...
                    {
                        //shangchuan = 2;//是否上传
                        shenqingfile = "<a href='" + model.nvc_ShenQingShu + "' title='点击查看' target='_blank'>申请书已上传</a>&nbsp;&nbsp;<span  style=\"color:Red;\">如证明文件有变更，请重新上传</span>";
                    ...
                    if (model.i_JiaoFeiType == 2 || mm.i_UserTypeId == 3)
                    {
                        ...
                        {
                            weituofile = "<a href='" + model.nvc_WeituoFile + "' title='点击查看' target='_blank'>委托书已上传</a>&nbsp;&nbsp;<span  style=\"color:Red;\">如证明文件有变更，请重新上传</span>";
                            weituoshu = 1;
                            //Button1.Visible = false;
                        }
                        else
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (Request.Cookies["hqhtshop"] != null || Request.Cookies["hqhtshop"]["hqht_sb_uid"] != null || Request.Cookies["hqhtshop"]["hqht_sb_uid"].ToString() != "")
        {
            ...
            if (Request.QueryString["t_r_id"] != null && Request.QueryString["t_r_id"].ToString() != "")
            {
                ...
                //else
                //{
                //    div_a.InnerHtml = "<script>alert('请上传商标注册证书复印件');location.href='" + url + "';</script>";
                ...
                //    if (model.nvc_ShenQingShu == "" || model.nvc_ShenQingShu == null)
                //{
                //    if (FileUpload1.HasFile == false)
                //    {
                //        div_a.InnerHtml = "<script>alert('请上传申请书复印件');location.href='" + url + "';</script>";
                ...
                //    if (JiaoFeiType == "2" || hi_usertype.Value == "3")
                //    {
                //        if (model.nvc_WeituoFile == "" || model.nvc_WeituoFile == null)
                //        {
                //            if (FileUpload2.HasFile == false)
                //            {
                //                div_a.InnerHtml = "<script>alert('请上传委托书复印件');location.href='" + url + "';</script>";
                ...
                //    else
                //    {
                //        MessageBox.Show(this.Page, "请上传商标申请书!");
                //        // div_a.InnerHtml = "<script>alert('请选择你要上传的文件');</script>";
                //        return;
                //    }
                //}
                ...
                {
                    #region 第三方信息
                    model.nvc_CFaxnumber = t_anjuanhao.Value;//案卷号
