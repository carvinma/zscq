...
public partial class nianfei : System.Web.UI.Page
{
    ...
    void Bind_Page_Value()
    {
        ...
        t_PageInfo model = DALPI.PageInfo_Select_Id(9);
    ...
    void Bind_County()
    {
        ...
        {
            selContry.Items.Add(new ListItem(i.nvc_Name, i.i_Id.ToString()));
            if (countryId == i.i_Id.ToString())
            {
                currency = i.nvc_Currency;
                countryName = i.nvc_Name;
                countrydesc = i.nt_Description;
            }
    ...
    void Bind_Rpt_PatentTypeList()
    {
        ...
        if (count == 0)
        {
            div_title.InnerHtml = "</br>没有搜索到相关内容！";
        }
