                        ...
                        <table width="221" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    ...
                                    <table <% if (myurl == "trademarkorder_list" ||myurl == "trademarkrenewalorder_list" ) {  %>style="display:;" <%}else{%>style="display:none;" <%} %>>
                                    <tr><td width="10" height="22"></td><td> <a href="trademarkOrder_list.aspx"  <% if (myurl == "trademarkorder_list" ){ %>class="ac7" <%}else{%>class="" <%} %>>·商标申请案订单</a></td></tr>
