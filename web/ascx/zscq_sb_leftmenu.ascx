                        ...
                        <table width="221" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    ...
                                    <table <% if (myurl=="trademarkrenewalorder_info"||myurl == "trademarkorder_info" ||myurl == "trademarkorder_list" ||myurl == "trademarkrenewalorder_list" ) {  %>style="display:;" <%}else{%>style="display:none;" <%} %>>
