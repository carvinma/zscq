                                            ...
                                            <td width="127" height="22" align="left">
                                               <%-- <a href="user_sblb.aspx" <% if (myurl == "user_sblb" || myurl == "user_sbck"|| myurl == "user_sbupdate"|| myurl == "user_trademarkzixing" ){ %>class="ac7" <%}else{%>class="" <%} %>>·全部商标信息</a>--%>
                                                   <a href="javascript:void(0)" class="menuchild">·全部商标信息</a> 
                                                     <table  <% if (myurl=="add_trademarkrenewalorder" ||myurl=="add_trademarkorder"||myurl == "trademark_list" ||myurl == "trademarkrenewal_list" || myurl == "trademark_detail"|| myurl == "edit_trademark" || myurl == "trademarkrenewal_detail"|| myurl == "edit_trademark_renewal" ) {  %>style="display:;" <%}else{%>style="display:none;" <%} %>>
                                                      <tr><td width="10" height="22"></td>
                                                      <td> <a href="trademark_list.aspx" <% if (myurl=="add_trademarkorder"||myurl == "trademark_list" || myurl == "trademark_detail"|| myurl == "edit_trademark" ){ %>class="ac7" <%}else{%>class="" <%} %>>·商标申请案</a></td></tr>
                                                      <tr><td width="10" height="22"></td><td>
                                                       <a href="trademarkrenewal_list.aspx"  <% if (myurl=="add_trademarkrenewalorder" ||myurl == "trademarkrenewal_list" || myurl == "trademarkrenewal_detail"|| myurl == "edit_trademark_renewal" ){ %>class="ac7" <%}else{%>class="" <%} %>>·商标续展案</a></td></tr>
                                                     </table>
                                            </td>
                                        </tr>
                                        <tr>
