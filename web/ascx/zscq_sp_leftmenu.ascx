                        ...
                        <table width="221" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td width="171" height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    <a href="user_shoptj.aspx" <% if ( myurl == "user_shoptj"){ %>class="font12bd44147" <%}else{%>class="" <%} %>>·我的订单统计</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    <a href="user_shopdd.aspx" <% if ( myurl == "user_shopdd"||myurl == "user_shoporder1"||myurl == "user_shopddck"||  myurl == "user_shoporder2"){ %>class="font12bd44147" <%}else{%>class="" <%} %>>·我的兑换订单</a>
                                </td>
                                <td style="border-bottom: 1px solid #d3d3d3;">&nbsp;
                            ...
                            <tr>
                                ...
                                <td height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    <a href="user_shopcoupon.aspx" <% if ( myurl == "user_shopcoupon"){ %>class="font12bd44147" <%}else{%>class="" <%} %>>·我的优惠券</a>
                                </td>
                                <td style="border-bottom: 1px solid #d3d3d3;">&nbsp;
                            ...
                            <tr>
                                ...
                                <td height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    <a href="user_shopintegral.aspx" <% if ( myurl == "user_shopintegral" ){ %>class="font12bd44147" <%}else{%>class="" <%} %>>·我的积分</a>
                                </td>
                                <td style="border-bottom: 1px solid #d3d3d3;">&nbsp;
                        ...
                        <table width="221" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td width="157" height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    <a href="user_shopdz.aspx" <% if (myurl == "user_shopdzadd"||myurl == "user_shopdz"){ %>class="font12bd44147" <%}else{%>class="" <%} %>>·我的地址簿</a>
                                </td>
