...
<body id="index">
  ...
  <uc3:zscqadv ID="zscqadv1" TypeId="52" runat="server" />
                  ...
                  <td width="221" height="22" bgcolor="#d34245">
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="183" align="left" style="font-size: 12px; font-weight: bold; color: #fff;">站内搜索 </td>
                      </tr>
                    </table>
                  </td>
                  <td width="29">&nbsp; </td>
          ...
          <tr>
            <td height="60" align="left" valign="top" style="background-image: url(images/aboutus_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">首页</a>&nbsp;>>&nbsp;站内搜索 </td>
                </tr>
              </table>
            </td>
          </tr>
                ...
                <tr>
                  <td colspan="2" height="19" align="right" valign="top">
                    <table class="aspnetpager" cellspacing="3" cellpadding="0">
                      <tr>
                        <webdiyer:AspNetPager NumericButtonCount="5" ID="AspNetPager1" OnPageChanged="AspNetPager1_PageChanged" AlwaysShow="true" ShowPageIndex="true" runat="server" ShowFirstLast="true" FirstPageText="首页" LastPageText="末页" PrevPageText="上一页" NextPageText="下一页" ShowInputBox="Never" PageSize="10" SubmitButtonText="GO" TextAfterInputBox="页" CustomInfoHTML="共 %PageCount% 页 " CustomInfoTextAlign="Right" ShowCustomInfoSection="Right" SubmitButtonClass="button" ShowDisabledButtons="true">
