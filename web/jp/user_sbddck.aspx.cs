...
public partial class user_sbddck : System.Web.UI.Page
{
    ...
    public string fapiaotaitou = "無", youjitype = "無", youjidizhi = "無", youjidizhia = "無", youjidizhib = "無", payway = "";
    public string youhuiquan = "無", isuseyouhui = "無";
        ...
        if (Request.QueryString["order"] != null || Request.QueryString["order"].ToString() != "")
        {
            ...
            if (order != null)
            {
                ...
                if (order.nvc_PayType == "线下汇款")
                {
                    ...
                    //        str += "<br/><br/>&nbsp;&nbsp;开户行:" + tb.nvc_BankDetails + "<br/>&nbsp;&nbsp;&nbsp;&nbsp;用户:" + tb.nvc_AccountName + "<br/>&nbsp;&nbsp;&nbsp;&nbsp;口座コード:" + tb.nvc_BankNumber;
                    //    }
                    //}
                ...
                if (mm.i_GuoJiId != null)
                {
                    ...
                    if (na != null)
                    {
                        ...
                        if (na.nvc_Name == "中国")
                        {
                            ...
                            Str_Money.Append(" <tr align=\"left\"><td width=\"200\" align=\"right\">公式商標更新する費用：</td><td width=\"110\">" + order.dm_TrademarkMoney + "</td><td width=\"30\"></td><td width=\"100\"></td></tr>");
                            if (zhinajinnum != 0)
                            {
                                Str_Money.Append(" <tr align=\"left\"><td width=\"200\" align=\"right\">延長金：</td><td width=\"110\">" + order.dm_TMZhiNaJin + "</td><td width=\"30\"></td><td width=\"100\"></td></tr>");
                            }
                            Str_Money.Append(" <tr align=\"left\"><td width=\"200\" align=\"right\">代理費：</td><td width=\"110\">" + order.dm_TMDaiLi + "</td><td width=\"30\"></td><td width=\"100\"></td></tr>");
                            ...
                            Str_AllMoney.Append("<tr align=\"left\"><td width=\"200\" align=\"right\"></td><td width=\"110\" align=\"right\">総計：</td><td width=\"color:red;\" width=\"30\">CNY</td><td style='color:red;' id='allmoney'  align=\"left\" width=\"100\" >" + order.dm_TotalMoney + "</td></tr>");
                        }
                        else
                        {
                            ...
                            Str_AllMoney.Append("<tr align=\"left\"><td width=\"200\" align=\"right\"></td><td width=\"110\" align=\"right\">総計：</td><td style='color:red;' width=\"30\"\">CNY</td><td style='color:red;' width=\"100\" id='allmoney'  align=\"left\">" + order.dm_TotalMoney + "</td></tr>");
