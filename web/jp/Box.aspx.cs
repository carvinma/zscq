...
public partial class Box : System.Web.UI.Page
{
    ...
    protected string Bind_FeeInfo()
    {
        ...
        if (Request["pId"] != null && Request["pId"].ToString() != "")
        {
            ...
            sb.Append("<tr>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>政府規定費用</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>延長金</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>項目超過費用</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>振込手数料</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>サービス手数料</strong></td>");
            sb.Append("<td width='15%' height='28' align='center' bgcolor='#FFFFFF'><strong>総計</strong></td>");
            sb.Append("<td width='10%' height='28' align='center' bgcolor='#FFFFFF'><strong>貨幣</strong></td>");
            sb.Append("</tr>");
