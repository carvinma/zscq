...
public partial class nianfei : System.Web.UI.Page
{
    ...
    void Bind_Page_Value()
    {
        ...
        t_PageInfo model = DALPI.PageInfo_Select_Id(51);
    ...
    void Bind_County()
    {
        ...
        {
            selContry.Items.Add(new ListItem(i.nvc_JpanName, i.i_Id.ToString()));
            if (countryId == i.i_Id.ToString())
            {
                currency = i.nvc_Currency;
                countryName = i.nvc_JpanName;
                countrydesc = i.nt_jpDescription;
            }
            sb.Append(string.Format("[{0},'{1}','{2}'],", i.i_Id, i.nvc_JpanName, i.nvc_Currency));
        }
    ...
    void Bind_Rpt_PatentTypeList()
    {
        ...
        if (count == 0)
        {
            div_title.InnerHtml = "</br>関連内容ヲ見つかりませんでした！";
        }
