    ...
    <tr>
      <td align="center" valign="middle">
        <div style="font-size: 24px;">
          <strong style="font-size: 24px;">ご注意：システムが未知なエラーが発生し、管理アシスタントにご連絡をください！</strong><br />
          <br />
          <span id="time" style="font-size: 24px;">5</span>秒後<a id="url" href="index.aspx" style="font-size: 24px;">フロントページに戻り</a>
        </div>
      </td>
    </tr>
  </table>
