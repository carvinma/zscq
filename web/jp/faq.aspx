...
<body id="faq">
                ...
                <tr>
                  ...
                  <td align="left" valign="top">
                    <table width="480" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="41" height="32" align="left"><strong>タイトル：</strong> </td>
                      ...
                      <tr>
                        <td height="32" align="left"><strong>メールボックス：</strong> </td>
                        <td valign="middle">
                      ...
                      <tr>
                        <td height="88" align="left"><strong>コンテンツ：</strong> </td>
                        <td valign="middle">
                      ...
                      <tr>
                        <td height="30" colspan="2" align="center"><strong style="color: #d34245;">もっと全面的なヘルプが必要である場合、直接に我々とご連絡をください</strong> </td>
                      </tr>
                      <tr>
  ...
  <uc3:zscqadv ID="zscqadv1" TypeId="77" runat="server" />
    ...
    <tr>
      <td height="78" align="left" valign="top">
        <table width="1001" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="538" align="left" valign="top"><img src="images/faq.gif" width="212" height="78" /> </td>
            <td width="93" align="left"><a href="javascript:void(0)"><img src="images/faq1.gif" width="86" height="27" border="0" id="img_faq" onclick="openBg(1);showdiv('1');" /></a></td>
            <td width="144" align="left">このページで検索する： </td>
                  ...
                  <td width="184" height="19" align="left" valign="top" style="background-image: url(images/search.gif);">
                    <table width="183" border="0" align="right" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="24" align="left"><img alt="検索" src="images/search1.gif" width="23" height="17" onclick="s();" style="cursor: pointer;" /></td>
                      </tr>
                    </table>
                  </td>
                </tr>
          ...
          <tr>
            ...
            <td width="851" align="left" valign="top">
              ...
              <%}
                ...
                { %>
              <asp:Label ID="lb_msg" runat="server" Text="関連内容ヲ見つかりませんでした!"></asp:Label>
              <%} %>
            </td>
            <td width="50">&nbsp; </td>
          </tr>
