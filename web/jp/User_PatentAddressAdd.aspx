...
<head>
  <title><%=PageType%>_書類郵送住所_アカウントセンター_会員センター_特許システム_環球匯通</title>
          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">フロントページ</a> >> 特許システム >> 会員センター >> アカウントセンター >> 書類郵送住所 >> <%=PageType%>
                  </td>
                </tr>
              </table>
            </td>
                    ...
                    <table width="671" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="115" align="left" valign="top">
                          <table width="671" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td height="32" align="right" class="style1"><strong><span style="color: #f00;">*</span>受信者の名前：</strong> </td>
                              <td width="433" align="left">
                                <input runat="server" id="text_shouhuoren" type="text" class="font12000" maxlength="20">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ValidationGroup="a" ControlToValidate="text_shouhuoren" Display="Dynamic" Text="空になることはできない！"></asp:RequiredFieldValidator>
                              </td>
                            </tr>
                            <tr>
                              <td height="32" align="right" class="style1"><strong>よく使うメールボックス：</strong> </td>
                              <td align="left">
                                <input class="font12000" maxlength="50" runat="server" id="text_dianziyoujian" type="text" />
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="RegularExpressionValidator" ValidationGroup="a" ControlToValidate="text_dianziyoujian" Text="お客様の記入した情報の格式が正しくありません。ご確認をください！" Display="Dynamic" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">
                                </asp:RegularExpressionValidator>
                              </td>
                            </tr>
                            <tr>
                              <td height="32" align="right" class="style1"><strong>受信者の電話：</strong> </td>
                              <td align="left">
                                <input runat="server" id="text_shoujihaoma" maxlength="11" class="font12000" type="text" />
                                
                                <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ErrorMessage="RegularExpressionValidator" ValidationGroup="a" ControlToValidate="text_shoujihaoma" Text="お客様の記入した情報の格式が正しくありません。ご確認をください！" Display="Dynamic" ValidationExpression="^1(3|5|8)\d{9}$">
                                </asp:RegularExpressionValidator>--%>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td align="left">
                                ...
                                <span></span> <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="RequiredFieldValidator" ValidationGroup="a" ControlToValidate="text_gudingdianhua" Display="Dynamic" Text="空になることはできない！"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                              ...
                              <td align="left">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="RegularExpressionValidator" ValidationGroup="a" ControlToValidate="text_youzhengbianma" Text="お客様の記入した情報の格式が正しくありません。ご確認をください！" Display="Dynamic" ValidationExpression="^[1-9]\d*$">
                                </asp:RegularExpressionValidator>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td align="left">
                                <input runat="server" id="text_shouhuodizhi" class="font12000" type="text" maxlength="250" style="width:300px;" /><span>完全なアドレスを入力してください</span>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="text_shouhuodizhi" Display="Dynamic" Text="空になることはできない！">
