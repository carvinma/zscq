        ...
        try
        {
            if (Request["oId"] != null && Request["oId"].ToString() != "")
            {
                ...
                if (model != null)
                {
                    ...
                    Ltl_OrderStatus.Text = DALPO.GetStatus(model.i_Status,"jp");
                    #region 绑定专利列表
                    ...
                    Lal_TotalMoney.Text = model.dm_TotalMoney.ToString();//特許授権国貨幣総計
                ...
                yinhang.Append("</tr>");
                        ...
                        #endregion
                            Ltl_PayType.Text = "線の下で送金" + "<br/><br/>" + yinhang.ToString();
                        ImgBtn_Pay.Visible=false;
                    }
