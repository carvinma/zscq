                ...
                if (arr_pid[i] != "")
                {
                    ...
                    if (model != null)
                    {
                        ...
                        if (tm != null)
                        {
                            ...
                            {
                                sb_trademrk.Append(" <a href=\"user_World_sbweituo.aspx?id=" + tid + "&type=2&zixing=ok\" target=\"_blank\" class=\"ac5t\">依頼書のダウンロード</a><br>");

                            }
                        }
                        sb_trademrk.Append("<a href=' user_World_sb.aspx?id=" + tid + "&zixing=ok' class='ac5t'>申請書をダウンロード</a></td>");
