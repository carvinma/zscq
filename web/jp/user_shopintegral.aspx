          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">フロントページ</a>&nbsp;&gt;&gt;&nbsp;会員センター&nbsp;&gt;&gt;&nbsp;私のポイント </td>
                </tr>
              </table>
            </td>
          </tr>
                        ...
                        <td width="687" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                          <table width="132" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="116" align="center" class="font12bt">積分流水 </td>
                              <td width="8"></td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td height="115" align="left" valign="top">
                          <table width="687" border="0" cellspacing="1" cellpadding="1" bgcolor="#d0d0d0">
                            <tr>
                              <td width="23%" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">日次 </td>
                              <td width="26%" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline"> 要旨 </td>
                              <td width="26%" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">ポイント変化 </td>
                              <td width="13%" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">ポイント残高 </td>
                              <td width="12%" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">ポイント状態 </td>
                            </tr>
                              ...
                              <ItemTemplate>
                                <tr>
                                  ...
                                  <td align="center" bgcolor="#FFFFFF"><span style="color: Red;">
                                    <%# (Convert.ToInt32(Eval("i_status")) == 0 ? "未発効する" : "確定し") %></span> </td>
                                </tr>
                              </ItemTemplate>
                            </asp:Repeater>
                          </table>
                          <table width="687" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td width="687" height="26" align="right"><a href="jifen.aspx"><img src="images/shop_go_1.jpg" title="进入ポイントショッピングセンター" /> </a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
