...
<head runat="server">
  <title>メッセージフィードバック_サービスセンター_会員センター_特許システム_環球匯通</title>
          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">フロントページ</a>&nbsp;>>&nbsp;特許システム&nbsp;>>&nbsp;サービスセンター&nbsp;>>&nbsp;メッセージフィードバック </td>
                </tr>
              </table>
            </td>
          </tr>
                                    ...
                                    <td width="601" height="29" align="left" valign="bottom">
                                      <table width="238" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          ...
                                          <td width="222" align="center" class="font12bt">メーセッジフィードバックリスト </td>
                                          <td width="6"></td>
                                        </tr>
                                      </table>
                                    </td>
                      ...
                      <tr>
                        <td align="right">
                          <table class="aspnetpager" cellspacing="5">
                            <tr>
                              <webdiyer:AspNetPager ID="AspNetPager1" runat="server" FirstPageText="フロントページ" LastPageText="最後のページ" NextPageText="後のページ" PrevPageText="前のページ" PageIndexBoxType="DropDownList" PageSize="20" OnPageChanging="AspNetPager1_PageChanging" ShowPageIndexBox="Always" ShowPageIndex="False" TextAfterPageIndexBox=" ページ" TextBeforePageIndexBox="へスキップ ">
