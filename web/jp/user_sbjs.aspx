                    ...
                    <table width="671" border="0" cellspacing="0" cellpadding="0" id="table_search1">
                      ...
                      <tr>
                        <td height="115" align="left" valign="top">
                          <table width="671" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="238" height="32" align="right"><strong>商標登録コード：</strong></td>
                              <td width="433" align="left">
                                <input type="text" name="s1" id="sb_num" class="font12000 tooltip" maxlength="50" runat="server"  tips="あなたは文字と数字のみを入力することができます 例如：E35123535"/></td>
                            </tr>
                            <tr>
                              <td height="32" align="right"><strong>商標類別：</strong></td>
                              <td align="left">
                                <input type="text" name="s5" id="sb_type" class="font12000" maxlength="50" runat="server" /></td>
                            </tr>
                            <tr>
                              <td height="32" align="right"><strong>商標登録：</strong></td>
                              <td align="left">
                          ...
                          <table width="630" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td height="115" align="left" valign="top">
                                <table width="630" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="225" height="32" align="right"><strong>商標登録コード：<br />
                                    </strong></td>
                                  ...
                                  <%--<tr>
                                    <td height="32" align="right"><strong>商標登録者国籍：</strong></td>
                          ...
                          <table width="630" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td height="115" align="left" valign="top">
                                <table width="630" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td height="32" align="right"><strong>商標费缴纳状态：</strong></td>
                                    <td align="left">
                                      <asp:DropDownList ID="ddl_jiaofei" runat="server" style="width:185px;">
                                        <asp:ListItem Value="-1">選択して下さい</asp:ListItem>
                                         <asp:ListItem Value="1">オーダー提出済</asp:ListItem>
                                        <asp:ListItem Value="2">費用納付済</asp:ListItem>
                                        <asp:ListItem Value="0">まだ費用を納付してない</asp:ListItem>
                                      </asp:DropDownList>
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td width="409" align="left"><span class="font12b4e user_zlbottomline">
                                      <asp:DropDownList ID="ddl_day" runat="server" style="width:185px;">
                                        ...
                                        <asp:ListItem Value="chao">期限が切れる</asp:ListItem>
                                      </asp:DropDownList>
                                    </span></td>
                                  </tr>
                                  <%-- <tr>
                            ...
                            <tr>
                              <td width="639" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                                <table width="114" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="10" height="20">&nbsp;</td>
                                    <td width="98" align="center" class="font12bt">第三者情報</td>
                                    <td width="6"></td>
                                  </tr>
                                </table>
                              </td>
