...
<head runat="server">
  <title>登録商標情報_私の商標_サービスセンター_商標システム_環球匯通</title>
                        ...
                        <td height="115" align="left" valign="top">
                          <table width="671" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td align="left">リストフォマットをダウンロードする：
                              <%if (usertype == 3)
                                { %>
                              <a href="FileLoad/Trademark Informaiton(2).xls" class="ac9">ここをクッリク
</a><%}
                                else { %>
                                 <a href="FileLoad/Trademark Informaiton(1).xls" class="ac9">ここをクッリク
</a>
                               <% } %></td>
                            </tr>
                            <tr>
