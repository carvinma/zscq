          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">フロントページ</a>&nbsp;&gt;&gt;&nbsp;会員センター&nbsp;&gt;&gt;&nbsp;アカウントセンター&nbsp;&gt;&gt;&nbsp;資料を修正 </td>
                </tr>
              </table>
            </td>
          </tr>
                              ...
                              <td width="687" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                                <table width="132" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="115" align="center" class="font12bt">資料を修正 </td>
                                    <td width="7"></td>
                                  </tr>
                                </table>
                              </td>
                        ...
                        <td height="115" align="left" valign="top">
                          ...
                          <table width="671" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <%if (usertype == 2)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>会社名称：</strong> </td>
                              <td align="left">
                                <input type="text" name="s8" id="c_company" class="font12000" maxlength="30" runat="server" /><%if (guoji == 0 && usertype == 2)
                                                                                                      { %><%} %><% else 
                            ...
                            <%if (guoji == 0 && usertype == 2)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>会社英語名称：</strong> </td>
                              <td align="left">
                            ...
                            <%if (usertype == 3)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>代理機構名称：</strong> </td>
                              <td align="left">
                            ...
                            <%} %>
                            <tr>
                              <td height="32" align="right"><strong>国籍：</strong> </td>
                              <td align="left">
                            ...
                            <tr>
                              <td width="238" height="32" align="right"><strong>人の名前：</strong> </td>
                              <td width="433" align="left">
                            ...
                            <%if (guoji == 0 && usertype != 3)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>コンタクト英文名称：</strong> </td>
                              <td align="left">
                                <input type="text" name="s8" id="c_NameEn" class="font12000" maxlength="50" runat="server" /><span style="color: Red;">*</span>
                                                                <asp:CustomValidator ID="CustomValidator9" runat="server" ClientValidationFunction="validate222"
                                                                    ControlToValidate="c_NameEn" ValidateEmptyText="true" Display="Dynamic" ValidationGroup="a" SetFocusOnError="true"></asp:CustomValidator><span id="s_c_NameEn" style="display: none"><img src='images/tOk.gif' /></td>
                            </tr>
                            <%} %>
                            <%if (guoji == 1 && usertype == 1)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>身分証明書コード：</strong> </td>
                              <td align="left">
                            ...
                            <%if (guoji == 0 && usertype == 1)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>有効証明書類：</strong> </td>
                              <td align="left">
                            ...
                            <%} %>
                            <tr>
                              <td height="32" align="right"><strong>連絡先電話番号：</strong> </td>
                              <td align="left">
                            ...
                            <tr>
                              <td height="32" align="right"><strong>連絡先ファックス番号：</strong> </td>
                              <td align="left">
                                <input type="text" id="text_chuanzhen" runat="server" maxlength="15" class="font12000" /></td>
                            </tr>
                            <tr>
                              <td height="32" align="right"><strong>アドレス帳：</strong> </td>
                              <td align="left">
                                <textarea rows="2" name="s6" id="text_Address" style="width: 300px; height: 40px;" class="font12000" maxlength="250" runat="server"> </textarea></td>
                            </tr>
                            <%if (guoji == 0 && usertype != 3)
                              { %>
                            <tr>
                              <td height="32" align="right"><strong>英語のアドレス帳：</strong> </td>
                              <td align="left">
                                <textarea rows="2" name="s6" id="c_addressEn" onkeyup="value=value.replace(/[^a-zA-Z0-9]/g,'')" style="width: 300px; height: 40px;" class="font12000" maxlength="150" runat="server"> </textarea>
                                </td>
                            </tr>
                            <%} %>
                            <tr>
                              <td height="32" align="right"><strong>連絡先郵便番号：</strong> </td>
                              <td align="left">
                            ...
                            <tr>
                              ...
                              <td align="left">
                                <input type="text" id="text_msn" name="text_msn" runat="server" class="font12000" maxlength="30"  oncontextmenu="return false;" /></td>
                            </tr>
                            <%} %>
                            <tr>
                              <td height="32" align="right"><strong>携帯電話：</strong> </td>
                              <td align="left">
                                <input type="text" name="s8" id="c_phone"  class="font12000" maxlength="50" runat="server" /></td>
                            </tr>
                            <tr style="display:none;">
                              <td height="32" align="right"><strong>アラートの有効期限が切れたSMSを開く：</strong> </td>
                              <td align="left">
                            ...
                            <tr>
                              <td style="height: 50px;" align="right" valign="top" style="line-height:20px;"><strong>主体資格証明書類：</strong> </td>
                              <td valign="top" style="line-height:20px;"> <%=zhutiwenjian %><br>
                                <asp:FileUpload ID="FileUpload3" runat="server"  Width="150px"/><br><span style="color: Red;">ファイル格式は jpg .gif .png .pdfに限定され、500Kにより大きくてはいけない</span> </td>
                            </tr>
                            <tr>
                                ...
                                <table width="415" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="95" align="left">
                                      <asp:ImageButton ID="Bt_Submit" ImageUrl="images/user_zl_b5.gif" runat="server" ValidationGroup="a" Text="確定" Width="85" Height="29" OnClick="Bt_Submit_Click"  />
...
<script type="text/javascript">
  $("#mail_add_show").click(function () {
    var html1 = '<div class="msg-div">' +
                ...
                '<input type="text" name="txt_addmail" id="txt_addmail" maxlength="60" class="font12000 tooltip" tips="入力関連のメール、クリック提出後に増加" />' +
