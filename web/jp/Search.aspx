...
<body id="index">
  ...
  <uc3:zscqadv ID="zscqadv1" TypeId="80" runat="server" />
                  ...
                  <td width="221" height="22" bgcolor="#d34245">
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="183" align="left" style="font-size: 12px; font-weight: bold; color: #fff;">サイト内で検索 </td>
                      </tr>
                    </table>
                  </td>
                  <td width="29">&nbsp; </td>
          ...
          <tr>
            <td height="60" align="left" valign="top" style="background-image: url(images/aboutus_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">フロントページ</a>&nbsp;>>&nbsp;サイト内で検索 </td>
                </tr>
              </table>
            </td>
          </tr>
