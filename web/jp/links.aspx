...
<body id="links">
  ...
  <uc3:zscqadv ID="zscqadv1" TypeId="78" runat="server" />
          ...
          <tr>
            ...
            <td width="906" height="27" align="left" valign="top" style="background-color: #f4f4f4;">
              <table width="906" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="174" height="27" align="center" bgcolor="<%=  ftype == "1" ? "#bf2831" : "#404040"%>"><a href="links.aspx?ftype=1" class="ac6">各国特許国</a> </td>
                  <td width="2"></td>
                  <td width="174" height="27" align="center" bgcolor="<%=  ftype == "2" ? "#bf2831" : "#404040"%>"><a href="links.aspx?ftype=2" class="ac6">各国商標国</a> </td>
                  <td width="2"></td>
                  <td width="174" height="27" align="center" bgcolor="<%=  ftype == "3" ? "#bf2831" : "#404040"%>"><a href="links.aspx?ftype=3" class="ac6">その他</a> </td>
                  <td width="380">&nbsp; </td>
                </tr>
              </table>
            </td>
                      ...
                      <td width="90" height="18" align="left" valign="top" style="background-color: <%#Eval("i_Id").ToString()==qypid?"#d45156;":"#949293" %>">
                        <table width="90" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="79" align="left"><a href="links.aspx?qypid=<%#Eval("i_Id") %>&ftype=<%=ftype %>" class="ac2">
                              <%#Eval("nvc_jpValue")%>
                            </a></td>
                          </tr>
                        </table>
                            ...
                            <td width="90" height="18" align="left" valign="top">
                              <table width="90" border="0" cellspacing="0" cellpadding="0">
                                <asp:Repeater ID="Rpt_Country" runat="server">
                                  <ItemTemplate>
                                    <tr>
                                      <td width="6" height="18" class="line_link">&nbsp; </td>
                                      <td width="79" align="left" class="line_link"><a href="links.aspx?qypid=<%#Eval("i_Pid") %>&qyid=<%#Eval("i_Id") %>&ftype=<%=ftype %>" <%# Eval("i_Id").ToString()==qyid?"class='ac5'":"" %>>
                                        <%#Eval("nvc_jpValue")%></a> </td>
                                    </tr>
                                  </ItemTemplate>
                                </asp:Repeater>
                              </table>
