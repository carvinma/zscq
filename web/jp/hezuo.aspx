<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HeZuo.aspx.cs" Inherits="HeZuo" %>
...
<body id="about">
  ...
  <uc3:zscqadv ID="zscqadv1" TypeId="73" runat="server" />
    ...
    <tr>
      <td width="260" height="618" align="left" valign="top" style="background-color: #f5f5f5;">
        <table width="260" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="260" height="360" align="left" valign="top" style="background-image: url(images/aboutus_left2.gif);">
              <table width="260" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="10">&nbsp; </td>
                  <td width="221" height="22" bgcolor="#949293">
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="183" align="left"><a href="AboutUs.aspx" class="ac2">会社歴史</a> </td>
                      </tr>
                    </table>
                  </td>
                  <td width="29">&nbsp; </td>
                ...
                <tr>
                  ...
                  <td height="22" bgcolor="#949293">
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="38" height="22">&nbsp; </td>
                        <td width="183" align="left"><a href="Team.aspx" class="ac2">私達のチーム</a> </td>
                      </tr>
                    </table>
                  </td>
                  <td>&nbsp; </td>
                ...
                <tr>
                  ...
                  <td height="22" bgcolor="#d34245">
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="38" height="22">&nbsp; </td>
                        <td width="183" align="left"><a href="###" class="ac2">提携パートナー</a> </td>
                      </tr>
                    </table>
                  </td>
                  <td>&nbsp; </td>
                ...
                <tr>
                  ...
                  <td height="22" bgcolor="#949293">
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="38" height="22">&nbsp; </td>
                        <td width="183" align="left"><a href="ContactUs.aspx" class="ac2">私達に連絡</a> </td>
                      </tr>
                    </table>
                  </td>
                  <td>&nbsp; </td>
          ...
          <tr>
            <td height="60" align="left" valign="top" style="background-image: url(images/aboutus_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp; </td>
                  <td align="left"><a href="index.aspx">フロントページ</a>&nbsp;>>&nbsp;<a href="AboutUs.aspx">私達について</a>&nbsp;>>&nbsp;提携パートナー </td>
                </tr>
              </table>
            </td>
          </tr>
                ...
                <tr>
                  ...
                  <td align="left" valign="top">
                    ...
                    <%}
                      ...
                      {%>
                    <div class="index_main5concent auto">
                      <%=html.ToString()%>
                    </div>
                    <%} %>
                  </td>
