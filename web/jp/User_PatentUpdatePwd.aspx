...
<head runat="server">
<title>パスワードを修正_アカウントセンター_会員センター_特許システム_環球匯通</title>
            ...
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td align="left">フロントページ >> 特許システム >> 会員センター >> アカウントセンター >> パスワードを修正</td>
                </tr>
              </table>
            </td>
          </tr>
                            ...
                            <tr>
                              ...
                              <td width="433" align="left">
                                <input runat="server" type="password" name="iptOldpwd" id="iptOldpwd" class="font12000"
                                  ...
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ValidationGroup="a" ControlToValidate="iptOldpwd" Display="Dynamic" SetFocusOnError="true" Text="空になることはできない！"></asp:RequiredFieldValidator>
                              </td>
                            </tr>
                            <tr>
                              <td height="32" align="right">
                                <strong>新しいパスワードを記入する：</strong>
                              </td>
                              <td align="left">
                                <input runat="server" type="password" name="iptNewpwd1" id="iptNewpwd1" class="font12000"
                                  maxlength="50" />&nbsp;<span class="error">*</span>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ValidationGroup="a" ControlToValidate="iptNewpwd1" Display="Dynamic" SetFocusOnError="true" Text="空になることはできない！"></asp:RequiredFieldValidator>
                              </td>
                            </tr>
                            <tr>
                              <td height="32" align="right">
                                <strong>新しいパスワードを確認する：</strong>
                              </td>
                              <td align="left">
