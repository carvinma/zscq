    ...
    <script type="text/javascript">
        function showaddr() {
            if (document.getElementById("div_address0").style.display == "") {
                ...
                obj("title").innerHTML = "添加アドレス";
            } else {
                document.getElementById("div_address0").style.display = "";
                obj("title").innerHTML = "キャンセル";
            }
                        ...
                        <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
                            <table width="739" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <a href="index.aspx">フロントページ</a>&nbsp;&gt;&gt;&nbsp;会員センター&nbsp;&gt;&gt;&nbsp;サービスセンター&nbsp;&gt;&gt;&nbsp;私の両替オーダー&nbsp;&gt;&gt;&nbsp;オーダーを確認
                                    </td>
                                </tr>
                            </table>
                        </td>
                                            ...
                                            <tr>
                                                <td height="115" align="left" valign="top">
                                                    <table width="689" border="0" cellspacing="1" cellpadding="1" bgcolor="#d0d0d0">
                                                        <tr>
                                                          <td height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline"><span left-pos="0|6" right-pos="0|6" space="">商品</span><span left-pos="6|6" right-pos="6|6" space="">画像</span></td>
                                                          <td align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline"> 商品名称 </td>
                                                          <td align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline"><span left-pos="0|6" right-pos="0|6" space="">必要の</span><span left-pos="6|6" right-pos="6|6" space="">積分</span></td>
                                                          <td align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline"><span left-pos="0|6" right-pos="0|6" space="">両替</span><span left-pos="6|6" right-pos="6|6" space="">数</span></td>
                                                          <td align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline"><span left-pos="0|6" right-pos="0|6" space="">積分</span><span left-pos="6|6" right-pos="6|6" space="">小計</span></td>
                                                            <%--<td width="137" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">商品番号</td>--%>
                                        ...
                                        <div id="div_addr" runat="server">
                                                        ...
                                                        <table width="687" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td width="600" align="right">
                                                                    <span id="title" style="cursor: pointer;" onclick="showaddr();">添加アドレス</span>
                                                                </td>
                                                                <td height="10">&nbsp;
                                            ...
                                            <table id="div_address1" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <asp:Repeater ID="Rpt_Address" runat="server">
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td width="17%" height="45" align="right">
                                                                <input type="radio" name="address" onclick="changeaddress('<%# Eval("i_Id")%>')" <%# Hi_AddressId.Value != Eval("i_Id").ToString() ? "" : " checked=\"checked\""%> />
                                                            </td>
                                                            <td width="83%">
                                                                <%#Eval("nvc_EnName")%>&nbsp;<%# Eval("nvc_StreetAddress")%>&nbsp;&nbsp;（<%# Eval("nvc_Consignee")%>&nbsp;&nbsp;収）&nbsp;&nbsp;<%# Eval("nvc_TelPhone")%>&nbsp;&nbsp;<%# Hi_Mr.Value != Eval("i_Id").ToString() ? "<a href=\"?aid=" + Hi_AddressId.Value + "&PageType=mr&mid=" + Eval("i_Id") + "\">[デフォルト設定]</a>" : "<span style=\"color:#e3441c;\">デフォルトのアドレス</span>"%>&nbsp;&nbsp;<a href="?aid=<%= Hi_AddressId.Value %>&PageType=del&did=<%# Eval("i_Id")%>" onclick="javascript:if(!window.confirm('削除の確認？')){return false;}">[削除]</a>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            ...
                                            <table id="div_address0" width="100%" border="0" cellspacing="0" cellpadding="0" style="display: none;">
                                                <tr>
                                                    <td width="17%" height="40" align="right">
                                                        <span style="color: #f00;">*</span>受取人名前：
                                                    </td>
                                                ...
                                                <tr>
                                                    <td width="17%" height="40" align="right">
                                                        <span style="color: #f00;">*</span>固定電話：
                                                    </td>
                                                    <td width="83%" align="left">
                                                ...
                                                <tr>
                                                    <td width="17%" height="40" align="right">
                                                        <span style="color: #f00;">*</span>詳細アドレス：
                                                    </td>
                                        ...
                                        <table width="689" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td height="59" align="right" valign="top" style="line-height: 22px;">
                                                    ...
                                                    ポイント総計：<span id="span_allintegral" class="font14ac5"><%= Hi_allintegral.Value %></span>
                                                </td>
                                            </tr>
                                        </table>
                                        <table width="687" border="0" cellspacing="0" cellpadding="0">
