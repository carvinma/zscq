    ...
    <table width="741" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);"><table width="739" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="19">&nbsp;</td>
            <td align="left"><a href="index.aspx">フロントページ</a>&nbsp;&gt;&gt;&nbsp;会員センター&nbsp;&gt;&gt;&nbsp;サービスセンター&nbsp;&gt;&gt;&nbsp;私の商標&nbsp;&gt;&gt;&nbsp;<span class="ordertext">商標の導入に成功</span></td>
          </tr>
        </table></td>
      </tr>
      <tr>
            ...
            <td width="691" align="left" valign="top"><table width="689" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="top"><table width="687" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="687" height="20" align="left" valign="top" style="border-bottom:1px solid #d34245;"><table width="210" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="10" height="20">&nbsp;</td>
                        <td width="192" align="center" class="font12bt">商標を正しく導入しました</td>
                        <td width="8"></td>
                      </tr>
                    </table></td>
                  </tr>
                  ...
                  <tr>
                    <td height="29" align="left"><table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto">
                      <tr class="orderxx">
                        <td height="30" align="left" valign="middle"><span class="ordertext">正しく導入された商標数：<span class="font12ac5"><%=sbshu%></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
