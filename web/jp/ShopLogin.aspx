              ...
              <table width="464" height="119" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="418" align="left" valign="top">
                    <table width="418" height="121" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="113" height="32" class="font14" align="right">ユーザータイプ：</td>
                        <td colspan="2">
                          <table width="199" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="97" height="30" align="left">
                                <input type="radio" runat="server" name="type" id="rad_type_zl" checked="true" />特許ユーザー </td>
