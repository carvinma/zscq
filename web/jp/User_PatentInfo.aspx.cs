        ...
        try
        {
            if (Request.QueryString["pId"] != null)
            {
                ...
                if (model != null)
                {
                    ...
                    Ltl_PatentType.Text = model.nvc_JapaneseName;
                    Ltl_PatentHolder.Text = model.nvc_PatentHolder;
                    if (model.i_YaoQiuXiang <= 0)//権利要求項目
                    {
                    ...
                    try
                    {
                        Ltl_PatentHolderNationalityId.Text = DALN.Nationality_Select_Id(model.i_PatentHolderNationalityId).nvc_JpanName;
                    }
                    catch { }
                    ...
                    {
                        Ltl_PriorityNationalityId.Text = DALN.Nationality_Select_Id(model.i_PriorityNationalityId).nvc_JpanName;
                    }
                    ...
                    Ltl_AuthorizeNationalityId.Text = DALN.Nationality_Select_Id(model.i_AuthorizeNationalityId).nvc_JpanName;
                    ...
                    Ltl_AnnualFeeStatus.Text = DALP.GetStatus(Convert.ToInt32(model.i_AnnualFeeStatus),"jp");
