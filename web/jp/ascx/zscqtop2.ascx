                      ...
                      <td width="184" height="19" align="left" valign="top" style="background-image: url(images/search.gif);">
                        <table width="180" border="0" align="right" cellpadding="0" cellspacing="0" height="19">
                          <tr>
                            ...
                            <td width="24" align="left" height="19"><img src="images/search1.gif" width="23" height="17" style="cursor: pointer;" onclick="searchOk();" title="サイト内で検索" /></td>
                          </tr>
                        </table>
                      </td>
                      <td width="6"></td>
                      <td width="32" align="center"><a href="../"><img src="images/Chinese.gif" width="25" height="16" title="中国語" /></a></td>
                      <td width="32" align="center"><a href="../en/"><img src="images/French.gif" width="25" height="16" title="英語" /></a></td>
                      <td width="32" align="center"><a href="../kr/"><img src="images/Korean.gif" width="25" height="16" title="韓国語" /></a></td>
                      <td width="32" align="center"><a href="../jp/"><img src="images/Japanese.gif" width="25" height="16" title="日本語" /></a></td>
                      <td width="8">&nbsp; </td>
                    </tr>
                  </table>
              ...
              <tr>
                <td height="72" align="left" valign="top">
                  <table class="topbox" width="1001" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="321" height="72" align="left" valign="top" bgcolor="#d34245"><a href="http://www.hqht-online.com/"><img src="images/logo.gif" width="321" height="72" border="0" title="環球匯通特許年金代理株式会社が主に各国特許年金代理サービスを扱い、各国特許年金基準検索サービスを無料に提供し、特許年金の監視と代行サービスを提供しています" /></a> </td>
                      <td class="index" width="124" align="center"><a href="index.aspx" class="ac2">フロントページ</a> </td>
                      <td class="about" width="113" align="center"><a href="AboutUs.aspx" class="ac2">私達について</a> </td>
                      <td class="services" width="99" align="center"><a href="services.aspx" class="ac2">サービス内容</a> </td>
                      <td class="nianfei" width="103" align="center"><a href="nianfei.aspx" class="ac2">特許年金検索</a> </td>
                      <td class="youhui" width="98" align="center"><a href="youhui.aspx" class="ac2">キャンペン</a> </td>
                      <td class="faq" width="66" align="center"><a href="faq.aspx" class="ac2">FAQ</a> </td>
                      <td class="links" width="66" align="center"><a href="links.aspx" class="ac2">LINK</a> </td>
