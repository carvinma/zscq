          ...
          <td align="left" valign="top">&nbsp; </td>
                    <td align="left" valign="top" style="background-color: #f4f4f4;">
                        <table width="221" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td width="57" style="border-bottom: 1px solid #d3d3d3;">&nbsp;
                                    
                                </td>
                                <td width="171" height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    <a href="user_shoptj.aspx" <% if ( myurl == "user_shoptj"){ %>class="font12bd44147" <%}else{%>class="" <%} %>>·私のオーダーを統計</a>
                                </td>
                                <td width="32" style="border-bottom: 1px solid #d3d3d3;">&nbsp;
                            ...
                            <tr>
                                ...
                                <td height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    <a href="user_shopdd.aspx" <% if ( myurl == "user_shopdd"||myurl == "user_shoporder1"||myurl == "user_shopddck"||  myurl == "user_shoporder2"){ %>class="font12bd44147" <%}else{%>class="" <%} %>>·私の両替オーダー</a>
                                </td>
                                <td style="border-bottom: 1px solid #d3d3d3;">&nbsp;
                            ...
                            <tr>
                                ...
                                <td height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    <a href="user_shopcoupon.aspx" <% if ( myurl == "user_shopcoupon"){ %>class="font12bd44147" <%}else{%>class="" <%} %>>·私のクーポン</a>
                                </td>
                                <td style="border-bottom: 1px solid #d3d3d3;">&nbsp;
                            ...
                            <tr>
                                ...
                                <td height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    <a href="user_shopintegral.aspx" <% if ( myurl == "user_shopintegral" ){ %>class="font12bd44147" <%}else{%>class="" <%} %>>·私のポイント</a>
                                </td>
                                <td style="border-bottom: 1px solid #d3d3d3;">&nbsp;
                        ...
                        <table width="221" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td width="157" height="30" align="left" style="border-bottom: 1px solid #d3d3d3;">
                                    <a href="user_shopdz.aspx" <% if (myurl == "user_shopdzadd"||myurl == "user_shopdz"){ %>class="font12bd44147" <%}else{%>class="" <%} %>>·私の住所リスト</a>
                                </td>
                    ...
                    <td bgcolor="#d34245">
                        <table width="221" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="183" align="left" class="font12b"><a href="Login.aspx?flag=sb&esc=true" class="ac2">システムからログアウト</a></td>
                            </tr>
                        </table>
                    </td>
                    <td>&nbsp;
