    ...
    function sendMsg() {
        ...
        $.ajax({
            ...
            success: function (msg) {
                if (msg == "ok") {
                    hidedivbox('divshow3');
                    alert("ご質問が既にサービスセンターに発送しました。我々が24時間以内にご返答を致します。直ちに登録し、チェックしてください");
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <table width="480" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="81" height="32" align="left">
                                        <strong>タイトル：</strong>
                                    </td>
                                    <td width="432">
                                ...
                                <tr>
                                    <td height="30" colspan="2" align="center">
                                        <strong style="color: #d34245;">もっと全面的なヘルプが必要である場合、直接に我々とご連絡をください</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="30" colspan="2" align="center">
                                                ...
                                                <table style="line-height: 15px;" width="600" border="0" cellspacing="0" cellpadding="0">
                                                    <tr valign="middle">
                                                        <td width="99" style="text-align: center; background-color: #bf2831; vertical-align: middle; line-height: 15px; height: 15px;">
                                                            <a href="javascript:openboxBg(1);showdivbox('divshow1');" class="ac3">使用要項</a>
                                                        </td>
                                                        <td width="2">
                                                        </td>
                                                        <td width="139" style="text-align: center; background-color: #bf2831; vertical-align: middle; line-height: 15px; height: 15px;">
                                                            <a href="javascript:openboxBg(1);showdivbox('divshow2');" class="ac3">プライバシー要項</a>
                                                        </td>
                                                        <td width="2">
                                                        </td>
                                                        <td width="139" style="text-align: center; background-color: #bf2831; vertical-align: middle; line-height: 15px; height: 15px;">
                                                            <a href="sitemap.aspx" class="ac3">ホームページマップ</a>
                                                        </td>
                                                        <td width="219">&nbsp;
                ...
                <table id="kefu1" style="border-left: 1px solid #d4484b; border-top: 1px solid #d4484b; border-bottom: 1px solid #d4484b; border-right: 1px solid #d4484b; background-color: #fff;" width="126" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td height="42" align="center" style="line-height: 21px;">
                            <strong>勤務日</strong>（北京時間）<br />
                            9:00-17:00
                        </td>
                    </tr>
                    <tr>
                        <td height="28" align="center">
                            <a href="javascript:openboxBg(1);showdivbox('divshow4');" class="ac10">本年度休暇予定</a>
                        </td>
                    </tr>
                    <tr>
