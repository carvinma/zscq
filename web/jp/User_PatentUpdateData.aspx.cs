...
public partial class User_PatentCount : System.Web.UI.Page
{
    ...
    public void Bind_Page_Info()//绑定基本情報
    {
        ...
        if (model != null)
        {
            ...
            ltl_grade.Text = DALG.UserGrade_Select_Id(model.i_Grade).nvc_Name_jp;
    ...
    protected void Bt_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            div_a.InnerHtml = "<script>alert('修正しました！');location.href='User_PatentUpdateData.aspx';</script>";
        }
        catch
        {
            div_a.InnerHtml = "<script>alert('パラメータの誤りがある後に提出し、確認してください！');location.href='user_sbzl.aspx';</script>";
        }
