<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_PatentAdd2.aspx.cs" Inherits="User_PatentCount" %>
...
<head runat="server">
  <title>ロット導入特許情報_特許情報を添加_私の特許_サービスセンター_会員センター_特許システム_環球匯通</title>
          ...
          <tr>
            <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
              <table width="739" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19">&nbsp;</td>
                  <td align="left">フロントページ>>特許システム>>会員センター>>サービスセンター>>私の特許>>特許情報を添加>>ロット導入特許情報 </td>
                </tr>
              </table>
            </td>
          </tr>
                              ...
                              <td width="687" height="20" align="left" valign="top" style="border-bottom: 1px solid #d34245;">
                                <table width="132" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="115" align="center" class="font12bt">大量に特許を導入</td>
                                    <td width="7"></td>
                                  </tr>
                                </table>
                              </td>
                      ...
                      <tr>
                        <td height="115" align="left" valign="top">
                          <table width="671" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="238" height="32" align="right"><strong>Excelリストをアップロードする：</strong></td>
                              <td width="433" align="left">&nbsp;
                                <asp:FileUpload ID="Fu_ExcelTable" runat="server" Style="border: 0px;" />
                              </td>
                            </tr>
                            <tr>
                              <td height="32" align="right"><strong>備考：</strong></td>
                              <td align="left">リストフォマットをダウンロードする：<a href="<%=excelpath %>" class="ac9">ここをクッリク
</a></td>
                            </tr>
                            <tr>
                                ...
                                <table width="415" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="95" align="left">
                                      <asp:ImageButton ID="ImgBtn_Add2" runat="server" ImageUrl="images/user_zl_b5.gif" OnClick="ImgBtn_Add2_Click" />
                                    </td>
