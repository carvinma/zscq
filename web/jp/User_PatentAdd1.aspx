...
<head runat="server">
    <title>手動で特許情報をインポート_特許情報を添加_私の特許_サービスセンター_会員センター_特許システム_環球匯通</title>
                        ...
                        <td height="52" align="left" valign="top" style="background-image: url(images/zl_right1.gif);">
                            <table width="739" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        フロントページ>>特許システム>>会員センター>>サービスセンター>>私の特許>>特許情報を添加>>手動で特許情報をインポート
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table width="716" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td width="691" align="left" valign="top">
                                                            ...
                                                            <td height="115" align="left" valign="top">
                                                                <table width="689" border="0" cellpadding='0' cellspacing='0'>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="429" height="26" align="left" valign="middle">
                                                                            <input type="text" runat="server" id="txt_Number" class="font12000 tooltip" tips="<p>中国特許号様式：9-13桁（例：200812345678.9）</p><p>他の国のフォーマットは限りません</p>"
                                                                                maxlength="50" />
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator"
                                                                                ...
                                                                                Text="空になることはできない！"></asp:RequiredFieldValidator>
                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="RegularExpressionValidator"
                                                                                ValidationGroup="a" ControlToValidate="txt_Number" Text="お客様の記入した情報の格式が正しくありません。ご確認をください！"
                                                                                Display="Dynamic" SetFocusOnError="true" ValidationExpression="[\s\S]{4,18}">
                                                                            </asp:RegularExpressionValidator>
                                                                            <%--<asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="CustomValidator" ValidationGroup="a" ControlToValidate="txt_Number" Display="Dynamic" SetFocusOnError="true" Text="お客様の記入した情報の格式が正しくありません。ご確認をください！" ClientValidationFunction="ClientValidatePatentNumberFormat"></asp:CustomValidator>--%>
                                                                            <%-- <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="CustomValidator" ValidationGroup="a" ControlToValidate="txt_Number" Display="Dynamic" SetFocusOnError="true" Text="特許番号を繰り返すことはできない！" ClientValidationFunction="ClientValidatePatentNumber"></asp:CustomValidator>--%>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="260" height="32" align="right" valign="middle">
                                                                        ...
                                                                        <td width="429" height="26" align="left" valign="middle">
                                                                            ...
                                                                            <input type="text" runat="server" id="txt_Name" class="font12000 tooltip" tips="200キャラクター以内"
                                                                                maxlength="200" />
                                                                            ...
                                                                            <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                <ContentTemplate>
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="RequiredFieldValidator"
                                                                                        ...
                                                                                        Display="Dynamic" SetFocusOnError="true" Text="選択して下さい"></asp:RequiredFieldValidator>
                                                                                </ContentTemplate>
                                                                            </asp:UpdatePanel>--%>
                                                                            <span class="font12b4e">
                                                                            ...
                                                                            <%--<asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                                <ContentTemplate>
                                                                                    <span class="font12b4e">
                                                                                        ...
                                                                                        InitialValue="0" Display="Dynamic" SetFocusOnError="true" Text="選択して下さい"></asp:RequiredFieldValidator>
                                                                                </ContentTemplate>
                                                                            </asp:UpdatePanel>--%>
                                                                            <span class="font12b4e">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="429" align="left" valign="middle">
                                                                            ...
                                                                            <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="空にすることはできません！"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="429" align="left" valign="middle">
                                                                            ...
                                                                            <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="空にすることはできません！"
                                                                    ...
                                                                    <tr id="tr_yaoqiuxiang" style="<%=hd_yaoqiuxiang.Value=="0"?"display:none": ""%>">
                                                                        ...
                                                                        <td width="429" height="26" align="left" valign="middle">
                                                                            <input type="text" runat="server" id="txt_yaoqiuxiang" class="font12000 tooltip"
                                                                                tips="数値のみを記入してください" value="0" maxlength="4" />
                                                                            <span class="error">*</span>
                                                                            <asp:CustomValidator ID="CustomValidator3" runat="server" ErrorMessage="空にすることはできません！"
                                                                            ...
                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ErrorMessage="RegularExpressionValidator"
                                                                                ValidationGroup="a" ControlToValidate="txt_yaoqiuxiang" Text="お客様の記入した情報の格式が正しくありません。ご確認をください！"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="429" height="26" align="left" valign="middle">
                                                                            <input type="text" runat="server" id="txt_PatentHolder" class="font12000 tooltip"
                                                                                tips="500キャラクター以内" maxlength="500" />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="429" height="26" align="left" valign="middle">
                                                                            <input type="text" runat="server" id="txt_PatentInventor" class="font12000 tooltip"
                                                                                tips="100キャラクター以内" maxlength="100" />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="429" height="32" align="left" valign="middle">
                                                                            ...
                                                                            <input type="text" runat="server" id="txt_AnnualFeeDateStart" readonly="readonly"
                                                                                class="font12000 tooltip" tips="システムに自動計算" style="background-image: url(images/user_js_date.gif);
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="429" height="32" align="left" valign="middle">
                                                                            <input type="text" runat="server" id="txt_AnnualFeeYear" class="font12000 tooltip"
                                                                                tips="システムに自動計算" readonly="readonly" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="260" height="32" align="right" valign="middle">
                                                                        ...
                                                                        <td width="429" height="32" align="left" valign="middle">
                                                                            <input type="text" runat="server" id="txt_AnnualFeeRestYear" class="font12000 tooltip"
                                                                                tips="システムに自動計算" maxlength="2" readonly="readonly" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="260" height="32" align="right" valign="middle">
                                                                        ...
                                                                        <td width="429" height="32" align="left" valign="middle">
                                                                            <span class="font12b4e">
                                                                                <asp:DropDownList ID="Drp_AnnualFeeStatus" runat="server" class="font_auto" onchange="selectChange()">
                                                                                    ...
                                                                                    <asp:ListItem Value="4">納付期限日まで＜30日間、オーダーを未提出</asp:ListItem>
                                                                                    <asp:ListItem Value="5">納付期限日まで＜15日間、オーダーを未提出</asp:ListItem>
                                                                                    <asp:ListItem Value="6">納付期限日まで＜0日間、オーダーを未提出</asp:ListItem>
                                                                                    <asp:ListItem Value="-1">オーダーを提出済、未支払</asp:ListItem>
                                                                                    <asp:ListItem Value="-1">オーダーを提出済、費用納付中</asp:ListItem>
                                                                                    <asp:ListItem Value="9">費用納付を放棄することを確認済</asp:ListItem>
                                                                                    <asp:ListItem Value="-1">納付人と連絡できない為、費用納付を放棄す</asp:ListItem>
                                                                                    <asp:ListItem Value="-1">ることと見なす</asp:ListItem>
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                                <ContentTemplate>
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="RequiredFieldValidator"
                                                                                        ...
                                                                                        SetFocusOnError="true" Text="選択して下さい" InitialValue="0"></asp:RequiredFieldValidator>
                                                                                </ContentTemplate>
                                                                            </asp:UpdatePanel>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td width="429" height="32" align="left" valign="middle">
                                                                            <input type="text" runat="server" id="txt_AnnualFeePrevYear" class="font12000 tooltip"
                                                                                tips="システムに自動計算" style="background-image: url(images/user_js_date.gif); background-repeat: no-repeat;
                                      ...
                                      <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="RegularExpressionValidator" ValidationGroup="a" ControlToValidate="txt_PriorityNumber" Text="お客様の記入した情報の格式が正しくありません。ご確認をください！" Display="Dynamic" SetFocusOnError="true" ValidationExpression="[\d\w\.]{6,18}">
                </asp:RegularExpressionValidator>--%>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                ...
                                                                <table width="689" border="0" cellpadding='0' cellspacing='0'>
                                                                    <tr>
                                                                        ...
                                                                        <td width="429" valign="middle">
                                                                            ...
                                                                            <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="RegularExpressionValidator" ValidationGroup="a" ControlToValidate="txt_PtcNumber" Text="お客様の記入した情報の格式が正しくありません。ご確認をください！" Display="Dynamic" SetFocusOnError="true" ValidationExpression="[\d\w\.]{6,18}">
                </asp:RegularExpressionValidator>--%>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <td height="115" align="left" valign="top">
                                                                <table width="689" border="0" cellpadding='0' cellspacing='0'>
                                                                    <tr>
                                                                        ...
                                                                        <td valign="middle">
                                                                            <input type="text" runat="server" id="txt_AnnualFeeNextYear" readonly="readonly"
                                                                                class="font12000 tooltip" tips="システムに自動計算" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="260" height="32" align="right" valign="middle">
                                                                        ...
                                                                        <td valign="middle">
                                                                            <input type="text" runat="server" id="txt_AnnualFeeRestDay" class="font12000 tooltip"
                                                                                tips="システムに自動計算" maxlength="5" readonly="readonly" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="260" height="32" align="right" valign="middle">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td valign="middle">
                                                                            <input type="text" runat="server" id="txt_AnnualFeeNextPaymentMoney" class="font12000 tooltip"
                                                                                tips="システムに自動計算" maxlength="8" readonly="readonly" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="260" height="32" align="right" valign="middle">
                                                                    ...
                                                                    <tr id="tr_chaoxiangfee" runat="server" style="display: none;">
                                                                        ...
                                                                        <td valign="middle">
                                                                            <input type="text" runat="server" id="txt_chaoxiang" class="font12000 tooltip" tips="システムに自動計算"
                                                                    ...
                                                                    <tr id="tr_zhinajin" runat="server" visible="false">
                                                                        ...
                                                                        <td valign="middle">
                                                                            <input type="text" runat="server" id="txt_zhinajin" class="font12000 tooltip" tips="システムに自動計算"
                                                                                maxlength="8" readonly="readonly" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td valign="middle">
                                                                            ...
                                                                            <input type="text" runat="server" id="txt_FeeSubtotal" class="font12000 tooltip"
                                                                                tips="費用を納付する場合、弊社とご連絡をください。具体的な金額は弊社のインボイスを基準にしてください" maxlength="8" readonly="readonly" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="260" height="32" align="right" valign="middle">
                                                                        ...
                                                                        <td valign="middle">
                                                                            <input type="text" runat="server" id="txt_CurrencyType" class="font12000 tooltip"
                                                                                tips="システムに自動計算" maxlength="50" readonly="readonly" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="260" height="32" align="right" valign="middle">
                                                                        ...
                                                                        <td valign="middle">
                                                                            <textarea id="nt_Remarks" runat="server" class="font12000 tooltip" tips="500文字以内"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="429" valign="middle">
                                                                            ...
                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="RegularExpressionValidator"
                                                                                ValidationGroup="a" ControlToValidate="txt_anjuanhao" Text="お客様の記入した情報の格式が正しくありません。ご確認をください！"
...
<script type="text/JavaScript">
        ...
        if (selIndex != 0) {
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    $("#hf_guanfei").val(json.SetFee); //政府規定費用
                    $("#hf_total").val(json.TotalFee); //小計
    ...
    function ZhuaQu() {
        ...
        if (patentnum != "") {
            if (guojiname == 1) {
                $("#zhuaquinfo").html("特許を検索しています。少々をお待ちください。もしシステムが長い時間で見つからない場合、以下をご自分で記入してください内容.");
            }
            else {
                $("#zhuaquinfo").html("");
                return false;
                    ...
                    if (msg != "no" && msg != "chaoshi") {
                        if (guojiname == 1) {
                            if (ptypename == "意匠") {//外观设计 
                                ...
                                $("#divhtml").html(msg);
                                $("#txt_Name").val($("#divhtml table tr:eq(1) td").eq(1).html().split('&nbsp;')[1]); //特許名称 
                                $("#txt_PatentHolder").val($("#divhtml table tr:eq(6) td").eq(1).html().split('&nbsp;')[1]); //特許権利人
                                $("#txt_PatentInventor").val($("#divhtml table tr:eq(8) td").eq(1).html().split('&nbsp;')[1]); //発明者
                                $("#txt_AuthorizeIsNationalityDate").val($("#divhtml table tr:eq(0) td").eq(3).html().split('&nbsp;')[1].replace(".", "-").replace(".", "-").replace("/", "-").replace("/", "-")); //特許申請日
                            }
                        }
                        else if (guojiname == 8) {
                            $("#divhtml").html(msg);
                            alert(msg);
                            var aa = $("#divhtml tbody tr:eq(5) td").eq(1).html(); //特許権利人
                            var bb = aa.replace("<br>", "<b>").replace("<br>", "</b>");
                            $("#dd").html(bb);
                            var cc = $("#dd").find("b").html().trim();
                            $("#txt_PatentHolder").val(cc); //特許権利人

                            var aa1 = $("#divhtml tbody tr:eq(8) td").eq(1).html(); //発明者
                            var bb1 = aa1.replace("/", "<b>").replace("<br>", "</b>");

                            $("#dd").html(bb1);
                            var cc1 = $("#dd").find("b").html().trim();
                            $("#txt_PatentInventor").val(cc1); //発明者
                        ...
                        // alert("专利号搜索超时，请稍后再试、、、");
                        $("#zhuaquinfo").html("検索時間オーバー！");
                    }
                    else if (msg == "no") {
                        alert("この特許コードの情報を見つかれませんでした。手動で情報を追加してください");
                        $("#zhuaquinfo").html();
                    }
                }
            });
