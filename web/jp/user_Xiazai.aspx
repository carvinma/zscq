...
<body id="index">
  <form id="form1" runat="server">
                                <table width="660" border="0" cellspacing="1" cellpadding="1" bgcolor="#d0d0d0">
                                  <tr>
                                    <td width="123" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">商標登録コード</td>
                                    <td width="98" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">商標タイプ
</td>
                                    <td width="105" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">費用納付種類</td>
                                   <td width="101" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">登録者名称</td>
                                     <td width="85" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">商標申請日</td>
                                    <td width="129" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">下载</td>
                                  </tr>
                                    ...
                                    <ItemTemplate>
                                      <tr>
                                        ...
                                        <td width="101" align="center" bgcolor="#FFFFFF">
                                          ...
                                          <%# GetGuojiName(Eval("i_GuoJiId"))!="中国"? Eval("nvc_SBRegEnName"):""%></td> <td width="85" align="center" bgcolor="#FFFFFF">
                                          <%# Eval("nvc_SbRegTime")%></td>
                                           <td width="129" align="center" bgcolor="#FFFFFF" style="line-height:20px;">
                                           <a href="user_World_sbweituo.aspx?id=<%#Eval("i_TrademarkId")%>&type=2" target="_blank" class="ac5t">依頼書のダウンロード</a><br><a href="user_World_sb.aspx?id=<%#Eval("i_TrademarkId")%>&type=3" target="_blank" class="ac5t">申請書をダウンロード</a></td>
                                      </tr>
                                    </ItemTemplate>
                                  </asp:Repeater>
