<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trademarkrenewalOrder_Info.aspx.cs" Inherits="trademarkrenewalOrder_Info" %>
                                                    ...
                                                    <table width="689" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <table width="689" border="0" cellspacing="1" cellpadding="1" bgcolor="#d0d0d0">
                                                                    <tr>
                                                                     <td width="70" height="35" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">
                                                                        ...
                                                                        <td width="235" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">
                                                                            申请人
                                                                        </td>
                                                        ...
                                                        <tr>
                                                         <td class="font12bd44147">
                                                                                ...
                                                                                提示语：<br />	
                                                                                请将以下文件邮寄给我们	<br />	
                                                                                  ①商标续展申请书（申请书），下载后签字/盖章； <br />
                                                                                  ②商标续展代理委托书（委托书），下载后签字/盖章； <br />
                                                                                  ③商标注册证书复印件； <br />
                                                                                  ④营业执照复印件，签字/盖章； <br />
                                                                                  ⑤身份证复印件，签字/盖章；（申请人为自然人的需提交此项） <br />
                                                                                  请知悉,我司收到原件之日为此订单的实际生效日，否则我司将视本订单未提交，如发生续展超过期限产生滞纳金、商标失效等情况我司将不承担任何责任。
                                                                            </td>
                                                         </tr>
                                                        <tr>
