...
public partial class user_shopdd : System.Web.UI.Page
{
    ...
    public void Bind_Page_Title()
    {
        ...
        TitleOrKeyword = "<title>我的兑换订单_商城系统_" + ShopName + "</title><meta name=\"Keywords\" content=\"" + ShopKeywords + "\"/><meta name=\"Description\" content=\"" + ShopDescription + "\"/>";
    }
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        if (LinkButton1.Text == "订单号↓")
        {
            LinkButton1.Text = "订单号↑";
            desc = false;
        }
        else
        {
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ordertype = "2";
        AspNetPager1.CurrentPageIndex = 1;
        if (LinkButton2.Text == "积分总计↓")
        {
            LinkButton2.Text = "积分总计↑";
            desc = false;
        }
        else
        {
    ...
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        ordertype = "3";
        AspNetPager1.CurrentPageIndex = 1;
        if (LinkButton3.Text == "订单状态↓")
        {
            LinkButton3.Text = "订单状态↑";
            desc = false;
        }
        else
        {
    ...
    protected void LinkButton4_Click(object sender, EventArgs e)
    {
        ordertype = "4";
        AspNetPager1.CurrentPageIndex = 1;
        if (LinkButton4.Text == "下单时间↓")
        {
            LinkButton4.Text = "下单时间↑";
            desc = false;
        }
        else
        {
