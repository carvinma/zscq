                        ...
                        <td height="115" align="left" valign="top">
                          ...
                          <table width="689" border="0" cellspacing="1" cellpadding="1" bgcolor="#d0d0d0">
                            <tr>
                              ...
                              <td width="65" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">案件号</td>
                              <td width="210" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">申请人</td>
                              ...
                              <td width="65" align="center" bgcolor="#FFFFFF" class="font12b4e user_zlbottomline">操作</td>
                            </tr>
                                ...
                                <tr>
                                  ...
                                  <td align="center" bgcolor="#FFFFFF">
                                   <asp:Repeater runat="server" ID="repApply">
                                      <ItemTemplate>
                                        <div title="<%#Eval("ApplyName")%>" style="text-align: center; width: 210px;height:30px;line-height:30px;overflow: hidden; text-overflow:ellipsis">
