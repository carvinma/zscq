...
namespace zscq.DAL
{
    public class dal_Trademark
    {
        ...
        public int Trademark_Add(t_Trademark model)
        {
            try
            {
                dzdc.t_Trademark.InsertOnSubmit(model);
                dzdc.SubmitChanges();
                return 1;
            }
            catch
        ...
        public int Trademark_Del(int id)
        {
            try
            {
                t_Trademark Trademark = dzdc.t_Trademark.SingleOrDefault(b => b.i_Id == id);
                if (Trademark != null)
                {
                    dzdc.t_Trademark.DeleteOnSubmit(Trademark);
                    dzdc.SubmitChanges();
                    return 1;
                }
                else
        ...
        /// <returns></returns>
        public int Trademark_Update(t_Trademark model)
        {
            try
            {
                t_Trademark Newmodel = dzdc.t_Trademark.SingleOrDefault(b => b.i_Id == model.i_Id);
                dzdc.SubmitChanges();
                return 1;
            }
            catch
        ...
        /// </summary>
        /// <param name="Model"></param>
        public int Trademark_Update_Views(t_Trademark m)
        {
            try
            {
                t_Trademark p = dzdc.t_Trademark.SingleOrDefault(a => a.i_Id == m.i_Id);
                dzdc.SubmitChanges();
                return 1;
            }
            catch
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public t_Trademark Trademark_Select_Id(int id)
        {
            try
            {
                t_Trademark m = (from a in dzdc.t_Trademark where (a.i_Id == id) select a).FirstOrDefault();
                return m;
            }
            catch
            {
        ...
        public t_Trademark Trademark_Select_No(string i_Number)
        {
            try
            {
                t_Trademark model = (from a in dzdc.t_Trademark where (a.nvc_SBRegNum == i_Number) select a).FirstOrDefault();
                return model;
            }
            catch
            {
        ...
        public t_Trademark Trademark_Select_No(string i_Number, int uid)
        {
            try
            {
                t_Trademark model = (from a in dzdc.t_Trademark where (a.nvc_SBRegNum == i_Number && a.i_MemberId == uid) select a).FirstOrDefault();
                return model;
            }
            catch
            {
        ...
        public List<t_Trademark> Trademark_Select_IdS(string list)
        {
            try
            {
                ...
                return dzdc.ExecuteQuery<t_Trademark>(sql).ToList();
            }
            catch
            {
                return null;
        ...
        public List<int> Trademark_Select_User()
        {
            try
            {
                ...
                return dzdc.ExecuteQuery<int>(sql).ToList();
            }
            catch
            {
                return null;
        ...
        {
            return from i in dzdc.t_Trademark select i;
        }
        /// <summary>
        /// 获取全部商标用户
        /// </summary>
        ...
        {
            var iquery = from i in dzdc.t_Trademark where i.i_MemberId == memberid && i.i_AnnualFeeStatus == sid select i;
            if (flag == 1)
            {
